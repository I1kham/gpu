...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_btn1_setText("确认");
	pleaseWait_btn1_show();
	pleaseWait_btn2_setText("没有");
...
TaskCleaning.prototype.priv_handleSanWashingMicro = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 0: pleaseWait_freeText_setText("冲泡器清洗未开始（或结束）"); break;	//Brewer Cleaning is not started (or ended)
				case 1: pleaseWait_freeText_setText("开始清洗冲泡器"); break; 	//Brewer Cleaning is started
				case 2: pleaseWait_freeText_setText("冲泡器放置"); break; 	//Brewer placed
				case 3: pleaseWait_freeText_setText("添加清洗药片并按下&quot;开始&quot;按钮"); break; //Put pastille and push START
				case 4: pleaseWait_freeText_setText("灌注"); break; //Infusion
				case 5: pleaseWait_freeText_setText("冲泡器清洁周期 1"); break; // Brewer cleaning cycles 1
				case 6: pleaseWait_freeText_setText("冲泡器清洁周期 2"); break;	// Brewer cleaning cycles 2
				case 7: pleaseWait_freeText_setText("冲泡器清洁周期 3"); break;	// Brewer cleaning cycles 3
				case 8: pleaseWait_freeText_setText("冲泡器清洁周期 4"); break;	// Brewer cleaning cycles 4
				case 9: pleaseWait_freeText_setText("冲泡器清洁周期 5"); break;	// Brewer cleaning cycles 56
				case 10: pleaseWait_freeText_setText("冲泡器清洁周期 6"); break;	// HC_STEP_BRW_6
				
				case 11: pleaseWait_freeText_setText("重复清洗？"); break;	//Repeat cleaning ?
				case 12: pleaseWait_freeText_setText("将冲泡器置于可手动清理位置，完成后按&quot;继续&quot;"); break;	//Brewer placed in brush position, press CONTINUE when finished
				case 13: pleaseWait_freeText_setText("跳过最后一杯咖啡或制作一杯咖啡"); break; //Skip final coffee or make a coffee
				case 14: pleaseWait_freeText_setText("咖啡出杯中"); break; //Coffee delivery
				...
				case 18:	//HC_STEP_MIXER_4
					...
					if (me.isEspresso)
						cleanMixNum++;
					pleaseWait_freeText_setText("冲洗 " +cleanMixNum); //rinsing
					break; 	
...
TaskCleaning.prototype.priv_handleSanWashingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: msg = ""; break;
				case 0: msg = "正在进行清洗"; break;	//Cleaning is active
				case 1: msg = "将药片放入冲泡器中，然后按&quot;继续&quot;"; break; 	//Put the pastille in the brewer and press CONTINUE
				case 2: msg = "冲泡器关闭"; break; 	//Brewer is closing
				case 3: msg = "药片溶解1/2，请稍候"; break; 	//Tablet dissolution 1/2, please wait
				case 4: msg = "第二次溶解循环即将开始"; break; 	//2nd dissolution cycle is about to starting
				case 5: msg = "药片溶解2/2，请稍候"; break; 	//Tablet dissolution 1/2, please wait

				case 6: msg = "第一次清洗，请稍候 1/3"; break; 	//1st Cleaning, please wait 1/3
				case 7: msg = "第一次清洁，有效1/3"; break; 	//1st Cleaning, active 1/3
				case 8: msg = "第一次清洗，请稍候 2/3"; break; 	//1st Cleaning, please wait 2/3
				case 9: msg = "第一次清洁，有效2/3"; break; 	//1st Cleaning, active 2/3
				case 10: msg = "第一次清洗，请稍候 3/3"; break; 	//1st Cleaning, please wait 3/3
				case 11: msg = "第一次清洁，有效3/3"; break; 	//1st Cleaning, active 3/3

				case 12: msg = "是否要重复清洁循环1/2？"; break; 	//Do you want to repeat clean cycle 1/2 ?
				
				case 13: msg = "冲泡器将处于打开位置"; break; 	//Brewer is going into open position
				
				case 14: msg = "请执行手动清理，完成后按&quot;继续&quot;"; break; 	//Please, perform a manual brush and then press CONTINUE when finished
				
				case 15: msg = "第二次清洗，请稍候 1/6"; break; 	//2nd Cleaning, please wait 1/6
				case 16: msg = "第二次清洁，有效1/6"; break; 	//2nd Cleaning, active 1/6
				case 17: msg = "第二次清洗，请稍候 2/6"; break; 	//2nd Cleaning, please wait 2/6
				case 18: msg = "第二次清洁，有效2/6"; break; 	//2nd Cleaning, active 2/6
				case 19: msg = "第二次清洗，请稍候 3/6"; break; 	//2nd Cleaning, please wait 3/6
				case 20: msg = "第二次清洁，有效3/6"; break; 	//2nd Cleaning, active 3/6
				case 21: msg = "第二次清洗，请稍候 4/6"; break; 	//2nd Cleaning, please wait 4/6
				case 22: msg = "第二次清洁，有效4/6"; break; 	//2nd Cleaning, active 4/6
				case 23: msg = "第二次清洗，请稍候 5/6"; break; 	//2nd Cleaning, please wait 5/6
				case 24: msg = "第二次清洁，有效5/6"; break; 	//2nd Cleaning, active 5/6
				case 25: msg = "第二次清洗，请稍候 6/6"; break; 	//2nd Cleaning, please wait 6/6
				case 26: msg = "第二次清洁，有效6/6"; break; 	//2nd Cleaning, active 6/6
				
				case 27: msg = "是否要重复清洁循环2/2？"; break; 	//Do you want to repeat clean cycle 2/2 ?
				
				case 28: msg = "你想不喝最后一杯咖啡吗？"; break; //Do you want to skip the final coffee ?
				case 29: msg = "咖啡出品中，请稍等"; break; //Coffee delivery, please wait

				case 30: msg = "冲泡器漂洗"; break; //Brewer Rinsing 
				case 31: msg = "搅拌机1冲洗"; break; //Mixer 1 Rinsing
				case 32: msg = "搅拌机2冲洗"; break; //Mixer 2 Rinsing
				case 33: msg = "搅拌机3冲洗"; break; //Mixer 3 Rinsing 
				case 34: msg = "冲泡器清洗完成。按&quot;关闭&quot;结束"; break; //Brewer Cleaning Done. Press CLOSE to exit
...
TaskCleaning.prototype.priv_handleMilkWashingVenturi = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 1: pleaseWait_freeText_setText("开始清洗奶泡机"); break;	//Milker Cleaning is started
				case 2: pleaseWait_freeText_setText("清洁剂加温"); break;	//Warming for cleaner
				case 3: pleaseWait_freeText_setText("等待确认"); break;	//Wait for confirm
				case 4: pleaseWait_freeText_setText("清洁循环（12）"); break;	//Doing cleaner cycles (12)
				case 5: pleaseWait_freeText_setText("水加热"); break;	//Warming for water
				case 6: pleaseWait_freeText_setText("等待第二次确认"); break;	//Wait for second confirm
				case 7: pleaseWait_freeText_setText("清洁循环（12）"); break;	//Doing cleaner cycles (12)
				default: pleaseWait_freeText_setText(""); break;
			}
			pleaseWait_freeText_show();
			...
			else
			{
				switch (me.fase)
				{
					...
					case 6:  pleaseWait_btn1_setText ("确认"); break;
				}
				pleaseWait_btn1_show();	
			}
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "开始清洗前，请检查：<ol><li>是否有水供应</li><li>废水箱是空的</li><li>奶管在清洗罐中</li><li>清洁剂已装入清洗罐中</li><ol>");
			...
			else
			{
				...
				case 2:	//CIC_STEP_FILL_WATER
					...
					pleaseWait_freeText_setText("正在注水中，请稍候。<br>导水率：{0} uS".translateLang(cond_uS)); //Water refilling in progress, please wait.<br>Water conducibility: {0} uS
					break;
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					...
					pleaseWait_freeText_setText("清洁程序已完成。<br><br>初始传导性 {0} 最终传导性 {1}<br><br>请记住：<ul><li>清空废水箱</li><li>将牛奶管放回原位</li></ul><br>按“关闭”关闭此窗口".translateLang(cond_uS_init_rif,cond_uS_finale)); //The cleaning procedure is finished.<br><Initial conducibility {0} and current conducibility {1},><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;
				...
				case 97: //CIC_TOO_MUCH_DETERGENTE
					pleaseWait_freeText_setText("警告：洗涤剂太多！");
					break;
				
				case 98: //CIC_DET_TOO_LOW
					pleaseWait_freeText_setText("警告：检测到洗涤剂液位过低<br>建议再清洗一次");
					break;

				case 99: //CIC_DET_TOO_AGGRESSIVE
					pleaseWait_freeText_setText("警告：洗涤剂腐蚀性太强");
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						...
						pleaseWait_btn1_setText ("启动");
					break;
				case 7:		pleaseWait_btn1_setText ("关闭"); break;
				case 9:		pleaseWait_btn1_setText ("启动"); break;
				}
				pleaseWait_btn1_show();	
			}
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("请取出冲泡器，然后按“继续”"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("继续");
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleGrinderSpeedTest = function(timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09 磨豆器速度</b><br><br>请取出冲泡器，然后按“继续”"); //Please remove the brewer, then press CONTINUE
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("继续");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断");
	...
	case 5: //step 1
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09 磨豆器速度</b><br><br>步骤1请关闭咖啡铃（橙色手柄）并按&quot;继续&quot;。磨豆器将运行约10秒钟，以便清空磨豆器本身。");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("继续");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断");
	...
	case 20:
		me.fase = 21;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09 磨豆器速度</b><br><br>步骤2<br>既然磨豆器是无豆状态，我们可以测试以检测磨豆器无豆时报告的平均传感器值。按&quot;继续&quot;继续，磨豆器将运行约10秒钟。");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("继续");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断");
	...
	case 40:
		me.fase = 41;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09 磨豆器速度</b><br><br>步骤3<br>现在<b>打开咖啡铃</b>（橙色操纵杆），然后按&quot;继续&quot;继续，磨豆器将运行约10秒钟。");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("继续");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断");
	...
	case 60:
		me.fase = 61;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09 磨豆器速度</b><br><br>结果:<br>磨豆器无豆时的平均速度: <b>" +me.speed1 +"</b><br>磨豆器有豆时的平均速度: <b>" +me.speed2 +"</b><br>");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("关闭");
		pleaseWait_btn1_show();
		break;
	...
	case 70: //chiedo di rimettere a posto il gruppo
		...
		else
		{
			me.fase = 71;
			pleaseWait_rotella_hide();
			pleaseWait_freeText_setText("<b>OFF09 磨豆器速度</b><br><br>将冲泡器安装到位，然后按“继续”"); //Place the brewer into position, then press CONTINUE
			pleaseWait_freeText_show();
			pleaseWait_btn1_setText("继续");
			pleaseWait_btn1_show();
		}
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("“卸载”进行中，请稍候 ...<br><br><br>Press PROG button to abort"); //DISINTALLATION is running, please wait
		else
	...
	case 40:
		var msgToOutput = "“卸载”已完成，请“关闭”机器设备"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "卸载完成，请“关闭”锅炉水龙头并“关闭”机器"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
	...
	case 51:
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("卸载<br><br>打开锅炉水龙头，然后按继续 ...<br><br><br>Press PROG button to abort"); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
		else
			pleaseWait_freeText_setText("卸载<br><br>打开锅炉水龙头，然后按继续 ..."); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
...
TaskGrinderClean.prototype.onEvent_cpuStatus  	= function(statusID, statusStr, flag16)		{ this.cpuStatus = statusID; pleaseWait_header_setTextL ("磨豆器清洗"); }
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	...
	var msg = "{1} 的运行磨豆器周期 {0}".translateLang(this.curCiclo,this.numCicli);
	msg += "<br><br><b>回收磨碎的咖啡豆</b>";
	this.priv_show (msg, "", "");	
...
TaskGrinderClean.prototype.runGrinderCycle_3 = function(timeNowMsec)
{
	...
	var msg = "{1} 的运行磨豆器周期 {0}".translateLang(this.curCiclo-1,this.numCicli);
	msg += "<br>" +"等待 {0} 秒。".translateLang(timeLeftSec);
	this.priv_show (msg, "", "");	
	if (timeLeftMSec <= 0)
		this.runGrinderCycle_1();
}
...
//console.log ("fase="+this.fase);	
	...
	{
		pleaseWait_freeText_setText ("<b>磨豆器清洗</b><br><br>" + text);
		pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	var msg = "关闭磨豆器豆仓开闭挡片以避免咖啡豆损失.";
	msg += "<br>完成后按继续.";
	this.priv_show (msg, "继续", "");
}
...
TaskGrinderClean.prototype.step6 = function()
{
	...
	var msg = "补充清洗装置.";
	msg += "<br>完成后按继续.";
	msg += "<br><br><b>警告：</b> 只要您按下&quot;继续&quot;，磨豆器就会开始运行";
	this.priv_show (msg, "继续", "");	
}
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("您想重复研磨循环吗？", "没有", "确认");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("你想制作一杯咖啡吗？", "没有", "确认");
}
