...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_freeText_setText("Pažnja, prva postavka ciklusa kave radi samo s donjim kompletom klipa (s bočnim otvorima) i posudom za kolače (s rupom na dnu), koji mogu pravilno otpustiti vodu za ispiranje u posudu za kapi, možeš li potvrditi da su ove komponente instalirane??");
	pleaseWait_freeText_show();
	pleaseWait_btn1_setText("POTVRDI");
	pleaseWait_btn1_show();
	pleaseWait_btn2_setText("NE");
...
TaskCleaning.prototype.priv_handleSanWashingMicro = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 0: pleaseWait_freeText_setText("Čišćenje grupe kave neće započeti (ili završiti)"); break;	//Brewer Cleaning is not started (or ended)
				case 1: pleaseWait_freeText_setText("Čišćenje grupe kave je započelo"); break; 	//Brewer Cleaning is started
				case 2: pleaseWait_freeText_setText("Grupa kave postavljena"); break; 	//Brewer placed
				case 3: pleaseWait_freeText_setText("Dodaj tabletu i pritisni ZAPOČNI"); break; //Put pastille and push START
				case 4: pleaseWait_freeText_setText("Infuzija"); break; //Infusion
				case 5: pleaseWait_freeText_setText("Ciklusi čišćenja grupe kave 1"); break; // Brewer cleaning cycles 1
				case 6: pleaseWait_freeText_setText("Ciklusi čišćenja grupe kave 2"); break;	// Brewer cleaning cycles 2
				case 7: pleaseWait_freeText_setText("Ciklusi čišćenja grupe kave 3"); break;	// Brewer cleaning cycles 3
				case 8: pleaseWait_freeText_setText("Ciklusi čišćenja grupe kave 4"); break;	// Brewer cleaning cycles 4
				case 9: pleaseWait_freeText_setText("Ciklusi čišćenja grupe kave 5"); break;	// Brewer cleaning cycles 56
				case 10: pleaseWait_freeText_setText("Ciklusi čišćenja grupe kave 6"); break;	// HC_STEP_BRW_6
				
				case 11: pleaseWait_freeText_setText("Ponoviti čišćenje?"); break;	//Repeat cleaning ?
				case 12: pleaseWait_freeText_setText("Grupa kave u položaju četkanja, pritisnuti NASTAVI kad završi"); break;	//Brewer placed in brush position, press CONTINUE when finished
				case 13: pleaseWait_freeText_setText("Preskoči zadnju kavu ili pripremi kavu"); break; //Skip final coffee or make a coffee
				case 14: pleaseWait_freeText_setText("Isporuka kave"); break; //Coffee delivery
				...
				case 18:	//HC_STEP_MIXER_4
					...
					if (me.isEspresso)
						cleanMixNum++;
					pleaseWait_freeText_setText("Ispiranje " +cleanMixNum); //rinsing
					break; 	
			...
			if (me.fase != me.prevFase)
			{
				...
				else
				{
					...
					{
						var btnText = "DUGME " +me.btn1;
						switch (me.fase)
						{
							case 3:  btnText = "POČETAK"; break; //HC_STEP_TABLET
							case 11: btnText = "NE"; break; //HC_STEP_BRW_REPEAT
							case 12: btnText = "NASTAVI"; break; //HC_STEP_BRW_BRUSH_POSITION
							case 13: btnText = "PRESKOČI KAVU"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
						}
				...
				{
					var btnText = "DUGME " +me.btn2;
					switch (me.fase)
					{
						case 11: btnText = "DA"; break;//HC_STEP_BRW_REPEAT
						case 13: btnText = "UZMI KAVU"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
					}
...
TaskCleaning.prototype.priv_handleDescalingMilker = function (timeElapsedMSec)		//#4419
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = ". PritisnI NASTAVI kad završi."; break;
				case 2:		msg = "Pražnjenje hidrauličkog sustava, pričekati…"; break;
				case 3:		msg = ". PritisnI NASTAVI kad završi."; break;
				case 4:		msg = "Pričvrsti potopnu pumpu na spremnik sa sredstvom za uklanjanje kamenca. PritisnI NASTAVI kad završi."; break;
				case 5:		msg = "Punjenje hidrauličkog sustava sredstvom za uklanjanje kamenca, pričekati…"; break;
				case 6:		msg = "Provjeri razinu sredstva za uklanjanje kamenca u spremniku zraka. PritisnI NASTAVI kad završi."; break;
				case 7:		msg = "Započni punjenje hidraulične cijevi sredstvom za uklanjanje kamenca, pričekati…"; break;
				case 8:		msg = "Pričekaj da tekućina za uklanjanje kamenca počne djelovati…"; break;
				case 9:		msg = "Tekućina za uklanjanje kamenca počinje istjecati kroz mlaznice, pričekati…"; break;
				case 10:	msg = "start emptying and rinsing of the hydraulic circuit"; break;
				case 11:	msg = ". PritisnI NASTAVI kad završi."; break;
				case 12:	msg = "Pražnjenje hidrauličkog sustava, pričekati…"; break;
				case 13:	msg = ". PritisnI NASTAVI kad završi."; break;
				case 14:	msg = "Prebaci izvor napajanja na spremnik za vodu. Pričvrsti potopnu pumpu na spremnik s vodom. PritisnI NASTAVI kad završi."; break;
				case 15:	msg = "Hidraulički sustav će biti napunjen vodom, pričekati…"; break;
				case 16:	msg = "Provjeri razinu vode u spremniku zraka. PritisnI NASTAVI kad završi."; break;
				case 17:	msg = "Voda je istekla kroz mlaznice."; break;
				case 18:	msg = "Ispusti vodu i ispitaj uzorak. Stavi šalicu za prikupljanje uzorka. PritisnI NASTAVI kad završi."; break;
				case 19:	msg = "Započni ispuštati uzorak kroz svaku mlaznicu."; break;
				case 20:	msg = "Provjeri prikupljeni uzorak. Pritisni dugme NASTAVI za nastavak ili PONOVI za ponavljanje prethodnih koraka i pravilno čišćenje hidrauličkog sustava."; break;
				case 21:	msg = "Postupak uklanjanja kamenca je završen, pritisni ZATVORI za završetak."; break;
			}
...
TaskCleaning.prototype.priv_handleDescalingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = "Otvori slavinu bojlera. PritisnI NASTAVI kad završi."; break;
				case 2:		msg = "Pražnjenje hidrauličkog sustava, pričekati…"; break;
				case 3:		msg = "Zatvori slavinu bojlera. PritisnI NASTAVI kad završi."; break;
				case 4:		msg = "Pričvrsti potopnu pumpu na spremnik sa sredstvom za uklanjanje kamenca. PritisnI NASTAVI kad završi."; break;
				case 5:		msg = "Punjenje hidrauličkog sustava sredstvom za uklanjanje kamenca, pričekati…"; break;
				case 6:		msg = "Provjeri razinu sredstva za uklanjanje kamenca u spremniku zraka. PritisnI NASTAVI kad završi."; break;
				case 7:		msg = "Započni punjenje hidraulične cijevi sredstvom za uklanjanje kamenca, pričekati…"; break;
				case 8:		msg = "Pričekaj da tekućina za uklanjanje kamenca počne djelovati…"; break;
				case 9:		msg = "Tekućina za uklanjanje kamenca počinje istjecati kroz mlaznice, pričekati…"; break;
				case 10:	msg = "Provjeri tekućinu koja izlazi iz mlaznica kako bi utvrdio je li postupak uklanjanja kamenca uspješno završen."; break;
				case 11:	msg = "Otvori slavinu bojlera. PritisnI NASTAVI kad završi."; break;
				case 12:	msg = "Pražnjenje hidrauličkog sustava, pričekati…"; break;
				case 13:	msg = "Zatvori slavinu bojlera. PritisnI NASTAVI kad završi."; break;
				case 14:	msg = "Prebaci izvor napajanja na spremnik za vodu. Pričvrsti potopnu pumpu na spremnik s vodom. PritisnI NASTAVI kad završi."; break;
				case 15:	msg = "Hidraulički sustav će biti napunjen vodom, pričekati…"; break;
				case 16:	msg = "Provjeri razinu vode u spremniku zraka. PritisnI NASTAVI kad završi."; break;
				case 17:	msg = "Voda je istekla kroz mlaznice."; break;
...
TaskCleaning.prototype.priv_handleSanWashingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: msg = ""; break;
				case 0: msg = "Čišćenje je aktivno"; break;	//Cleaning is active
				case 1: msg = "Stavi tabletu u grupu kave i pritisni NASTAVI"; break; 	//Put the pastille in the brewer and press CONTINUE
				case 2: msg = "Grupa kave se zatvara"; break; 	//Brewer is closing
				case 3: msg = "Otapanje tablete 1/2, pričekati"; break; 	//Tablet dissolution 1/2, please wait
				case 4: msg = "2. ciklus otapanja - uskoro počinje"; break; 	//2nd dissolution cycle is about to starting
				case 5: msg = "Otapanje tablete 2/2, pričekati"; break; 	//Tablet dissolution 1/2, please wait

				case 6: msg = "1. čišćenje, pričekati 1/3"; break; 	//1st Cleaning, please wait 1/3
				case 7: msg = "1. čišćenje, aktivno 1/3"; break; 	//1st Cleaning, active 1/3
				case 8: msg = "1. čišćenje, pričekati 2/3"; break; 	//1st Cleaning, please wait 2/3
				case 9: msg = "1. čišćenje, aktivno 2/3"; break; 	//1st Cleaning, active 2/3
				case 10: msg = "1. čišćenje, pričekati 3/3"; break; 	//1st Cleaning, please wait 3/3
				case 11: msg = "1. čišćenje, aktivno 3/3"; break; 	//1st Cleaning, active 3/3

				case 12: msg = "Želite li ponoviti ciklus čišćenja 1/2?"; break; 	//Do you want to repeat clean cycle 1/2 ?
				
				case 13: msg = "Grupa kave prelazi u otvoreni položaj"; break; 	//Brewer is going into open position
				
				case 14: msg = "Izvrši ručno četkanje i zatim pritisni NASTAVI kad završi"; break; 	//Please, perform a manual brush and then press CONTINUE when finished
				
				case 15: msg = "2. čišćenje, pričekati 1/6"; break; 	//2nd Cleaning, please wait 1/6
				case 16: msg = "2. čišćenje, aktivno 1/6"; break; 	//2nd Cleaning, active 1/6
				case 17: msg = "2. čišćenje, pričekati 2/6"; break; 	//2nd Cleaning, please wait 2/6
				case 18: msg = "2. čišćenje, aktivno 2/6"; break; 	//2nd Cleaning, active 2/6
				case 19: msg = "2. čišćenje, pričekati 3/6"; break; 	//2nd Cleaning, please wait 3/6
				case 20: msg = "2. čišćenje, aktivno 3/6"; break; 	//2nd Cleaning, active 3/6
				case 21: msg = "2. čišćenje, pričekati 4/6"; break; 	//2nd Cleaning, please wait 4/6
				case 22: msg = "2. čišćenje, aktivno 4/6"; break; 	//2nd Cleaning, active 4/6
				case 23: msg = "2. čišćenje, pričekati 5/6"; break; 	//2nd Cleaning, please wait 5/6
				case 24: msg = "2. čišćenje, aktivno 5/6"; break; 	//2nd Cleaning, active 5/6
				case 25: msg = "2. čišćenje, pričekati 6/6"; break; 	//2nd Cleaning, please wait 6/6
				case 26: msg = "2. čišćenje, aktivno 6/6"; break; 	//2nd Cleaning, active 6/6
				
				case 27: msg = "Želite li ponoviti ciklus čišćenja 2/2?"; break; 	//Do you want to repeat clean cycle 2/2 ?
				
				case 28: msg = "Želite li preskočiti zadnju kavu ?"; break; //Do you want to skip the final coffee ?
				case 29: msg = "Kava se isporučuje, pričekati"; break; //Coffee delivery, please wait

				case 30: msg = "Ispiranje grupe kave"; break; //Brewer Rinsing 
				case 31: msg = "Mikser 1 - ispiranje"; break; //Mixer 1 Rinsing
				case 32: msg = "Mikser 2 - ispiranje"; break; //Mixer 2 Rinsing
				case 33: msg = "Mikser 3 - ispiranje"; break; //Mixer 3 Rinsing 
				case 34: msg = "Čišćenje grupe kave završeno. Pritisni ZATVORI za završetak"; break; //Brewer Cleaning Done. Press CLOSE to exit
				case 35: msg = "Želiš li izvršiti RUČNO ili AUTOMATSKO pranje?"; break; //Do you want to perform MANUAL or AUTOMATIC washing?
			}
			...
			if ( (me.fase != me.prevFase) || ( me.fase == me.prevFase && (me.btn1 != me.prevFaseBtn1 || me.btn2 != me.prevFaseBtn2) ))
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							case 1:  btnText = "NASTAVI"; break;
							case 12: btnText = "NE"; break; //Do you want to repeat clean cycle 1/2 ?
							case 14:  btnText = "NASTAVI"; break;
							case 27: btnText = "NE"; break; //Do you want to repeat clean cycle 2/2 ?
							case 28: btnText = "PRESKOČI KAVU"; break; //Do you want to skip the final coffee ?
							case 34: btnText = "ZATVORI"; break; //Do you want to skip the final coffee ?
							case 35: btnText = "AUTOMATSKO"; break;
				...
				else
				{
					...
					switch (me.fase)
					{
						...
						case 28: btnText = "UZMI KAVU"; break; //Do you want to skip the final coffee ?
						case 35: btnText = "RUČNO"; break;
					}
					pleaseWait_btn2_setText (btnText);
					pleaseWait_btn2_show();	
				}
...
TaskCleaning.prototype.priv_handleMilkWashingVenturi = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 1: pleaseWait_freeText_setText("Čišćenje modula mlijeka je započelo"); break;	//Milker Cleaning is started
				case 2: pleaseWait_freeText_setText("Zagrijavanje za čistač"); break;	//Warming for cleaner
				case 3: pleaseWait_freeText_setText("Čeka se potvrda"); break;	//Wait for confirm
				case 4: pleaseWait_freeText_setText("Ciklusi čišćenja u tijeku"); break;	//Doing cleaner cycles (12)
				case 5: pleaseWait_freeText_setText("Zagrijavanje za vodu"); break;	//Warming for water
				case 6: pleaseWait_freeText_setText("Čeka se druga potvrda"); break;	//Wait for second confirm
				case 7: pleaseWait_freeText_setText("Ciklusi čišćenja u tijeku"); break;	//Doing cleaner cycles (12)
				default: pleaseWait_freeText_setText(""); break;
			}
			pleaseWait_freeText_show();
			...
			else
			{
				switch (me.fase)
				{
					default: pleaseWait_btn1_setText ("DUGME " +me.btn2); break;
					case 2:  pleaseWait_btn1_setText ("POČETAK"); break;
					case 3:
					case 5:  pleaseWait_btn1_setText ("NASTAVI"); break;
					case 6:  pleaseWait_btn1_setText ("POTVRDI"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			{
				pleaseWait_btn2_setText ("DUGME " +me.btn2);
				pleaseWait_btn2_show();	
			}			
		})
		.catch( function(result)
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "Prije nego što počneš s čišćenjem, provjeri:<ol><li>je li omogućena dostava vode</li><li>je li spremnik za višak ispražnjen</li><li>je li cijev za mlijeko u vrču za čišćenje</li><li>je li deterdžent napunjen u vrč</li></ol>");
			...
			else
			{
				...
				case 2:	//CIC_STEP_FILL_WATER
					...
					pleaseWait_freeText_setText("Punjenje vode u tijeku, pričekati.<br>Vodljivost vode: {0} uS".translateLang(cond_uS)); //Water refilling in progress, please wait.<br>Water conducibility: {0} uS
					break;

				case 3:	//CIC_WAIT_FOR_TABLET_DISSOLVING
					var timeSec = parseInt(obj.buffer8[0]);
					pleaseWait_freeText_setText("Čišćenje u tijeku:-{0}".translateLang(timeSec)); //Rinsing -{0}
					break;
				...
				case 5:	//CIC_cleaning_PHASE2
					...
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Čišćenje {0} od {1} u tijeku, pričekati.<br>Vodljivost vode: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Rinsing {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 6: //CIC_RINSING_PHASE3
					...
					var ciclo_di = parseInt(obj.buffer8[3]);
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Ispiranje {0} od {1} u tijeku, pričekati.<br>Vodljivost vode: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Cleaning {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					...
					pleaseWait_freeText_setText("Postupak čišćenja je završen.<br><br>Ne zaboravi:<ul><li>isprazniti spremnik za višak</li><li>vratiti cijev za mlijeko u prijašnji položaj</li></ul><br>Pritisni <br>ZATVORI za zatvaranje ovog prozora i provjeri mlijeko".translateLang(cond_uS_init_rif,cond_uS_finale)); //The cleaning procedure is finished.<br><Initial conducibility {0} and current conducibility {1},><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;

				case 9: //CIC_WAIT_CONF_LIQUID_DETERGENT
					pleaseWait_freeText_setText("dodajte deterdžent u mosuda mlijeko, stavi prazan vrč na mjesto za šalicu i pritisni &quot;STARTI&quot;.<br><br><center><img src='img/milkerInduxClean05.jpg'></center>"); //Please fill liquid detergent and push START
					break;
					
				case 97: //CIC_TOO_MUCH_DETERGENTE
					pleaseWait_freeText_setText("UPOZORENJE: previše deterdženta!");
					break;
				
				case 98: //CIC_DET_TOO_LOW
					pleaseWait_freeText_setText("UPOZORENJE: otkrivena preniska razina deterdženta!<br>Preporučuje se ponovno čišćenje.");
					break;

				case 99: //CIC_DET_TOO_AGGRESSIVE
					pleaseWait_freeText_setText("UPOZORENJE: preagresivan deterdžent!");
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						pleaseWait_btn1_setText ("NASTAVI");
					else
						pleaseWait_btn1_setText ("POČETAK");
					break;
				case 7:		pleaseWait_btn1_setText ("ZATVORI"); break;
				case 9:		pleaseWait_btn1_setText ("POČETAK"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			else
			{
				...
				case 1:	 pleaseWait_btn2_setText ("PREKINI"); break;
				case 7:	 pleaseWait_btn2_setText ("ZATVORI NE IZBOR MLIJEKA"); break;
				}
				pleaseWait_btn2_show();	
			}	
...
TaskCalibMotor.prototype.showPopupCalibrazioneEVPump = function (ev1_5)
{
	...
	pleaseWait_btn1_setText("PREKINI");
	pleaseWait_btn1_show();
}
...
console.log ("TaskCalibMotor::fase[" +me.fase +"]");
	...
	case 0:
		...
		pleaseWait_calibration_setText("PRIČEKATI, MOTOR RADI"); //Please wait while motor is running
	...
	case 20:
		...
		pleaseWait_calibration_setText("Kad završiš, unesi količinu ZADNJEG mljevenja u gramima i pritisni NASTAVI"); //Please enter the quantity, then press CONTINUE
	...
	case 40:
		...
		{
			pleaseWait_calibration_setText("Nevažeća vrijednost");
			me.fase = 20;
			break;
		}
	
		pleaseWait_calibration_setText("Spremljena vrijednost ...");
		me.value = pleaseWait_calibration_num_getValue();
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Ukloni grupu kave i pritisni NASTAVI, pripremi se za preuzimanje kave"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("PREKINI");
		pleaseWait_btn2_show();	
...
//console.log ("TaskCalibMotor.priv_handleCalibMacina() => runMotor, m="  +me.motor);
	...
	case 25:	//qui ci andiamo se siamo in fase 21 e l'utente preme il btn SET per impostare una nuova apertura del VGrind
		pleaseWait_calibration_setText("Pričekati dok varigrind ne prilagodi svoj položaj"); //Please wait while the varigrind is adjusting its position
	...
	case 28:
		if (da3.isGruppoVariflex())
		{
			rhea.ajax ("getPosMacina", {"m":(me.motor-10)}).then( function(result)
			{
				var obj = JSON.parse(result);
				rheaSetDivHTMLByName("pagePleaseWait_calibration_1_vg", obj.v);
				pleaseWait_calibration_setText("Pričekati dok varigrind ne prilagodi svoj položaj" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position  [current pos]
			})
			.catch( function(result)
			{
			});	
...
//console.log	("TaskCalibMotor.priv_handleCalibMacina: setFattoreCalib m=" +me.motor +",v=" +me.gsec);		
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Postavi grupu kave na mjesto i pritisni NASTAVI"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_show();
		me.fase = 41;
		break;
	...
	case 60: //gruppo è stato ricollegato, procedo con il calcolo impulsi se richiesto
		...
		else
		{
			me.fase = 65;
			pleaseWait_calibration_show();
			pleaseWait_calibration_setText("Izračun impulsa u tijeku, pričekati"); //Impulse calculation in progress, please wait
...
TaskTestSelezione.prototype.priv_handleTestMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Ukloni grupu kave i pritisni NASTAVI"); //Please remove the brewer, then press CONTINUE
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("PREKINI");
		pleaseWait_btn2_show();
	...
	case 10:  //ok, il gruppo è scollegato, chiedo a CPU di attivare la macina
		me.fase = 11;
		pleaseWait_calibration_setText ("Mlin radi"); //Grinder is running
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Postavi grupu kave na mjesto i pritisni NASTAVI ili pritisni PONOVI za ponovljeno mljevenje"); //Place the brewer into position then press CONTINUE, or press REPEAT to grind again
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("PONOVI");
		pleaseWait_btn2_show();		
		me.fase = 41;
		break;
...
TaskDevices.prototype.priv_handleSnackProg = function(timeNowMsec)
{
	...
	case 0:
		this.fase = 10;
		pleaseWait_rotella_hide();
		pleaseWait_btn1_setText("NAPUSTI PROGRAMIRANJE");
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleRichiestaPosizioneMacina = function()
{
	...
	rhea.ajax ("getCupSensorLiveValue", "" ).then( function(result)
	{
		...
		default: rheaSetDivHTMLByName("divCupSensorLiveValueBrewmatic", "NIJE OTKRIVENA ŠALICA"); break;
		}
		
		//nel caso di sensore Wenglor
		switch (parseInt(result))
		{
		default: rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "NIJE OTKRIVENA ŠALICA"); break;
		case 1:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "MALA ŠALICA (dolje)"); break;
		case 2:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "MALA ŠALICA (gore)"); break;
		case 3:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "VELIKA ŠALICA"); break;
		}		
	})
	.catch( function(result)
	{
...
TaskDevices.prototype.priv_handleRegolazionePosizioneMacina = function()
{
	switch (this.fase)
	{
		case 0: 
			...
			pleaseWait_freeText_setText("Pričekati dok varigrind ne prilagodi svoj položaj"); //Please wait while the varigrind is adjusting its position
			pleaseWait_freeText_show();
...
TaskDevices.prototype.priv_queryMacina = function(macina_1o2)
{
	...
	rhea.ajax ("getPosMacina", {"m":macina_1o2}).then( function(result)
	{
		...
		pleaseWait_freeText_setText("Pričekati dok varigrind ne prilagodi svoj položaj" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position [current_value]
	})
	.catch( function(result)
	{
	});			
...
TaskDevices.prototype.priv_handleTestAssorbGruppo = function(timeNowMsec)
{
	...
	{
	case 0:
		pleaseWait_freeText_setText ("Test počinje...");
		pleaseWait_freeText_show();
		pleaseWait_rotella_show();
		me.fase = 1;
		me.test_fase = 0;
	...
	case 10:
		...
		pleaseWait_freeText_setText ("Test u tijeku, pričekati...<br>Trenutna faza: " +me.test_fase +"/5");
		me.fase = 11;
		break;
	...
	case 11:
		...
		rhea.ajax ("getStatTestAssGrp", "" ).then( function(result)
		{
			...
			{
				//errore
				pleaseWait_freeText_setText ("Test je dovršen.<br>Result: FAILED<br><br>");
				pleaseWait_btn1_setText("ZATVORI");
				pleaseWait_btn1_show();	
				pleaseWait_btn2_setText("PONOVI");
				pleaseWait_btn2_show();	
				me.fase = 80;
			...
			else
			{
				...
				else
				{
					...
					var html = "<table class='dataAudit'>"
								...
								+"</table>";
					pleaseWait_freeText_setText ("Test je dovršen.<br>Results:<br><br>" +html);		
					pleaseWait_btn1_setText("ZATVORI");
					pleaseWait_btn1_show();	
					pleaseWait_btn2_setText("PONOVI");
					pleaseWait_btn2_show();	
...
TaskDevices.prototype.priv_handleTestAssorbMotoriduttore = function(timeNowMsec)
{
	...
	case 0: //prego rimuovere il gruppo
		me.fase = 1;
		pleaseWait_show();
		pleaseWait_freeText_setText ("Ukloni grupu kave i pritisni NASTAVI");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("PREKINI");
	...
	case 20:
		//ho ricevuto l'OK dal comando start Test. Da ora in poi, pollo lo stato del test fino a che non finisce
		pleaseWait_freeText_setText ("Test u tijeku, pričekati...<br>Trenutna faza: " +me.test_fase +"/4");
		me.fase = 21;
		break;
	...
	case 85: //prego rimettere a posto il gruppo
		pleaseWait_freeText_setText("Postavi grupu kave na mjesto i pritisni NASTAVI"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		pleaseWait_rotella_show();
		me.fase = 86;
...
TaskDevices.prototype.priv_handleGrinderSpeedTest = function(timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>BRZINA MLINA ZA OFF09</b><br><br>Ukloni grupu kave i pritisni NASTAVI"); //Please remove the brewer, then press CONTINUE
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("PREKINI");
	...
	case 5: //step 1
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>BRZINA MLINA ZA OFF09</b><br><br>KORAK 1<br>Zatvoriti spremnik za kavu</b> (narančasta poluga) i pritisni NASTAVI. Mlin će raditi oko 10 sekundi kako bi ispraznio mlin.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("PREKINI");
	...
	case 20:
		me.fase = 21;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>BRZINA MLINA ZA OFF09</b><br><br>KORAK 2<br>Sad kad je mlin prazan, možemo testirati kako bi otkrili prosječnu vrijednost senzora prijavljenu kad je mlin prazan. Pritisni NASTAVI za nastavak. Mlin će raditi oko 10 sekundi.");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("PREKINI");
	...
	case 40:
		me.fase = 41;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>BRZINA MLINA ZA OFF09</b><br><br>KORAK 3<br>Sad <b>otvori spremnik za kavu</b> (narančasta poluga) i zatim pritisni NASTAVI za nastavak. Mlin če raditi oko 10 sekundi.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("PREKINI");
	...
	case 60:
		me.fase = 61;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>BRZINA MLINA ZA OFF09</b><br><br>REZULTAT:<br>Prosječna brzina kad je mlin prazan: <b>" +me.speed1 +"</b><br>Prosječna brzina kad mlin nije prazan: <b>" +me.speed2 +"</b><br>");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ZATVORI");
		pleaseWait_btn1_show();
		break;
	...
	case 70: //chiedo di rimettere a posto il gruppo
		...
		else
		{
			me.fase = 71;
			pleaseWait_rotella_hide();
			pleaseWait_freeText_setText("<b>BRZINA MLINA ZA OFF09</b><br><br>Postavi grupu kave na mjesto i pritisni NASTAVI"); //Place the brewer into position, then press CONTINUE
			pleaseWait_freeText_show();
			pleaseWait_btn1_setText("NASTAVI");
			pleaseWait_btn1_show();
		}
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_freeText_show();
		pleaseWait_freeText_setText("DEINSTALACIJA<br><br>Je li posuda za kapi prazna?"); //DISINTALLATION<br><br>Is driptray empty?
		pleaseWait_btn1_setText("DA-NASTAVI");
		pleaseWait_btn2_setText("PREKINI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 10:
		this.fase = 11;
		pleaseWait_freeText_setText("DEINSTALACIJA<br><br>Ukloniti ostatke kave i pritisnuti NASTAVI"); //DISINTALLATION<br><br>Please remove coffee grounds, then press CONTINUE
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn2_setText("PREKINI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
	...
	case 20:
		this.fase = 21;
		pleaseWait_freeText_setText("DEINSTALACIJA<br><br>Pritisni ZAPOČNI DEINSTALACIJU za nastavak, ODUSTANI za prekid operacije"); //DISINTALLATION<br><br>Press START DISINSTALLATION to continue, ABORT to cancel the operation
		pleaseWait_btn1_setText("ZAPOČNI DEINSTALACIJU");
		pleaseWait_btn2_setText("PREKINI");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("DEINSTALACIJA u tijeku, pričekati ...<br><br><br>Pritisni dugme PROG za odustajanje"); //DISINTALLATION is running, please wait
		else
			pleaseWait_freeText_setText("DEINSTALACIJA u tijeku, pričekati ..."); //DISINTALLATION is running, please wait
	...
	case 40:
		var msgToOutput = "DEINSTALACIJA završena, ISKLJUČITI uređaj"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "DEINSTALACIJA završena, ZATVORITI slavinu bojlera i ISKLJUČITI uređaj"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
	...
	case 51:
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("DEINSTALACIJA<br><br>Otvori slavinu bojlera i pritisni NASTAVAK ...<br><br><br>Pritisni dugme PROG za odustajanje"); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
		else
			pleaseWait_freeText_setText("DEINSTALACIJA<br><br>Otvori slavinu bojlera i pritisni NASTAVAK ..."); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
...
TaskDataAudit.prototype.onTimer = function (timeNowMsec)
{
	...
	switch (this.fase)
	{
		...
		case 10: //eva dts scaricato
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			me.fase = 20;
			pleaseWait_freeText_appendText ("<br>Završeno. Obrada podataka u tijeku, pričekati<br>"); //Done, processing data, please wait
			break;
		...
		case 200: //errore downloading eva-dts
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			pleaseWait_freeText_appendText("Greška pri preuzimanju EVA-DTS-a. Pokušati ponovo kasnije"); //Error downloading EVA-DTS. Please try again later
			me.fase = 201;
			break;
...
TaskGrinderClean.prototype.onEvent_cpuStatus  	= function(statusID, statusStr, flag16)		{ this.cpuStatus = statusID; pleaseWait_header_setTextL ("ČIŠĆENJE MLINA"); }
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	...
	var msg = "Ciklus mlina u tijeku {0} od {1]".translateLang(this.curCiclo,this.numCicli);
	msg += "<br><br><b>Preuzmi proizvod</b>";
	this.priv_show (msg, "", "");	
...
TaskGrinderClean.prototype.runGrinderCycle_3 = function(timeNowMsec)
{
	...
	var msg = "Ciklus mlina u tijeku {0} od {1]".translateLang(this.curCiclo-1,this.numCicli);
	msg += "<br>" +"Pričekaj {0} sek.".translateLang(timeLeftSec);
	this.priv_show (msg, "", "");	
	if (timeLeftMSec <= 0)
		this.runGrinderCycle_1();
}
...
//console.log ("fase="+this.fase);	
	...
	{
		pleaseWait_freeText_setText ("<b>ČIŠĆENJE MLINA</b><br><br>" + text);
		pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step1 = function()
{
	...
	this.priv_show ("&nbsp;", "NASTAVI", "PREKINI");
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	var msg = "Zatvori poklopac spremnika za zrna da ne dođe do gubitka zrna.";
	msg += "<br>Pritisni NASTAVI kad završi.";
	this.priv_show (msg, "NASTAVI", "");
}
...
TaskGrinderClean.prototype.step3 = function()
{
	...
	var msg = "Ukloni grupu kave i spremnik za zrna.";
	msg += "<br>Pritisni NASTAVI kad završi.";
	this.priv_show (msg, "NASTAVI", "");
}
...
TaskGrinderClean.prototype.step5 = function()
{
	...
	var msg = "Instaliraj uređaj za čišćenje mlina.";
	msg += "<br>Pritisni NASTAVI kad završi.";	
	this.priv_show (msg, "NASTAVI", "");	
}
...
TaskGrinderClean.prototype.step6 = function()
{
	...
	var msg = "Dopuni uređaj za čišćenje.";
	msg += "<br>Pritisni NASTAVI kad završi.";
	msg += "<br><br><br>UPOZORENJE:<br>čim pritisneš NASTAVI, mlin će se pokrenuti";
	this.priv_show (msg, "NASTAVI", "");	
}
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("Želiš li ponoviti cikluse mlina?", "NE", "DA");
}
...
TaskGrinderClean.prototype.step23 = function()
{
	...
	var msg = "Otvori poklopac spremnika.";
	msg += "<br>Pritisni NASTAVI kad završi.";
	msg += "<br><br><br>UPOZORENJE:<br>čim pritisneš NASTAVI, mlin će se pokrenuti";
	this.priv_show (msg, "NASTAVI", "");	
}
...
TaskGrinderClean.prototype.step26 = function()
{
	...
	var msg = "Vrati grupu kave na mjesto.";
	msg += "<br>Pritisni NASTAVI kad završi.";
	this.priv_show (msg, "NASTAVI", "");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("Želite li ispustiti kavu?", "NE", "DA");
}
...
TaskCalibMilkPump.prototype.priv_handleCalibMilkPump = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_calibMilkPump_setText("Napuni spremnik za mlijeko vodom, stavi prazan vrč na mjesto za šalicu i pritisni &quot;NASTAVI&quot;.");
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		var btnText = "IZLAZ";
		pleaseWait_btn2_setText (btnText);
	...
	case 12:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
	    pleaseWait_calibMilkPump_setText("Pričekati dok voda ne iscuri"); 
	...
	case 13:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
		pleaseWait_calibMilkPump_setText("Isprazniti vrč na mjestu za šalicu i pritisnuti &quot;NASTAVI&quot;");
		pleaseWait_btn1_setText("NASTAVI");
		pleaseWait_btn1_show();
		break;	
	...
	case 20:
		...
		pleaseWait_calibMilkPump_setText("Kada završiš, unesi količinu POSLJEDNJE ispuštene vode u ml,<br> maks 340 ml<br> zatim pritisni NASTAVI<br><br>"); //Please enter the quantity, then press CONTINUE
...
TaskCleaning.prototype.priv_handleSyrupCleaning = function (timeElapsedMSec)		//#4660
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = " "; break;
				case 1:		msg = "Place an one-liter tank with the correct quantity of detergent under the cup station, PritisnI NASTAVI kad završi."; break;			//SYRUP_CLEANING_PREPARE_TANK_UNDER_NOZZLES,
				case 2:		msg = "Hot water is flowing from the the nozzle in the tank with cleaning detergent. pričekati…..."; break;
				case 3:		msg = "Remove the tubes from the syrup bottles and place them in the cleaning solution tank, PritisnI NASTAVI kad završi."; break;
				case 4:		msg = "step 1 - Cleaning solution is flowing from the syrup tube nozzles. pričekati…..."; break;
				case 5:		msg = "step 1 - Please wait for the cleaning solution action…, pričekati…..."; break;
				case 6:		msg = "step 2 - Cleaning solution is flowing from the syrup tube nozzles. pričekati…..."; break;
				case 7:		msg = "step 2 - Please wait for the cleaning solution action…. pričekati…..."; break;
				case 8:		msg = "Place a clean empty tank under the cup station, PritisnI NASTAVI kad završi."; break;
				case 9:		msg = "Hot water is flowing from the the nozzle in the tank. pričekati…..."; break;
				case 10:	msg = "Place the syrup tubes in the cleaning water tank. PritisnI NASTAVI kad završi."; break;
				case 11:	msg = "Hot water  is flowing from the syrup tube nozzles."; break;
				case 12:	msg = "Check the syrup tubes. Do you want to repeat the rinsing ?  Press REPEAT to rinse again the tubes.. PritisnI NASTAVI kad završi."; break;
