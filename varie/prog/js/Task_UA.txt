...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_freeText_setText("Попередження: перше налаштування циклу приготування кави працює лише з комплектом нижнього поршня (з бічними прорізами) і контейнером  (з отвором у нижній частині), які можуть належним чином випускати промивну воду в піддон для збору крапель. Ви можете підтвердити, що ці компоненти встановлено??");
	pleaseWait_freeText_show();
	pleaseWait_btn1_setText("ПІДТВЕРДИТИ");
	pleaseWait_btn1_show();
	pleaseWait_btn2_setText("НІ");
...
TaskCleaning.prototype.priv_handleSanWashingMicro = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 0: pleaseWait_freeText_setText("Очищення заварювального блока не почалося (або закінчилося)"); break;	//Brewer Cleaning is not started (or ended)
				case 1: pleaseWait_freeText_setText("Розпочато очищення заварювального блока"); break; 	//Brewer Cleaning is started
				case 2: pleaseWait_freeText_setText("Заварювальний блок установлено"); break; 	//Brewer placed
				case 3: pleaseWait_freeText_setText("Вкладіть таблетку та натисніть СТАРТ"); break; //Put pastille and push START
				case 4: pleaseWait_freeText_setText("Інфузія"); break; //Infusion
				case 5: pleaseWait_freeText_setText("Цикли очищення заварювального блока 1"); break; // Brewer cleaning cycles 1
				case 6: pleaseWait_freeText_setText("Цикли очищення заварювального блока 2"); break;	// Brewer cleaning cycles 2
				case 7: pleaseWait_freeText_setText("Цикли очищення заварювального блока 3"); break;	// Brewer cleaning cycles 3
				case 8: pleaseWait_freeText_setText("Цикли очищення заварювального блока 4"); break;	// Brewer cleaning cycles 4
				case 9: pleaseWait_freeText_setText("Цикли очищення заварювального блока 5"); break;	// Brewer cleaning cycles 56
				case 10: pleaseWait_freeText_setText("Цикли очищення заварювального блока 6"); break;	// HC_STEP_BRW_6
				
				case 11: pleaseWait_freeText_setText("Повторити очищення?"); break;	//Repeat cleaning ?
				case 12: pleaseWait_freeText_setText("Установіть заварювальний блок і натисніть ПРОДОВЖИТИ після завершення"); break;	//Brewer placed in brush position, press CONTINUE when finished
				case 13: pleaseWait_freeText_setText("Пропустіть останню каву або зробіть каву"); break; //Skip final coffee or make a coffee
				case 14: pleaseWait_freeText_setText("Приготування кави"); break; //Coffee delivery
				...
				case 18:	//HC_STEP_MIXER_4
					...
					if (me.isEspresso)
						cleanMixNum++;
					pleaseWait_freeText_setText("Промивка " +cleanMixNum); //rinsing
					break; 	
			...
			if (me.fase != me.prevFase)
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							case 3:  btnText = "СТАРТ"; break; //HC_STEP_TABLET
							case 11: btnText = "НІ"; break; //HC_STEP_BRW_REPEAT
							case 12: btnText = "ПРОДОВЖИТИ"; break; //HC_STEP_BRW_BRUSH_POSITION
							case 13: btnText = "ПРОПУСТІТЬ КАВУ"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
						}
				...
				else
				{
					...
					switch (me.fase)
					{
						case 11: btnText = "ТАК"; break;//HC_STEP_BRW_REPEAT
						case 13: btnText = "ОТРИМАЙТЕ КАВУ"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
					}
...
TaskCleaning.prototype.priv_handleDescalingMilker = function (timeElapsedMSec)		//#4419
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = ". Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 2:		msg = "Спорожнення гідравлічного контуру, будь ласка, зачекайте..."; break;
				case 3:		msg = ". Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 4:		msg = "Приєднайте занурювальний насос до ємності з миючим засобом для видалення накипу. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 5:		msg = "Заповнення гідравлічного контуру мийним засобом для видалення накипу, будь ласка, зачекайте..."; break;
				case 6:		msg = "Перевірте рівень мийного засобу в повітряному резервуарі. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 7:		msg = "Початок заповнення гідравлічних труб мийним засобом для видалення накипу, будь ласка, зачекайте..."; break;
				case 8:		msg = "Зачекайте, поки почне діяти рідина для видалення накипу..."; break;
				case 9:		msg = "Рідина для видалення накипу починає стікати через випускні отвори, будь ласка, зачекайте..."; break;
				case 10:	msg = "start emptying and rinsing of the hydraulic circuit"; break;
				case 11:	msg = ". Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 12:	msg = "Спорожнення гідравлічного контуру, будь ласка, зачекайте..."; break;
				case 13:	msg = ". Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 14:	msg = "Змініть джерело подачі на резервуар для води. Приєднайте занурювальний насос до резервуару з водою. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 15:	msg = "Гідравлічний контур буде заповнений водою, будь ласка, зачекайте..."; break;
				case 16:	msg = "Перевірте рівень води в повітряному резервуарі. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 17:	msg = "Зливання води через випускні отвори."; break;
				case 18:	msg = "Подайте воду й перевірте зразок. Поставте чашку, щоб зібрати зразок. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 19:	msg = "Почніть зливати зразок через кожний випускний отвір."; break;
				case 20:	msg = "Перевірте зібраний зразок. Натисніть  ПРОДОВЖИТИ для продовження,  або ПОВТОРИТИ, щоб повторити попередні кроки для належного очищення гідравлічного контуру."; break;
				case 21:	msg = "Процедуру видалення накипу завершено, натисніть ЗАКРИТИ для завершення."; break;
			}
...
TaskCleaning.prototype.priv_handleDescalingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = "Відкрийте зливний кран бойлера. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 2:		msg = "Спорожнення гідравлічного контуру, будь ласка, зачекайте..."; break;
				case 3:		msg = "Закрийте зливний кран бойлера. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 4:		msg = "Приєднайте занурювальний насос до ємності з миючим засобом для видалення накипу. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 5:		msg = "Заповнення гідравлічного контуру мийним засобом для видалення накипу, будь ласка, зачекайте..."; break;
				case 6:		msg = "Перевірте рівень мийного засобу в повітряному резервуарі. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 7:		msg = "Початок заповнення гідравлічних труб мийним засобом для видалення накипу, будь ласка, зачекайте..."; break;
				case 8:		msg = "Зачекайте, поки почне діяти рідина для видалення накипу..."; break;
				case 9:		msg = "Рідина для видалення накипу починає стікати через випускні отвори, будь ласка, зачекайте..."; break;
				case 10:	msg = "Перевірте рідину, яка витікає з випускних отворів, аби переконатися, що очищення пройшло успішно."; break;
				case 11:	msg = "Відкрийте зливний кран бойлера. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 12:	msg = "Спорожнення гідравлічного контуру, будь ласка, зачекайте..."; break;
				case 13:	msg = "Закрийте зливний кран бойлера. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 14:	msg = "Змініть джерело подачі на резервуар для води. Приєднайте занурювальний насос до резервуару з водою. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 15:	msg = "Гідравлічний контур буде заповнений водою, будь ласка, зачекайте..."; break;
				case 16:	msg = "Перевірте рівень води в повітряному резервуарі. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 17:	msg = "Зливання води через випускні отвори."; break;
...
TaskCleaning.prototype.priv_handleSanWashingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: msg = ""; break;
				case 0: msg = "Триває очищення"; break;	//Cleaning is active
				case 1: msg = "Покладіть таблетку в заварювальний блок і натисніть ПРОДОВЖИТИ"; break; 	//Put the pastille in the brewer and press CONTINUE
				case 2: msg = "Заварювальний блок закритий"; break; 	//Brewer is closing
				case 3: msg = "Розчинення таблетки - цикл 1/2, зачекайте"; break; 	//Tablet dissolution 1/2, please wait
				case 4: msg = "Незабаром розпочнеться 2-й цикл розчинення"; break; 	//2nd dissolution cycle is about to starting
				case 5: msg = "Розчинення таблетки - цикл 2/2, зачекайте"; break; 	//Tablet dissolution 1/2, please wait

				case 6: msg = "1-е очищення, будь ласка, зачекайте 1/3"; break; 	//1st Cleaning, please wait 1/3
				case 7: msg = "1-е очищення, активний цикл 1/3"; break; 	//1st Cleaning, active 1/3
				case 8: msg = "1-е очищення, будь ласка, зачекайте 2/3"; break; 	//1st Cleaning, please wait 2/3
				case 9: msg = "1-е очищення, активний цикл 2/3"; break; 	//1st Cleaning, active 2/3
				case 10: msg = "1-е очищення, будь ласка, зачекайте 3/3"; break; 	//1st Cleaning, please wait 3/3
				case 11: msg = "1-е очищення, активний цикл 3/3"; break; 	//1st Cleaning, active 3/3

				case 12: msg = "Бажаєте повторити цикл очищення 1/2?"; break; 	//Do you want to repeat clean cycle 1/2 ?
				
				case 13: msg = "Заварювальний блок переходить у відкрите положення"; break; 	//Brewer is going into open position
				
				case 14: msg = "Виконайте ручну чистку й натисніть ПРОДОВЖИТИ після закінчення"; break; 	//Please, perform a manual brush and then press CONTINUE when finished
				
				case 15: msg = "2-е очищення, будь ласка, зачекайте 1/6"; break; 	//2nd Cleaning, please wait 1/6
				case 16: msg = "2-е очищення, активний цикл 1/6"; break; 	//2nd Cleaning, active 1/6
				case 17: msg = "2-е очищення, будь ласка, зачекайте 2/6"; break; 	//2nd Cleaning, please wait 2/6
				case 18: msg = "2-е очищення, активний цикл 2/6"; break; 	//2nd Cleaning, active 2/6
				case 19: msg = "2-е очищення, будь ласка, зачекайте 3/6"; break; 	//2nd Cleaning, please wait 3/6
				case 20: msg = "2-е очищення, активний цикл 3/6"; break; 	//2nd Cleaning, active 3/6
				case 21: msg = "2-е очищення, будь ласка, зачекайте 4/6"; break; 	//2nd Cleaning, please wait 4/6
				case 22: msg = "2-е очищення, активний цикл 4/6"; break; 	//2nd Cleaning, active 4/6
				case 23: msg = "2-е очищення, будь ласка, зачекайте 5/6"; break; 	//2nd Cleaning, please wait 5/6
				case 24: msg = "2-е очищення, активний цикл 5/6"; break; 	//2nd Cleaning, active 5/6
				case 25: msg = "2-е очищення, будь ласка, зачекайте 6/6"; break; 	//2nd Cleaning, please wait 6/6
				case 26: msg = "2-е очищення, активний цикл 6/6"; break; 	//2nd Cleaning, active 6/6
				
				case 27: msg = "Бажаєте повторити цикл очищення 2/2?"; break; 	//Do you want to repeat clean cycle 2/2 ?
				
				case 28: msg = "Бажаєте пропустити останню каву?"; break; //Do you want to skip the final coffee ?
				case 29: msg = "Готується кава, зачекайте."; break; //Coffee delivery, please wait

				case 30: msg = "Промивка  заварювального блока"; break; //Brewer Rinsing 
				case 31: msg = "Промивка Миксер 1"; break; //Mixer 1 Rinsing
				case 32: msg = "Промивка Миксер 2"; break; //Mixer 2 Rinsing
				case 33: msg = "Промивка Миксер 3"; break; //Mixer 3 Rinsing 
				case 34: msg = "Очищення заварювального блока здійснено. Натисніть ЗАКРИТИ для завершення"; break; //Brewer Cleaning Done. Press CLOSE to exit
				case 35: msg = "Бажаєте здійснити РУЧНУ або АВТОМАТИЧНУ мийку?"; break; //Do you want to perform MANUAL or AUTOMATIC washing?
			}
			...
			if ( (me.fase != me.prevFase) || ( me.fase == me.prevFase && (me.btn1 != me.prevFaseBtn1 || me.btn2 != me.prevFaseBtn2) ))
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							case 1:  btnText = "ПРОДОВЖИТИ"; break;
							case 12: btnText = "НІ"; break; //Do you want to repeat clean cycle 1/2 ?
							case 14:  btnText = "ПРОДОВЖИТИ"; break;
							case 27: btnText = "НІ"; break; //Do you want to repeat clean cycle 2/2 ?
							case 28: btnText = "ПРОПУСТІТЬ КАВУ"; break; //Do you want to skip the final coffee ?
							case 34: btnText = "ЗАКРИТО"; break; //Do you want to skip the final coffee ?
							case 35: btnText = "АВТОМАТИЧНИЙ"; break;
				...
				else
				{
					...
					switch (me.fase)
					{
						case 12: btnText = "ТАК"; break; //Do you want to repeat clean cycle 1/2 ?
						case 27: btnText = "ТАК"; break; //Do you want to repeat clean cycle 2/2 ?
						case 28: btnText = "ОТРИМАЙТЕ КАВУ"; break; //Do you want to skip the final coffee ?
						case 35: btnText = "РУЧНИЙ"; break;
					}
					pleaseWait_btn2_setText (btnText);
					pleaseWait_btn2_show();	
				}
...
TaskCleaning.prototype.priv_handleMilkWashingVenturi = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 1: pleaseWait_freeText_setText("Розпочато очищення капучинатора"); break;	//Milker Cleaning is started
				case 2: pleaseWait_freeText_setText("Нагрівання для очищення"); break;	//Warming for cleaner
				case 3: pleaseWait_freeText_setText("Очікування підтвердження"); break;	//Wait for confirm
				case 4: pleaseWait_freeText_setText("Виконання циклів очищення (12)"); break;	//Doing cleaner cycles (12)
				case 5: pleaseWait_freeText_setText("Нагрівання води"); break;	//Warming for water
				case 6: pleaseWait_freeText_setText("Очікування другого підтвердження"); break;	//Wait for second confirm
				case 7: pleaseWait_freeText_setText("Виконання циклів очищення (12)"); break;	//Doing cleaner cycles (12)
				default: pleaseWait_freeText_setText(""); break;
			}
			pleaseWait_freeText_show();
			...
			else
			{
				switch (me.fase)
				{
					default: pleaseWait_btn1_setText ("КНОПКА " +me.btn2); break;
					case 2:  pleaseWait_btn1_setText ("СТАРТ"); break;
					case 3:
					case 5:  pleaseWait_btn1_setText ("ПРОДОВЖИТИ"); break;
					case 6:  pleaseWait_btn1_setText ("ПІДТВЕРДИТИ"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			{
				pleaseWait_btn2_setText ("КНОПКА " +me.btn2);
				pleaseWait_btn2_show();	
			}			
		})
		.catch( function(result)
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "Перед початком очищення переконайтеся, що:<ol><li>подача води доступна</li><li>бак для відходів порожній</li><li>молочна трубка знаходиться в ємності для очищення</li>< li>мийний засіб заливається в ємність</li></ol>");
			...
			else
			{
				...
				case 2:	//CIC_STEP_FILL_WATER
					...
					pleaseWait_freeText_setText("Виконується долив води, зачекайте.<br>Провідність води: {0} uS".translateLang(cond_uS)); //Water refilling in progress, please wait.<br>Water conducibility: {0} uS
					break;

				case 3:	//CIC_WAIT_FOR_TABLET_DISSOLVING
					var timeSec = parseInt(obj.buffer8[0]);
					pleaseWait_freeText_setText("Виконується очищення: -{0}".translateLang(timeSec)); //Rinsing -{0}
					break;
				...
				case 5:	//CIC_cleaning_PHASE2
					...
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Триває очищення {0} з {1}, зачекайте.<br>Провідність води: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Rinsing {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 6: //CIC_RINSING_PHASE3
					...
					var ciclo_di = parseInt(obj.buffer8[3]);
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Триває промивання {0} з {1}, зачекайте.<br>Провідність води:{2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Cleaning {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					...
					pleaseWait_freeText_setText("Процедуру очищення завершено.<br><br>Не забудьте:<ul><li>спорожнити резервуар для відходів</li><li>повернути трубку для молока на місце</li></ul><br >Натисніть <br>ЗАКРИТИ, щоб закрити це вікно й перевірити наявність молока або натисніть<br> ЗАКРИТИ ОПЦІЮ БЕЗ ВИБОРУ МОЛОКА, якщо ви не бажаєте, щоб був активований вибір молока".translateLang(cond_uS_init_rif,cond_uS_finale)); //The cleaning procedure is finished.<br><Initial conducibility {0} and current conducibility {1},><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;

				case 9: //CIC_WAIT_CONF_LIQUID_DETERGENT
					pleaseWait_freeText_setText("додайте миючий засіб у резервуар для молока, поставте порожній глечик у станцію для чашок, а потім натисніть «СТАРТ».<br><br><center><img src='img/milkerInduxClean05.jpg'></center>"); //Please fill liquid detergent and push START
					break;
					
				case 97: //CIC_TOO_MUCH_DETERGENTE
					pleaseWait_freeText_setText("УВАГА: забагато мийного засобу!");
					break;
				
				case 98: //CIC_DET_TOO_LOW
					pleaseWait_freeText_setText("УВАГА: виявлено низький рівень мийного засобу!<br>Рекомендовано ще одне очищення");
					break;

				case 99: //CIC_DET_TOO_AGGRESSIVE
					pleaseWait_freeText_setText("УВАГА: мийний засіб занадто агресивний");
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						pleaseWait_btn1_setText ("ПРОДОВЖИТИ");
					else
						pleaseWait_btn1_setText ("СТАРТ");
					break;
				case 7:		pleaseWait_btn1_setText ("ЗАКРИТИ"); break;
				case 9:		pleaseWait_btn1_setText ("СТАРТ"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			else
			{
				...
				case 1:	 pleaseWait_btn2_setText ("СКАСУВАТИ"); break;
				case 7:	 pleaseWait_btn2_setText ("ЗАКРИТИ БЕЗ ВИБОРУ МОЛОКА"); break;
				}
				pleaseWait_btn2_show();	
			}	
...
TaskCalibMotor.prototype.showPopupCalibrazioneEVPump = function (ev1_5)
{
	...
	pleaseWait_btn1_setText("СКАСУВАТИ");
	pleaseWait_btn1_show();
}
...
console.log ("TaskCalibMotor::fase[" +me.fase +"]");
	...
	case 0:
		...
		pleaseWait_calibration_setText("Зачекайте, поки двигун працює"); //Please wait while motor is running
	...
	case 20:
		...
		pleaseWait_calibration_setText("Після закінчення введіть кількість у грамах ОСТАННЬОГО помелу, потім натисніть ПРОДОВЖИТИ"); //Please enter the quantity, then press CONTINUE
	...
	case 40:
		...
		{
			pleaseWait_calibration_setText("Недійсне значення");
			me.fase = 20;
			break;
		}
	
		pleaseWait_calibration_setText("Збереження значення ...");
		me.value = pleaseWait_calibration_num_getValue();
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Зніміть заварювальний блок, потім натисніть ПРОДОВЖИТИ й будьте готові взяти каву"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("СКАСУВАТИ");
		pleaseWait_btn2_show();	
...
//console.log ("TaskCalibMotor.priv_handleCalibMacina() => runMotor, m="  +me.motor);
	...
	case 25:	//qui ci andiamo se siamo in fase 21 e l'utente preme il btn SET per impostare una nuova apertura del VGrind
		pleaseWait_calibration_setText("Зачекайте, поки varigrind регулює своє положення"); //Please wait while the varigrind is adjusting its position
	...
	case 28:
		if (da3.isGruppoVariflex())
		{
			rhea.ajax ("getPosMacina", {"m":(me.motor-10)}).then( function(result)
			{
				var obj = JSON.parse(result);
				rheaSetDivHTMLByName("pagePleaseWait_calibration_1_vg", obj.v);
				pleaseWait_calibration_setText("Зачекайте, поки varigrind регулює своє положення" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position  [current pos]
			})
			.catch( function(result)
			{
			});	
...
//console.log	("TaskCalibMotor.priv_handleCalibMacina: setFattoreCalib m=" +me.motor +",v=" +me.gsec);		
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Установіть заварювальний блок на місце й натисніть ПРОДОВЖИТИ"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_show();
		me.fase = 41;
		break;
	...
	case 60: //gruppo è stato ricollegato, procedo con il calcolo impulsi se richiesto
		...
		else
		{
			me.fase = 65;
			pleaseWait_calibration_show();
			pleaseWait_calibration_setText("Виконується підрахунок імпульсів, зачекайте"); //Impulse calculation in progress, please wait
...
TaskTestSelezione.prototype.priv_handleTestMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Вийміть заварювальний пристрій і натисніть ПРОДОВЖИТИ"); //Please remove the brewer, then press CONTINUE
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("СКАСУВАТИ");
		pleaseWait_btn2_show();
	...
	case 10:  //ok, il gruppo è scollegato, chiedo a CPU di attivare la macina
		me.fase = 11;
		pleaseWait_calibration_setText ("Кавомолка працює"); //Grinder is running
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Установіть заварювальний пристрій на місце й натисніть ПРОДОВЖИТИ, або натисніть ПОВТОРИТИ, щоб знову змолоти каву"); //Place the brewer into position then press CONTINUE, or press REPEAT to grind again
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ПОВТОРИТИ");
		pleaseWait_btn2_show();		
		me.fase = 41;
		break;
...
TaskDevices.prototype.priv_handleSnackProg = function(timeNowMsec)
{
	...
	case 0:
		this.fase = 10;
		pleaseWait_rotella_hide();
		pleaseWait_btn1_setText("ВИХІД З ПРОГРАМУВАННЯ");
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleRichiestaPosizioneMacina = function()
{
	...
	rhea.ajax ("getCupSensorLiveValue", "" ).then( function(result)
	{
		...
		default: rheaSetDivHTMLByName("divCupSensorLiveValueBrewmatic", "ЧАШКУ НЕ ВИЯВЛЕНО"); break;
		}
		
		//nel caso di sensore Wenglor
		switch (parseInt(result))
		{
		default: rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "ЧАШКУ НЕ ВИЯВЛЕНО"); break;
		case 1:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "МАЛА ЧАШКА (вниз)"); break;
		case 2:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "МАЛА ЧАШКА (вгору)"); break;
		case 3:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "ВЕЛИКА ЧАШКА"); break;
		}		
	})
	.catch( function(result)
	{
...
TaskDevices.prototype.priv_handleRegolazionePosizioneMacina = function()
{
	switch (this.fase)
	{
		case 0: 
			...
			pleaseWait_freeText_setText("Зачекайте, поки varigrind регулює своє положення"); //Please wait while the varigrind is adjusting its position
			pleaseWait_freeText_show();
...
TaskDevices.prototype.priv_queryMacina = function(macina_1o2)
{
	...
	rhea.ajax ("getPosMacina", {"m":macina_1o2}).then( function(result)
	{
		...
		pleaseWait_freeText_setText("Зачекайте, поки varigrind регулює своє положення" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position [current_value]
	})
	.catch( function(result)
	{
	});			
...
TaskDevices.prototype.priv_handleTestAssorbGruppo = function(timeNowMsec)
{
	...
	{
	case 0:
		pleaseWait_freeText_setText ("Тест розпочато...");
		pleaseWait_freeText_show();
		pleaseWait_rotella_show();
		me.fase = 1;
		me.test_fase = 0;
	...
	case 10:
		...
		pleaseWait_freeText_setText ("Тест виконується, зачекайте...<br>Поточний етап: " +me.test_fase +"/5");
		me.fase = 11;
		break;
	...
	case 11:
		...
		rhea.ajax ("getStatTestAssGrp", "" ).then( function(result)
		{
			...
			{
				//errore
				pleaseWait_freeText_setText ("Тест завершено.<br>Result: FAILED<br><br>");
				pleaseWait_btn1_setText("ЗАКРИТИ");
				pleaseWait_btn1_show();	
				pleaseWait_btn2_setText("ПОВТОРИТИ");
				pleaseWait_btn2_show();	
				me.fase = 80;
			...
			else
			{
				...
				else
				{
					...
					var html = "<table class='dataAudit'>"
								...
								+"</table>";
					pleaseWait_freeText_setText ("Тест завершено.<br>Results:<br><br>" +html);		
					pleaseWait_btn1_setText("ЗАКРИТИ");
					pleaseWait_btn1_show();	
					pleaseWait_btn2_setText("ПОВТОРИТИ");
					pleaseWait_btn2_show();	
...
TaskDevices.prototype.priv_handleTestAssorbMotoriduttore = function(timeNowMsec)
{
	...
	case 0: //prego rimuovere il gruppo
		me.fase = 1;
		pleaseWait_show();
		pleaseWait_freeText_setText ("Вийміть заварювальний пристрій і натисніть ПРОДОВЖИТИ");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("СКАСУВАТИ");
	...
	case 20:
		//ho ricevuto l'OK dal comando start Test. Da ora in poi, pollo lo stato del test fino a che non finisce
		pleaseWait_freeText_setText ("Тест виконується, зачекайте...<br>Поточний етап: " +me.test_fase +"/4");
		me.fase = 21;
		break;
	...
	case 85: //prego rimettere a posto il gruppo
		pleaseWait_freeText_setText("Установіть заварювальний блок на місце й натисніть ПРОДОВЖИТИ"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		pleaseWait_rotella_show();
		me.fase = 86;
...
TaskDevices.prototype.priv_handleGrinderSpeedTest = function(timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>ШВИДКІСТЬ КАВОМОЛКИ ДЛЯ OFF09</b><br><br>Вийміть заварювальний пристрій і натисніть ПРОДОВЖИТИ"); //Please remove the brewer, then press CONTINUE
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("СКАСУВАТИ");
	...
	case 5: //step 1
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>ШВИДКІСТЬ КАВОМОЛКИ ДЛЯ OFF09</b><br><br>КРОК 1<br>Закрийте кавовий контейнер (помаранчевий важіль) і натисніть ПРОДОВЖИТИ. Кавомолка працюватиме приблизно 10 секунд, щоб спорожнитися.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("СКАСУВАТИ");
	...
	case 20:
		me.fase = 21;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>ШВИДКІСТЬ КАВОМОЛКИ ДЛЯ OFF09</b><br><br>КРОК 2<br>Тепер, коли кавомолка порожня, ми можемо протестувати й визначити середнє значення датчика, що показує, коли кавомолка порожня. Натисніть ПРОДОВЖИТИ для подовження. Кавомолка працюватиме близько 10 секунд.");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("СКАСУВАТИ");
	...
	case 40:
		me.fase = 41;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>ШВИДКІСТЬ КАВОМОЛКИ ДЛЯ OFF09</b><br><br>КРОК 3<br>Тепер відкрийте кавовий контейнер </b> (помаранчевий важіль) і натисніть ПРОДОВЖИТИ для продовження. Кавомолка пропрацюватиме близько 10 секунд.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("СКАСУВАТИ");
	...
	case 60:
		me.fase = 61;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>ШВИДКІСТЬ КАВОМОЛКИ ДЛЯ OFF09</b><br><br>РЕЗУЛЬТАТ:<br>Середня швидкість кавомолки без зерен: <b>" +me.speed1 +"</b><br>Середня швидкість, коли кавомолка має зерна: <b>" +me.speed2 +"</b><br>");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ЗАКРИТО");
		pleaseWait_btn1_show();
		break;
	...
	case 70: //chiedo di rimettere a posto il gruppo
		...
		else
		{
			me.fase = 71;
			pleaseWait_rotella_hide();
			pleaseWait_freeText_setText("<b>ШВИДКІСТЬ КАВОМОЛКИ ДЛЯ OFF09</b><br><br>Установіть заварювальний блок на місце й натисніть ПРОДОВЖИТИ"); //Place the brewer into position, then press CONTINUE
			pleaseWait_freeText_show();
			pleaseWait_btn1_setText("ПРОДОВЖИТИ");
			pleaseWait_btn1_show();
		}
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_freeText_show();
		pleaseWait_freeText_setText("ДЕІНСТАЛЯЦІЯ <br><br> Піддон для крапель порожній?"); //DISINTALLATION<br><br>Is driptray empty?
		pleaseWait_btn1_setText("ТАК - ПРОДОВЖИТИ");
		pleaseWait_btn2_setText("СКАСУВАТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 10:
		this.fase = 11;
		pleaseWait_freeText_setText("ДЕІНСТАЛЯЦІЯ <br> <br> Видаліть кавову гущу й натисніть ПРОДОВЖИТИ"); //DISINTALLATION<br><br>Please remove coffee grounds, then press CONTINUE
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn2_setText("СКАСУВАТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
	...
	case 20:
		this.fase = 21;
		pleaseWait_freeText_setText("ДЕІНСТАЛЛЯЦІЯ <br> <br> Натисніть ПОЧАТИ ДЕІНСТАЛЛЯЦІЮ, щоб продовжити, СКАСУВАТИ, щоб скасувати операцію."); //DISINTALLATION<br><br>Press START DISINSTALLATION to continue, ABORT to cancel the operation
		pleaseWait_btn1_setText("ПОЧАТИ ДЕІНСТАЛЯЦІЮ");
		pleaseWait_btn2_setText("СКАСУВАТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("Здійснюється ДЕІНСТАЛЯЦІЯ, зачекайте ...<br><br><br>Натисніть кнопку PROG для скасування"); //DISINTALLATION is running, please wait
		else
			pleaseWait_freeText_setText("Здійснюється ДЕІНСТАЛЯЦІЯ, зачекайте ..."); //DISINTALLATION is running, please wait
	...
	case 40:
		var msgToOutput = "ДЕІНСТАЛЯЦІЯ завершена, вимкніть машину."; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "ДЕІНСТАЛЯЦІЯ завершена, ЗАКРИЙТЕ кран бойлера й ВИМКНІТЬ машину"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
	...
	case 51:
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("ДЕІНСТАЛЯЦІЯ <br> <br> Відкрийте кран бойлера, а потім натисніть ПРОДОВЖИТИ ...<br><br><br>Натисніть кнопку PROG для скасування"); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
		else
			pleaseWait_freeText_setText("ДЕІНСТАЛЯЦІЯ <br> <br> Відкрийте кран бойлера, а потім натисніть ПРОДОВЖИТИ ..."); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
...
TaskDataAudit.prototype.onTimer = function (timeNowMsec)
{
	...
	switch (this.fase)
	{
		...
		case 10: //eva dts scaricato
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			me.fase = 20;
			pleaseWait_freeText_appendText ("<br>Готово. Дані обробляються, зачекайте<br>"); //Done, processing data, please wait
			break;
		...
		case 200: //errore downloading eva-dts
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			pleaseWait_freeText_appendText("Помилка завантаження EVA-DTS. Будь-ласка спробуйте пізніше"); //Error downloading EVA-DTS. Please try again later
			me.fase = 201;
			break;
...
TaskGrinderClean.prototype.onEvent_cpuStatus  	= function(statusID, statusStr, flag16)		{ this.cpuStatus = statusID; pleaseWait_header_setTextL ("ОЧИЩЕННЯ КАВОМОЛКИ"); }
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	...
	var msg = "Триває очищення кавомолки {0} з {1}".translateLang(this.curCiclo,this.numCicli);
	msg += "<br><br><b>Заберіть продукт</b>";
	this.priv_show (msg, "", "");	
...
TaskGrinderClean.prototype.runGrinderCycle_3 = function(timeNowMsec)
{
	...
	var msg = "Триває очищення кавомолки {0} з {1}".translateLang(this.curCiclo-1,this.numCicli);
	msg += "<br>" +"Очікування {0} с.".translateLang(timeLeftSec);
	this.priv_show (msg, "", "");	
	if (timeLeftMSec <= 0)
		this.runGrinderCycle_1();
}
...
//console.log ("fase="+this.fase);	
	...
	{
		pleaseWait_freeText_setText ("<b>ОЧИЩЕННЯ КАВОМОЛКИ</b><br><br>" + text);
		pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step1 = function()
{
	...
	this.priv_show ("&nbsp;", "ПРОДОВЖИТИ", "СКАСУВАТИ");
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	var msg = "Закрийте засувку контейнера для кавових зерен, щоб уникнути їх втрати.";
	msg += "<br>Після завершення натисніть ПРОДОВЖИТИ.";
	this.priv_show (msg, "ПРОДОВЖИТИ", "");
}
...
TaskGrinderClean.prototype.step3 = function()
{
	...
	var msg = "Зніміть заварювальний блок і контейнер для кавових зерен.";
	msg += "<br>Після завершення натисніть ПРОДОВЖИТИ.";
	this.priv_show (msg, "ПРОДОВЖИТИ", "");
}
...
TaskGrinderClean.prototype.step5 = function()
{
	...
	var msg = "Установіть пристрій для очищення кавомолки.";
	msg += "<br>Після завершення натисніть ПРОДОВЖИТИ.";	
	this.priv_show (msg, "ПРОДОВЖИТИ", "");	
}
...
TaskGrinderClean.prototype.step6 = function()
{
	...
	var msg = "Заправте пристрій для очищення.";
	msg += "<br>Після завершення натисніть ПРОДОВЖИТИ.";
	msg += "<br><br><b>УВАГА:</b> щойно ви натиснете ПРОДОВЖИТИ, кавомолка почне працювати";
	this.priv_show (msg, "ПРОДОВЖИТИ", "");	
}
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("Бажаєте повторити цикли помелу?", "НІ", "ТАК");
}
...
TaskGrinderClean.prototype.step21 = function()
{
	...
	var msg = "Установіть на місце контейнер для кавових зерен.";
	msg += "<br>Після завершення натисніть ПРОДОВЖИТИ.";
	this.priv_show (msg, "ПРОДОВЖИТИ", "");
}
...
TaskGrinderClean.prototype.step23 = function()
{
	...
	var msg = "Відкрийте засувку контейнера для кавових зерен.";
	msg += "<br>Після завершення натисніть ПРОДОВЖИТИ.";
	msg += "<br><br><b>УВАГА:</b> щойно ви натиснете ПРОДОВЖИТИ, кавомолка почне працювати";
	this.priv_show (msg, "ПРОДОВЖИТИ", "");	
}
...
TaskGrinderClean.prototype.step26 = function()
{
	...
	var msg = "Установіть заварювальний блок на місце.";
	msg += "<br>Після завершення натисніть ПРОДОВЖИТИ.";
	this.priv_show (msg, "ПРОДОВЖИТИ", "");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("Бажаєте подати каву?", "НІ", "ТАК");
}
...
TaskCalibMilkPump.prototype.priv_handleCalibMilkPump = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_calibMilkPump_setText("Будь ласка, налийте воду в молочний резервуар, поставте порожній глечик у станцію для чашок, а потім натисніть «ПРОДОВЖИТИ».");
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		var btnText = "ВИХІД";
		pleaseWait_btn2_setText (btnText);
	...
	case 12:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
	    pleaseWait_calibMilkPump_setText("Зачекайте, поки подається вода"); 
	...
	case 13:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
		pleaseWait_calibMilkPump_setText("Спорожніть глечик на станції для чашок і натисніть «ПРОДОВЖИТИ»");
		pleaseWait_btn1_setText("ПРОДОВЖИТИ");
		pleaseWait_btn1_show();
		break;	
	...
	case 20:
		...
		pleaseWait_calibMilkPump_setText("Після закінчення введіть кількість у мл ОСТАННЬОЇ наданої води,<br> максимум 340 мл, <br>потім натисніть ПРОДОВЖИТИ<br><br>"); //Please enter the quantity, then press CONTINUE
...
TaskCleaning.prototype.priv_handleSyrupCleaning = function (timeElapsedMSec)		//#4660
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = " "; break;
				case 1:		msg = "Place an one-liter tank with the correct quantity of detergent under the cup station, Після завершення натисніть ПРОДОВЖИТИ."; break;			//SYRUP_CLEANING_PREPARE_TANK_UNDER_NOZZLES,
				case 2:		msg = "Hot water is flowing from the the nozzle in the tank with cleaning detergent. будь ласка, зачекайте......"; break;
				case 3:		msg = "Remove the tubes from the syrup bottles and place them in the cleaning solution tank, Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 4:		msg = "step 1 - Cleaning solution is flowing from the syrup tube nozzles. будь ласка, зачекайте......"; break;
				case 5:		msg = "step 1 - Please wait for the cleaning solution action…, будь ласка, зачекайте......"; break;
				case 6:		msg = "step 2 - Cleaning solution is flowing from the syrup tube nozzles. будь ласка, зачекайте......"; break;
				case 7:		msg = "step 2 - Please wait for the cleaning solution action…. будь ласка, зачекайте......"; break;
				case 8:		msg = "Place a clean empty tank under the cup station, Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 9:		msg = "Hot water is flowing from the the nozzle in the tank. будь ласка, зачекайте......"; break;
				case 10:	msg = "Place the syrup tubes in the cleaning water tank. Після завершення натисніть ПРОДОВЖИТИ."; break;
				case 11:	msg = "Hot water  is flowing from the syrup tube nozzles."; break;
				case 12:	msg = "Check the syrup tubes. Do you want to repeat the rinsing ?  Press REPEAT to rinse again the tubes.. Після завершення натисніть ПРОДОВЖИТИ."; break;
