...
function pleaseWait_setup()
{
	...
	document.getElementById("pagePleaseWait_freeBtn3").addEventListener		("mousedown", function(ev) 	{ currentTask.onFreeBtn3Clicked(ev); } , true);
...
{ 
	...
	pleaseWait_btn1_hide();	pleaseWait_btn2_hide();	pleaseWait_btnTrick_hide(); pleaseWait_btn3_hide();
...
function pleaseWait_btn3_show()							{ rheaShowElem(rheaGetElemByID("pagePleaseWait_freeBtn3")); }
function pleaseWait_btn3_hide()							{ rheaHideElem(rheaGetElemByID("pagePleaseWait_freeBtn3")); }
function pleaseWait_btn3_setText(s)						{ rheaSetDivHTMLByName("bntFree3Text", s); }
...
//********* usati durante la calibrazione/tuning della pompa latte cappuccinatore indux
function pleaseWait_calibMilkPump_show()				{ pleaseWait_calibMilkPump_num_hide(); pleaseWait_calibMilkPump_dispenseWater_hide(); rheaShowElem(rheaGetElemByID("pagePleaseWait_calibMilkPump")); }
function pleaseWait_calibMilkPump_hide()				{ pleaseWait_calibMilkPump_num_hide(); pleaseWait_calibMilkPump_dispenseWater_hide(); rheaHideElem(rheaGetElemByID("pagePleaseWait_calibMilkPump")); }
function pleaseWait_calibMilkPump_num_show()			{ rheaShowElem(rheaGetElemByID("pagePleaseWait_calibMilkPump_num")); }
function pleaseWait_calibMilkPump_num_hide()			{ rheaHideElem(rheaGetElemByID("pagePleaseWait_calibMilkPump_num")); }
function pleaseWait_calibMilkPump_num_setValue (v)		{ uiStandAloneCalbMilkPumpNum.setValue(parseInt(v)); }
function pleaseWait_calibMilkPump_num_getValue()		{ return uiStandAloneCalbMilkPumpNum.getValue(); }
function pleaseWait_calibMilkPump_setText(s)			{ rheaSetDivHTMLByName("pagePleaseWait_calibMilkPump_text", s); }
function pleaseWait_calibMilkPump_dispenseWater_show()	{ rheaShowElem(rheaGetElemByID("pagePleaseWait_calibMilkPump_1")); }
function pleaseWait_calibMilkPump_dispenseWater_hide()	{ rheaHideElem(rheaGetElemByID("pagePleaseWait_calibMilkPump_1")); }

//********* usati durante la calibrazione delle pompe EV solubili
function pleaseWait_calibEVPump_show()					{ rheaShowElem(rheaGetElemByID("pagePleaseWait_calibEVPump")); }
function pleaseWait_calibEVPump_hide()					{ rheaHideElem(rheaGetElemByID("pagePleaseWait_calibEVPump")); }	