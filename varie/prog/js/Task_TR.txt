		...
		.then( function(result) 
		{
			...
			if (me.fase != me.prevFase)
			{
				...
				else
				{
					...
					switch (me.fase)
					{
						case 11: btnText = "EVET"; break;//HC_STEP_BRW_REPEAT
		...
		.then( function(result) 
		{
			...
			if ( (me.fase != me.prevFase) || ( me.fase == me.prevFase && (me.btn1 != me.prevFaseBtn1 || me.btn2 != me.prevFaseBtn2) ))
			{
				...
				else
				{
					...
					switch (me.fase)
					{
						case 12: btnText = "EVET"; break; //Do you want to repeat clean cycle 1/2 ?
						case 27: btnText = "EVET"; break; //Do you want to repeat clean cycle 2/2 ?
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			else
			{
				...
				case 1:	 pleaseWait_btn2_setText ("İPTAL"); break;
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Please remove the brewer, then press CONTINUE and be prepared to catch coffee"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("CONTINUE");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("İPTAL");
		pleaseWait_btn2_show();	
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_freeText_show();
		pleaseWait_freeText_setText("UNINSTALLATION<br><br>Is driptray empty?"); //DISINTALLATION<br><br>Is driptray empty?
	...
	case 10:
		this.fase = 11;
		pleaseWait_freeText_setText("UNINSTALLATION<br><br>Please remove coffee grounds, then press CONTINUE"); //DISINTALLATION<br><br>Please remove coffee grounds, then press CONTINUE
		pleaseWait_btn1_setText("CONTINUE");
		pleaseWait_btn2_setText("İPTAL");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
	...
	case 20:
		this.fase = 21;
		pleaseWait_freeText_setText("UNINSTALLATION<br><br>Press START UNINSTALLATION to continue, ABORT to cancel the operation"); //DISINTALLATION<br><br>Press START DISINSTALLATION to continue, ABORT to cancel the operation
		pleaseWait_btn1_setText("START UNINSTALLATION");
		pleaseWait_btn2_setText("İPTAL");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("UNINSTALLATION is running, please wait ...<br><br><br>Press PROG button to abort"); //DISINTALLATION is running, please wait
		else
			pleaseWait_freeText_setText("UNINSTALLATION is running, please wait ..."); //DISINTALLATION is running, please wait
	...
	case 40:
		var msgToOutput = "UNINSTALLATION finished, please SHUT DOWN the machine"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("Do you want to repeat the grinding cycles?", "NO", "EVET");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("Do you want do dispense a coffee?", "NO", "EVET");
}
