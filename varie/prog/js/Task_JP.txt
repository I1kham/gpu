...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_freeText_setText("First coffee cycleは排水直結の場合のみ機能します?");
	pleaseWait_freeText_show();
	pleaseWait_btn1_setText("確認");
	pleaseWait_btn1_show();
	pleaseWait_btn2_setText("いいえ");
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				...
				case 4: pleaseWait_freeText_setText("タブレットを溶かしています"); break; //Infusion
				...
				case 12: pleaseWait_freeText_setText("抽出ユニットをブラシの位置に置き、CONTINUEを押す"); break;	//Brewer placed in brush position, press CONTINUE when finished
				case 13: pleaseWait_freeText_setText("コーヒーを抽出しますか、スキップしますか"); break; //Skip final coffee or make a coffee
			...
			if (me.fase != me.prevFase)
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							case 3:  btnText = "スタート"; break; //HC_STEP_TABLET
							case 11: btnText = "いいえ"; break; //HC_STEP_BRW_REPEAT
				...
				else
				{
					...
					switch (me.fase)
					{
						...
						case 13: btnText = "コーヒーを抽出します"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
					}
...
TaskCleaning.prototype.priv_handleDescalingMilker = function (timeElapsedMSec)		//#4419
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = ". 完了したらCONTINUEを押します."; break;
				case 2:		msg = "給水経路を空にします, お待ちください..."; break;
				case 3:		msg = ". 完了したらCONTINUEを押します."; break;
				case 4:		msg = "スケール除去剤を含んだ給水タンクを取り付けます. 完了したらCONTINUEを押します."; break;
				case 5:		msg = "スケール除去剤を給水経路に充填します, お待ちください..."; break;
				case 6:		msg = "エアブレイクタンク内のスケール除去剤のレベルを確認します. 完了したらCONTINUEを押します."; break;
				case 7:		msg = "スケール除去剤をチューブに充填します, お待ちください..."; break;
				case 8:		msg = "スケーリングアクション中、お待ちください..."; break;
				case 9:		msg = "スケール除去剤の排水を開始いたします。, お待ちください..."; break;
				case 10:	msg = "start emptying and rinsing of the hydraulic circuit"; break;
				case 11:	msg = ". 完了したらCONTINUEを押します."; break;
				case 12:	msg = "給水経路を空にします, お待ちください..."; break;
				case 13:	msg = ". 完了したらCONTINUEを押します."; break;
				case 14:	msg = "供給源を水タンクに変更します。水タンクにポンプを取り付けて下さい. 完了したらCONTINUEを押します."; break;
				case 15:	msg = "水経路は水で満たされます, お待ちください..."; break;
				case 16:	msg = "エアブレイクタンクの水量を確認してください. 完了したらCONTINUEを押します."; break;
				case 17:	msg = "水が排出されました."; break;
				case 18:	msg = "水を分配し、サンプルをテストします。サンプルを集めるためにカップを置きます. 完了したらCONTINUEを押します."; break;
...
TaskCleaning.prototype.priv_handleDescalingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = "ボイラーバルブを開きます. 完了したらCONTINUEを押します."; break;
				case 2:		msg = "給水経路を空にします, お待ちください..."; break;
				case 3:		msg = "ボイラーバルブを閉じます. 完了したらCONTINUEを押します."; break;
				case 4:		msg = "スケール除去剤を含んだ給水タンクを取り付けます. 完了したらCONTINUEを押します."; break;
				case 5:		msg = "スケール除去剤を給水経路に充填します, お待ちください..."; break;
				case 6:		msg = "エアブレイクタンク内のスケール除去剤のレベルを確認します. 完了したらCONTINUEを押します."; break;
				case 7:		msg = "スケール除去剤をチューブに充填します, お待ちください..."; break;
				case 8:		msg = "スケーリングアクション中、お待ちください..."; break;
				case 9:		msg = "スケール除去剤の排水を開始いたします。, お待ちください..."; break;
				case 10:	msg = "スケール除去が完了したら抽出ノズルに除去剤が残っていないか確認します"; break;
				case 11:	msg = "ボイラーバルブを開きます. 完了したらCONTINUEを押します."; break;
				case 12:	msg = "給水経路を空にします, お待ちください..."; break;
				case 13:	msg = "ボイラーバルブを閉じます. 完了したらCONTINUEを押します."; break;
				case 14:	msg = "供給源を水タンクに変更します。水タンクにポンプを取り付けて下さい. 完了したらCONTINUEを押します."; break;
				case 15:	msg = "水経路は水で満たされます, お待ちください..."; break;
				case 16:	msg = "エアブレイクタンクの水量を確認してください. 完了したらCONTINUEを押します."; break;
				case 17:	msg = "水が排出されました."; break;
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				...
				case 28: msg = "コーヒー抽出ススギをスキップしますか?"; break; //Do you want to skip the final coffee ?
				case 29: msg = "コーヒー抽出中 しばらくお待ちください"; break; //Coffee delivery, please wait
				...
				case 35: msg = "MANUALとAUTOのどちらでクリーニングしますか"; break; //Do you want to perform MANUAL or AUTOMATIC washing?
			}
			...
			if ( (me.fase != me.prevFase) || ( me.fase == me.prevFase && (me.btn1 != me.prevFaseBtn1 || me.btn2 != me.prevFaseBtn2) ))
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							...
							case 12: btnText = "いいえ"; break; //Do you want to repeat clean cycle 1/2 ?
							case 14:  btnText = "継続する"; break;
							case 27: btnText = "いいえ"; break; //Do you want to repeat clean cycle 2/2 ?
							case 28: btnText = "スキップ　コーヒー"; break; //Do you want to skip the final coffee ?
							case 34: btnText = "クローズ"; break; //Do you want to skip the final coffee ?
				...
				else
				{
					...
					switch (me.fase)
					{
						...
						case 28: btnText = "コーヒーを抽出します"; break; //Do you want to skip the final coffee ?
		...
		.then( function(result) 
		{
			...
			else
			{
				switch (me.fase)
				{
					...
					case 2:  pleaseWait_btn1_setText ("スタート"); break;
					case 3:
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "清掃を開始する前に確認してください。<OL> <LI>給水が利用可能です</ LI> <LI>廃棄物タンクは空</ LI> <Li>ミルクチューブがクリーニングジャグ内にあります</ li> < Li>洗剤は容器に充填されています</ li> </ OL>");
			...
			else
			{
				...
				case 5:	//CIC_cleaning_PHASE2
					...
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("{0}と{1}の清掃中、しばらくお待ち下さい。<br>水の伝達：{2}us".translateLang(ciclo_num,ciclo_di,cond_uS)); //Rinsing {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 6: //CIC_RINSING_PHASE3
					...
					var ciclo_di = parseInt(obj.buffer8[3]);
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("すすぎ中{0}or{1}、しばらくお待ち下さい。<br>水の伝達：{2}us".translateLang(ciclo_num,ciclo_di,cond_uS)); //Cleaning {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						...
						pleaseWait_btn1_setText ("スタート");
					break;
				case 7:		pleaseWait_btn1_setText ("クローズ"); break;
				case 9:		pleaseWait_btn1_setText ("スタート"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			else
			{
				...
				case 1:	 pleaseWait_btn2_setText ("中断します"); break;
			...
			else
			{
				switch (me.fase)
				{
				case 1:	 pleaseWait_btn3_setText ("液体洗剤を使用します"); break;
				}
...
//console.log ("TaskCalibMotor::fase[" +me.fase +"], ev=" +me.ev1_5 +", speed="+me.speed0_2);
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("ポンプ作動中、しばらくお待ちください"); //Please wait while pump is running
...
//console.log ("TaskCalibMotor:: error fase 0 [" +result +"]");
	...
	case 20:
		me.fase = 30;
		pleaseWait_calibration_setText("水の量をグラム単位で入力してください"); //Please enter the quantity in grams of the water dispensed, then press CONTINUE
		pleaseWait_calibration_num_setValue(0);
		pleaseWait_calibration_num_show();
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("抽出ユニットと外し、続行"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断します");
		pleaseWait_btn2_show();	
...
TaskTestSelezione.prototype.priv_handleTestMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("抽出ユニットを外し、続行"); //Please remove the brewer, then press CONTINUE
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断します");
		pleaseWait_btn2_show();
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("抽出ユニットを取り付けて、RPEATを押して再度豆を挽くか、CONTINUEを押して次に進みます"); //Place the brewer into position then press CONTINUE, or press REPEAT to grind again
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleSnackProg = function(timeNowMsec)
{
	...
	case 0:
		this.fase = 10;
		pleaseWait_rotella_hide();
		pleaseWait_btn1_setText("プログラムを出ます");
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleRichiestaPosizioneMacina = function()
{
	...
	rhea.ajax ("getCupSensorLiveValue", "" ).then( function(result)
	{
		...
		default: rheaSetDivHTMLByName("divCupSensorLiveValueBrewmatic", "カップ無し"); break;
		}
		
		//nel caso di sensore Wenglor
		switch (parseInt(result))
		{
		default: rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "カップ無し"); break;
		case 1:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "スモールカップ（下限）"); break;
		case 2:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "スモールカップ（上限）"); break;
		case 3:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "ビックカップ"); break;
		}		
	})
	.catch( function(result)
	{
...
TaskDevices.prototype.priv_handleTestAssorbMotoriduttore = function(timeNowMsec)
{
	...
	case 0: //prego rimuovere il gruppo
		me.fase = 1;
		pleaseWait_show();
		pleaseWait_freeText_setText ("抽出ユニットを外し、続行");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断します");
...
TaskDevices.prototype.priv_handleGrinderSpeedTest = function(timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09用グラインダー回転数</b><br><br>抽出ユニットを外し、続行"); //Please remove the brewer, then press CONTINUE
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断します");
	...
	case 5: //step 1
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09用グラインダー回転数</b><br><br>ステップ1 <br> <B> <B>ホッパーシャッター閉じます。グラインダー内の豆を空にするため、グラインダーは約10秒間稼働します。");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断します");
	...
	case 20:
		me.fase = 21;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09用グラインダー回転数</b><br><br>ステップ2<br>グラインダーが空の時の平均センサー値を出します｡ CONTINUEを押す");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断します");
	...
	case 40:
		me.fase = 41;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09用グラインダー回転数</b><br><br>ステップ3<br>ホッパーシャッター開き CONTINUEを押します｡");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("中断します");
	...
	case 60:
		me.fase = 61;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>OFF09用グラインダー回転数</b><br><br>リザルト:<br>グラインダーが空の平均速度: <b>" +me.speed1 +"</b><br>グラインダーが空でない場合の平均速度: <b>" +me.speed2 +"</b><br>");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("クローズ");
		pleaseWait_btn1_show();
		break;
	...
	case 70: //chiedo di rimettere a posto il gruppo
		...
		else
		{
			me.fase = 71;
			pleaseWait_rotella_hide();
			pleaseWait_freeText_setText("<b>OFF09用グラインダー回転数</b><br><br>抽出ユニットをセットし、続行"); //Place the brewer into position, then press CONTINUE
			pleaseWait_freeText_show();
			pleaseWait_btn1_setText("継続する");
			pleaseWait_btn1_show();
		}
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 20:
		...
		pleaseWait_btn1_setText("水抜き動作を開始する");
		pleaseWait_btn2_setText("中断します");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("アンインストール中、しばらくお待ち下さい。 ...<br><br><br>プログラムボタンを押すと中断します"); //DISINTALLATION is running, please wait
		else
	...
	case 40:
		var msgToOutput = "削除完了、マシンをシャットダウンして下さい。"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "ドレイン完了、ボイラーコックを閉じてマシンをシャットダウンします"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
	...
	case 51:
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("アンインストール<br><br>ボイラーコックを開けます、開けたら続行を押します ...<br><br><br>プログラムボタンを押すと中断します"); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
		else
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	...
	var msg = "{1}のグラインダー サイクル{0}実行中".translateLang(this.curCiclo,this.numCicli);
	msg += "<br><br><b>コーヒー豆が吐出されますので受けてください</b>";
	this.priv_show (msg, "", "");	
...
TaskGrinderClean.prototype.runGrinderCycle_3 = function(timeNowMsec)
{
	...
	var msg = "{1}のグラインダー サイクル{0}実行中".translateLang(this.curCiclo-1,this.numCicli);
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("グラインドサイクルを繰りますか？", "いいえ", "はい");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("コーヒーを抽出しますか?", "いいえ", "はい");
}
...
TaskCalibMilkPump.prototype.priv_handleCalibMilkPump = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_calibMilkPump_setText("ミルクタンクに水を入れて、クリーニング排水受けをセットしたら「START」を押してください。");
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
		var btnText = "EXIT";
		pleaseWait_btn2_setText (btnText);
	...
	case 12:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
	    pleaseWait_calibMilkPump_setText("水を排出中。しばらくお待ちください。"); 
	...
	case 13:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
		pleaseWait_calibMilkPump_setText("クリーニング排水受けを空にしてください CONTINUE");
		pleaseWait_btn1_setText("継続する");
		pleaseWait_btn1_show();
		break;	
	...
	case 20:
		...
		pleaseWait_calibMilkPump_setText("完了したら水を注ぎ、水量をml単位で入力してください。<br>最大340ml<br>CONTINUEを押します<br><br>"); //Please enter the quantity, then press CONTINUE
...
TaskCleaning.prototype.priv_handleSyrupCleaning = function (timeElapsedMSec)		//#4660
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = " "; break;
				case 1:		msg = "Place an one-liter tank with the correct quantity of detergent under the cup station, 完了したらCONTINUEを押します."; break;			//SYRUP_CLEANING_PREPARE_TANK_UNDER_NOZZLES,
				case 2:		msg = "Hot water is flowing from the the nozzle in the tank with cleaning detergent. お待ちください......"; break;
				case 3:		msg = "Remove the tubes from the syrup bottles and place them in the cleaning solution tank, 完了したらCONTINUEを押します."; break;
				case 4:		msg = "step 1 - Cleaning solution is flowing from the syrup tube nozzles. お待ちください......"; break;
				case 5:		msg = "step 1 - Please wait for the cleaning solution action…, お待ちください......"; break;
				case 6:		msg = "step 2 - Cleaning solution is flowing from the syrup tube nozzles. お待ちください......"; break;
				case 7:		msg = "step 2 - Please wait for the cleaning solution action…. お待ちください......"; break;
				case 8:		msg = "Place a clean empty tank under the cup station, 完了したらCONTINUEを押します."; break;
				case 9:		msg = "Hot water is flowing from the the nozzle in the tank. お待ちください......"; break;
				case 10:	msg = "Place the syrup tubes in the cleaning water tank. 完了したらCONTINUEを押します."; break;
				case 11:	msg = "Hot water  is flowing from the syrup tube nozzles."; break;
				case 12:	msg = "Check the syrup tubes. Do you want to repeat the rinsing ?  Press REPEAT to rinse again the tubes.. 完了したらCONTINUEを押します."; break;
