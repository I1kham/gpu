...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_btn1_setText("CONFIRM");
	pleaseWait_btn1_show();
	pleaseWait_btn2_setText("NO");
...
TaskCleaning.prototype.priv_handleSanWashingMicro = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 0: pleaseWait_freeText_setText("LAVADO DE GRUPO NO SE INICIA ( O TERMINA)"); break;	//Brewer Cleaning is not started (or ended)
				case 1: pleaseWait_freeText_setText("INICIANDO LAVADO DEL GRUPO"); break; 	//Brewer Cleaning is started
				case 2: pleaseWait_freeText_setText("GRUPO DE CAFÉ POSICIONADO"); break; 	//Brewer placed
				case 3: pleaseWait_freeText_setText("INTRODUCIR PASTILLA Y PULSAR START"); break; //Put pastille and push START
				case 4: pleaseWait_freeText_setText("INFUSION"); break; //Infusion
				case 5: pleaseWait_freeText_setText("CICLO DE LAVADO DE GRUPO 1"); break; // Brewer cleaning cycles 1
				case 6: pleaseWait_freeText_setText("CICLO DE LAVADO DE GRUPO 2"); break;	// Brewer cleaning cycles 2
				case 7: pleaseWait_freeText_setText("CICLO DE LAVADO DE GRUPO 3"); break;	// Brewer cleaning cycles 3
				case 8: pleaseWait_freeText_setText("CICLO DE LAVADO DE GRUPO 4"); break;	// Brewer cleaning cycles 4
				case 9: pleaseWait_freeText_setText("CICLO DE LAVADO DE GRUPO 5"); break;	// Brewer cleaning cycles 56
				case 10: pleaseWait_freeText_setText("CICLO DE LAVADO DE GRUPO 6"); break;	// HC_STEP_BRW_6
				
				case 11: pleaseWait_freeText_setText("REPETIR LAVADO ?"); break;	//Repeat cleaning ?
				case 12: pleaseWait_freeText_setText("GRUPO POSICIONANDOSE , PULSAR &quot;CONTINUAR&quot; CUANDO TERMINE"); break;	//Brewer placed in brush position, press CONTINUE when finished
				case 13: pleaseWait_freeText_setText("OMITIR EL CAFÉ O HACERLO"); break; //Skip final coffee or make a coffee
				case 14: pleaseWait_freeText_setText("EROGACION EN CURSO"); break; //Coffee delivery
				...
				case 18:	//HC_STEP_MIXER_4
					...
					if (me.isEspresso)
						cleanMixNum++;
					pleaseWait_freeText_setText("LAVADO DE GRUPO NO SE INICIA ( O TERMINA) " +cleanMixNum); //rinsing
					break; 	
			...
			if (me.fase != me.prevFase)
			{
				...
				else
				{
					...
					{
						var btnText = "BOTON " +me.btn1;
						switch (me.fase)
						{
							case 3:  btnText = "INICIA"; break; //HC_STEP_TABLET
							case 11: btnText = "NO"; break; //HC_STEP_BRW_REPEAT
							case 12: btnText = "CONTINUA"; break; //HC_STEP_BRW_BRUSH_POSITION
							case 13: btnText = "SALTA CAFE"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
						}
				...
				{
					var btnText = "BOTON " +me.btn2;
					switch (me.fase)
					{
						case 11: btnText = "SI"; break;//HC_STEP_BRW_REPEAT
						case 13: btnText = "HAZ UN CAFE"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
					}
...
TaskCleaning.prototype.priv_handleSanWashingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: msg = ""; break;
				case 0: msg = "LAVADO ACTIVO"; break;	//Cleaning is active
				case 1: msg = "PONER LA PASTILLA EN EL GRUPO Y PULSAR CONTINUAR"; break; 	//Put the pastille in the brewer and press CONTINUE
				case 2: msg = "GRUPO CERRADO"; break; 	//Brewer is closing
				case 3: msg = "DISOLVIENDO PASTILLA 1/2 , ESPERAR"; break; 	//Tablet dissolution 1/2, please wait
				case 4: msg = "EMPAZANDO EL SEGUNDO CICLO DE DISOLUCION"; break; 	//2nd dissolution cycle is about to starting
				case 5: msg = "DISOLUCION PASTILLA 2/2 , ESPERAR"; break; 	//Tablet dissolution 1/2, please wait

				case 6: msg = "1ª LIMPI·EZA , ESPERE 1/3"; break; 	//1st Cleaning, please wait 1/3
				case 7: msg = "1ª LIMPIEZA activa 1/3"; break; 	//1st Cleaning, active 1/3
				case 8: msg = "1ª LIMPI·EZA , ESPERE 2/3"; break; 	//1st Cleaning, please wait 2/3
				case 9: msg = "1ª LIMPIEZA activa 2/3"; break; 	//1st Cleaning, active 2/3
				case 10: msg = "1ª LIMPI·EZA , ESPERE 3/3"; break; 	//1st Cleaning, please wait 3/3
				case 11: msg = "1ª LIMPIEZA activa 3/3"; break; 	//1st Cleaning, active 3/3

				case 12: msg = "Quiere repetir el ciclo de lavado 1/2 ?"; break; 	//Do you want to repeat clean cycle 1/2 ?
				
				case 13: msg = "Grrupo en posicion abierta"; break; 	//Brewer is going into open position
				
				case 14: msg = "Realizar limpieza manual y pulsar &quot;Continuar&quot; para terminar"; break; 	//Please, perform a manual brush and then press CONTINUE when finished
				
				case 15: msg = "2ª Limpieza , espere 1/6"; break; 	//2nd Cleaning, please wait 1/6
				case 16: msg = "2ª Limpieza , activa 1/6"; break; 	//2nd Cleaning, active 1/6
				case 17: msg = "2ª Limpieza , espere 2/6"; break; 	//2nd Cleaning, please wait 2/6
				case 18: msg = "2ª limpieza , activa 2/6"; break; 	//2nd Cleaning, active 2/6
				case 19: msg = "2ª Limpieza , espere 3/6"; break; 	//2nd Cleaning, please wait 3/6
				case 20: msg = "2nd Cleaning, active 3/6"; break; 	//2nd Cleaning, active 3/6
				case 21: msg = "2ª Limpieza , espere 4/6"; break; 	//2nd Cleaning, please wait 4/6
				case 22: msg = "2nd Cleaning, active 4/6"; break; 	//2nd Cleaning, active 4/6
				case 23: msg = "2ª Limpieza , espere 5/6"; break; 	//2nd Cleaning, please wait 5/6
				case 24: msg = "2nd Cleaning, active 5/6"; break; 	//2nd Cleaning, active 5/6
				case 25: msg = "2ª Limpieza , espere 6/6"; break; 	//2nd Cleaning, please wait 6/6
				case 26: msg = "2nd Cleaning, active 6/6"; break; 	//2nd Cleaning, active 6/6
				
				case 27: msg = "Quiere repetir ciclo de lavado 2/2 ?"; break; 	//Do you want to repeat clean cycle 2/2 ?
				
				case 28: msg = "Quiere saltar al café final?"; break; //Do you want to skip the final coffee ?
				case 29: msg = "Erogando café , por favor espere"; break; //Coffee delivery, please wait

				case 30: msg = "Lavado de grupo"; break; //Brewer Rinsing 
				case 31: msg = "Lavado batidor 1"; break; //Mixer 1 Rinsing
				case 32: msg = "Lavado batidor 2"; break; //Mixer 2 Rinsing
				case 33: msg = "Lavado batidor 3"; break; //Mixer 3 Rinsing 
				case 34: msg = "Fin lavado grupo , pulsar &quot;CLOSE&quot; para finalizar"; break; //Brewer Cleaning Done. Press CLOSE to exit
			...
			if ( (me.fase != me.prevFase) || ( me.fase == me.prevFase && (me.btn1 != me.prevFaseBtn1 || me.btn2 != me.prevFaseBtn2) ))
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							...
							case 28: btnText = "SALTA CAFE"; break; //Do you want to skip the final coffee ?
							case 34: btnText = "CERRADO"; break; //Do you want to skip the final coffee ?
				...
				else
				{
					...
					switch (me.fase)
					{
						...
						case 28: btnText = "HAZ UN CAFE"; break; //Do you want to skip the final coffee ?
...
TaskCleaning.prototype.priv_handleMilkWashingVenturi = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 1: pleaseWait_freeText_setText("INICIANDO LAVADO DEL CAPUCHINADOR"); break;	//Milker Cleaning is started
				case 2: pleaseWait_freeText_setText("CALENTAMIENTO PARA LAVADO"); break;	//Warming for cleaner
				case 3: pleaseWait_freeText_setText("ESPERANDO PARA CONFIRMAR"); break;	//Wait for confirm
				case 4: pleaseWait_freeText_setText("CICLOS DE LAVADO (12)"); break;	//Doing cleaner cycles (12)
				case 5: pleaseWait_freeText_setText("CALENTANDO AGUA"); break;	//Warming for water
				case 6: pleaseWait_freeText_setText("ESPERANDO LA SEGUNDA CONFIRMACION"); break;	//Wait for second confirm
				case 7: pleaseWait_freeText_setText("CICLOS DE LAVADO (12)"); break;	//Doing cleaner cycles (12)
				default: pleaseWait_freeText_setText(""); break;
			}
			pleaseWait_freeText_show();
			...
			else
			{
				switch (me.fase)
				{
					default: pleaseWait_btn1_setText ("BOTON " +me.btn2); break;
					case 2:  pleaseWait_btn1_setText ("INICIA"); break;
					case 3:
			...
			{
				pleaseWait_btn2_setText ("BOTON " +me.btn2);
				pleaseWait_btn2_show();	
			}			
		})
		.catch( function(result)
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "Antes de comenzar la limpieza, verifique que: <ol> <li> el suministro de agua esté disponible </li> <li> el tanque de RESIDUOS esté vacío </li> <li> el tubo de leche esté en la jarra de limpieza </li> <li> el detergente esta en la jarra </li> </ol>");
			...
			else
			{
				...
				case 2:	//CIC_STEP_FILL_WATER
					...
					pleaseWait_freeText_setText("Lavado en progreso , por favor esperar".translateLang(cond_uS)); //Water refilling in progress, please wait.<br>Water conducibility: {0} uS
					break;
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					...
					pleaseWait_freeText_setText("El lavado ha terminado. <br><br>Condicibilidad inicial {0} Conductibilidad final {1}<br><br> Por favor, recuerde: <ul> <li> vaciar el tanque de residuos </li> <li> volver a colocar el tubo de leche en su posición </li> </ul> <br > Presione CERRAR para cerrar esta ventana o CLOSE NO SEL.MILK si no desea habilitar las selecciones de leche".translateLang(cond_uS_init_rif,cond_uS_finale)); //The cleaning procedure is finished.<br><Initial conducibility {0} and current conducibility {1},><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;

				case 9: //CIC_WAIT_CONF_LIQUID_DETERGENT
					pleaseWait_freeText_setText("Por favor, llene la jarra de limpieza con el detergente.<br><br><center><img src='img/milkerInduxClean05.jpg'></center>"); //Please fill liquid detergent and push START
					break;
					
				case 97: //CIC_TOO_MUCH_DETERGENTE
					pleaseWait_freeText_setText("ATENCION : demasiado detergente");
					break;
				
				case 98: //CIC_DET_TOO_LOW
					pleaseWait_freeText_setText("ATENCION: ¡se ha detectado muy poco detergente! <por> Se recomienda una nueva limpieza");
					break;

				case 99: //CIC_DET_TOO_AGGRESSIVE
					pleaseWait_freeText_setText("ATENCION : el detergente es demasiado agresivo");
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						...
						pleaseWait_btn1_setText ("INICIA");
					break;
				case 7:		pleaseWait_btn1_setText ("CIERRA"); break;
				case 9:		pleaseWait_btn1_setText ("INICIA"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			else
			{
				...
				case 1:	 pleaseWait_btn2_setText ("INTERRUMPIR"); break;
			...
			else
			{
				switch (me.fase)
				{
				case 1:	 pleaseWait_btn3_setText ("LIMPIAR CON `DETERGENTE LÍQUIDO`"); break;
				}
...
TaskCalibMotor.prototype.showPopupCalibrazioneEVPump = function (ev1_5)
{
	...
	pleaseWait_btn1_setText("INTERRUMPIR");
	pleaseWait_btn1_show();
}
...
console.log ("TaskCalibMotor::fase[" +me.fase +"]");
	...
	case 0:
		...
		pleaseWait_calibration_setText("Por favor espere mientras el motor está en marcha"); //Please wait while motor is running
	...
	case 20:
		...
		pleaseWait_calibration_setText("Al final, introduzca la cantidad en gramos obtenida de la última molida y luego pulse CONTINUAR"); //Please enter the quantity, then press CONTINUE
	...
	case 40:
		...
		{
			pleaseWait_calibration_setText("VALOR INVALIDO");
			me.fase = 20;
			break;
		}
	
		pleaseWait_calibration_setText("GUARDADO EN PROCESO ...");
		me.value = pleaseWait_calibration_num_getValue();
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Por favor retire el grupo de café y luego pulse CONTINUAR"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("CONTINUA");
		pleaseWait_btn1_show();
...
//console.log ("TaskCalibMotor.priv_handleCalibMacina() => runMotor, m="  +me.motor);
	...
	case 25:	//qui ci andiamo se siamo in fase 21 e l'utente preme il btn SET per impostare una nuova apertura del VGrind
		pleaseWait_calibration_setText("Por favor espere mientras el varigrind está fijando la posición"); //Please wait while the varigrind is adjusting its position
	...
	case 28:
		if (da3.isGruppoVariflex())
		{
			rhea.ajax ("getPosMacina", {"m":(me.motor-10)}).then( function(result)
			{
				var obj = JSON.parse(result);
				rheaSetDivHTMLByName("pagePleaseWait_calibration_1_vg", obj.v);
				pleaseWait_calibration_setText("Por favor espere mientras el varigrind está fijando la posición" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position  [current pos]
			})
			.catch( function(result)
			{
			});	
...
//console.log	("TaskCalibMotor.priv_handleCalibMacina: setFattoreCalib m=" +me.motor +",v=" +me.gsec);		
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Volver a colocar el grupo en posicion y luego presionar CONTINUAR"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_show();
		me.fase = 41;
		break;
	...
	case 60: //gruppo è stato ricollegato, procedo con il calcolo impulsi se richiesto
		...
		else
		{
			me.fase = 65;
			pleaseWait_calibration_show();
			pleaseWait_calibration_setText("Cálculo de los impulsos en curso, por favor espere"); //Impulse calculation in progress, please wait
...
TaskTestSelezione.prototype.priv_handleTestMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Por favor retire el grupo de café y luego pulse CONTINUAR"); //Please remove the brewer, then press CONTINUE
		pleaseWait_btn1_setText("CONTINUA");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("INTERRUMPIR");
		pleaseWait_btn2_show();
	...
	case 10:  //ok, il gruppo è scollegato, chiedo a CPU di attivare la macina
		me.fase = 11;
		pleaseWait_calibration_setText ("El molinillo está en funcionamiento"); //Grinder is running
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Vuelva a colocar el grupo en posicion y pulse CONTINUAR, o pulse REPETIR para moler nuevamente"); //Place the brewer into position then press CONTINUE, or press REPEAT to grind again
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("REPITE");
		pleaseWait_btn2_show();		
		me.fase = 41;
		break;
...
TaskDevices.prototype.priv_handleRegolazionePosizioneMacina = function()
{
	switch (this.fase)
	{
		case 0: 
			...
			pleaseWait_freeText_setText("Por favor espere mientras el varigrind está fijando la posición"); //Please wait while the varigrind is adjusting its position
			pleaseWait_freeText_show();
...
TaskDevices.prototype.priv_queryMacina = function(macina_1o2)
{
	...
	rhea.ajax ("getPosMacina", {"m":macina_1o2}).then( function(result)
	{
		...
		pleaseWait_freeText_setText("Por favor espere mientras el varigrind está fijando la posición" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position [current_value]
	})
	.catch( function(result)
	{
	});			
...
TaskDevices.prototype.priv_handleTestAssorbGruppo = function(timeNowMsec)
{
	...
	{
	case 0:
		pleaseWait_freeText_setText ("EL TEST ESTA INICIANDO...");
		pleaseWait_freeText_show();
		pleaseWait_rotella_show();
		me.fase = 1;
		me.test_fase = 0;
	...
	case 10:
		...
		pleaseWait_freeText_setText ("La prueba se está ejecutando, espere ... <br> Fase actual: " +me.test_fase +"/5");
		me.fase = 11;
		break;
	...
	case 11:
		...
		rhea.ajax ("getStatTestAssGrp", "" ).then( function(result)
		{
			...
			{
				//errore
				pleaseWait_freeText_setText ("EL TEST HA TERMINADO.<br>Result: FAILED<br><br>");
				pleaseWait_btn1_setText("CIERRA");
				pleaseWait_btn1_show();	
				pleaseWait_btn2_setText("REPITE");
				pleaseWait_btn2_show();	
				me.fase = 80;
			...
			else
			{
				...
				else
				{
					...
					var html = "<table class='dataAudit'>"
								...
								+"</table>";
					pleaseWait_freeText_setText ("EL TEST HA TERMINADO.<br>Results:<br><br>" +html);		
					pleaseWait_btn1_setText("CIERRA");
					pleaseWait_btn1_show();	
					pleaseWait_btn2_setText("REPITE");
					pleaseWait_btn2_show();	
...
TaskDevices.prototype.priv_handleTestAssorbMotoriduttore = function(timeNowMsec)
{
	...
	case 0: //prego rimuovere il gruppo
		me.fase = 1;
		pleaseWait_show();
		pleaseWait_freeText_setText ("Por favor retire el grupo de café y luego pulse CONTINUAR");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("CONTINUA");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("INTERRUMPIR");
	...
	case 20:
		//ho ricevuto l'OK dal comando start Test. Da ora in poi, pollo lo stato del test fino a che non finisce
		pleaseWait_freeText_setText ("La prueba se está ejecutando, espere ... <br> Fase actual: " +me.test_fase +"/4");
		me.fase = 21;
		break;
	...
	case 85: //prego rimettere a posto il gruppo
		pleaseWait_freeText_setText("Volver a colocar el grupo en posicion y luego presionar CONTINUAR"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_setText("CONTINUA");
		pleaseWait_btn1_show();
		pleaseWait_rotella_show();
		me.fase = 86;
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_freeText_show();
		pleaseWait_freeText_setText("DESINSTALACIÓN <br> <br> ¿Está vacía la bandeja de goteo?"); //DISINTALLATION<br><br>Is driptray empty?
	...
	case 10:
		this.fase = 11;
		pleaseWait_freeText_setText("DESINSTALACIÓN <br> <br> Retire el café molido y luego presione CONTINUAR"); //DISINTALLATION<br><br>Please remove coffee grounds, then press CONTINUE
		pleaseWait_btn1_setText("CONTINUA");
		pleaseWait_btn2_setText("INTERRUMPIR");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
	...
	case 20:
		this.fase = 21;
		pleaseWait_freeText_setText("DESINSTALACIÓN <br> <br> Presione INICIAR DESINSTALACIÓN para continuar, INTERRUMPIR para cancelar la operación"); //DISINTALLATION<br><br>Press START DISINSTALLATION to continue, ABORT to cancel the operation
		pleaseWait_btn1_setText("COMENZAR DESINSTALACION");
		pleaseWait_btn2_setText("INTERRUMPIR");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("LA DESINSTALACIÓN está en curso, por favor espere ...<br><br><br>Press PROG button to abort"); //DISINTALLATION is running, please wait
		else
			pleaseWait_freeText_setText("LA DESINSTALACIÓN está en curso, por favor espere ..."); //DISINTALLATION is running, please wait
	...
	case 40:
		var msgToOutput = "LA DESINSTALACIÓN está completa. REINICIE la máquina"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "UNINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
...
TaskDataAudit.prototype.onTimer = function (timeNowMsec)
{
	...
	switch (this.fase)
	{
		...
		case 10: //eva dts scaricato
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			me.fase = 20;
			pleaseWait_freeText_appendText ("<br>Hecho. Espere mientras se procesan los datos.<br>"); //Done, processing data, please wait
			break;
		...
		case 200: //errore downloading eva-dts
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			pleaseWait_freeText_appendText("Error al descargar. Por favor intente nuevamente más tarde"); //Error downloading EVA-DTS. Please try again later
			me.fase = 201;
			break;
...
TaskGrinderClean.prototype.onEvent_cpuStatus  	= function(statusID, statusStr, flag16)		{ this.cpuStatus = statusID; pleaseWait_header_setTextL ("limpieza molinillo"); }
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	...
	var msg = "Empezar ciclo de molinillo (0) o (1)".translateLang(this.curCiclo,this.numCicli);
	msg += "<br><br><b>Recoger en un vaso el ciclo de molienda</b>";
	this.priv_show (msg, "", "");	
...
TaskGrinderClean.prototype.runGrinderCycle_3 = function(timeNowMsec)
{
	...
	var msg = "Empezar ciclo de molinillo (0) o (1)".translateLang(this.curCiclo-1,this.numCicli);
	msg += "<br>" +"Esperar (o ) segundos".translateLang(timeLeftSec);
	this.priv_show (msg, "", "");	
	if (timeLeftMSec <= 0)
		this.runGrinderCycle_1();
}
...
//console.log ("fase="+this.fase);	
	...
	{
		pleaseWait_freeText_setText ("<b>limpieza molinillo</b><br><br>" + text);
		pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step1 = function()
{
	...
	this.priv_show ("&nbsp;", "CONTINUA", "INTERRUMPIR");
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	var msg = "Cerrar contenedor de café.";
	msg += "<br>Pulsar CONTINUE cuando termine.";
...
TaskGrinderClean.prototype.step3 = function()
{
	...
	var msg = "Quitar el grupo y el contenedor de café.";
	msg += "<br>Pulsar CONTINUE cuando termine.";
	this.priv_show (msg, "CONTINUA", "");
}
...
TaskGrinderClean.prototype.step5 = function()
{
	...
	var msg = "Instalar el dispositivo de limpieza del molinilloo.";
	msg += "<br>Pulsar CONTINUE cuando termine.";	
	this.priv_show (msg, "CONTINUA", "");	
}
...
TaskGrinderClean.prototype.step6 = function()
{
	...
	var msg = "Rellenar disposivo de limpieza.";
	msg += "<br>Pulsar CONTINUE cuando termine.";
	msg += "<br><br>ATENCION , cuando pulse CONTINUE el molinillo empezara a moler";
	this.priv_show (msg, "CONTINUA", "");	
}
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("Quiere repetir los ciclos de molienda?", "NO", "SI");
}
...
TaskGrinderClean.prototype.step21 = function()
{
	...
	var msg = "Recolocar el contenedor de cafe.";
	msg += "<br>Pulsar CONTINUE cuando termine.";
	this.priv_show (msg, "CONTINUA", "");
}
...
TaskGrinderClean.prototype.step23 = function()
{
	...
	var msg = "Abrir el contenedor de café.";
	msg += "<br>Pulsar CONTINUE cuando termine.";
	msg += "<br><br>ATENCION , cuando pulse CONTINUE el molinillo empezara a moler";
	this.priv_show (msg, "CONTINUA", "");	
}
...
TaskGrinderClean.prototype.step26 = function()
{
	...
	var msg = "Recolocar el grupo de café.";
	msg += "<br>Pulsar CONTINUE cuando termine.";
	this.priv_show (msg, "CONTINUA", "");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("Quiere erogar un café ?", "NO", "SI");
}
