...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_freeText_setText("Let op, de instelling 1ste koffiecyclus werkt alleen met de speciale onderste piston (voorzien van zijgleuven) en residubak (met gat aan de onderkant) waardoor spoelwater in de lekbak kan stromen. Bevestig a.u.b. de aanwezigheid van deze componenten?");
	pleaseWait_freeText_show();
	pleaseWait_btn1_setText("BEVESTIGEN");
	pleaseWait_btn1_show();
	pleaseWait_btn2_setText("NEE");
...
TaskCleaning.prototype.priv_handleSanWashingMicro = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 0: pleaseWait_freeText_setText("Zetgroep reiniging is niet gestart (of geëindigd)"); break;	//Brewer Cleaning is not started (or ended)
				case 1: pleaseWait_freeText_setText("Zetgroep reiniging is gestart"); break; 	//Brewer Cleaning is started
				case 2: pleaseWait_freeText_setText("Zetgroep geplaatst"); break; 	//Brewer placed
				case 3: pleaseWait_freeText_setText("Plaats de tablet en druk op START"); break; //Put pastille and push START
				case 4: pleaseWait_freeText_setText("Infusie"); break; //Infusion
				case 5: pleaseWait_freeText_setText("Zetgroep reinigingscycli 1"); break; // Brewer cleaning cycles 1
				case 6: pleaseWait_freeText_setText("Zetgroep reinigingscycli 2"); break;	// Brewer cleaning cycles 2
				case 7: pleaseWait_freeText_setText("Zetgroep reinigingscycli 3"); break;	// Brewer cleaning cycles 3
				case 8: pleaseWait_freeText_setText("Zetgroep reinigingscycli 4"); break;	// Brewer cleaning cycles 4
				case 9: pleaseWait_freeText_setText("Zetgroep reinigingscycli 5"); break;	// Brewer cleaning cycles 56
				case 10: pleaseWait_freeText_setText("Zetgroep reinigingscycli 6"); break;	// HC_STEP_BRW_6
				
				case 11: pleaseWait_freeText_setText("Reiniging herhalen ?"); break;	//Repeat cleaning ?
				case 12: pleaseWait_freeText_setText("Zetgroep geplaatst, druk op DOORGAAN indien gereed"); break;	//Brewer placed in brush position, press CONTINUE when finished
				case 13: pleaseWait_freeText_setText("Sla de koffiestap over of kies wel voor een koffiebereiding"); break; //Skip final coffee or make a coffee
				case 14: pleaseWait_freeText_setText("Koffiebereiding"); break; //Coffee delivery
				...
				case 18:	//HC_STEP_MIXER_4
					...
					if (me.isEspresso)
						cleanMixNum++;
					pleaseWait_freeText_setText("Spoelen " +cleanMixNum); //rinsing
					break; 	
			...
			if (me.fase != me.prevFase)
			{
				...
				else
				{
					...
					{
						var btnText = "KNOP " +me.btn1;
						switch (me.fase)
						{
							case 3:  btnText = "START"; break; //HC_STEP_TABLET
							case 11: btnText = "NEE"; break; //HC_STEP_BRW_REPEAT
							case 12: btnText = "DOORGAAN"; break; //HC_STEP_BRW_BRUSH_POSITION
							case 13: btnText = "KOFFIESTAP OVERSLAAN"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
						}
				...
				{
					var btnText = "KNOP " +me.btn2;
					switch (me.fase)
					{
						case 11: btnText = "JA"; break;//HC_STEP_BRW_REPEAT
						case 13: btnText = "NEEM EEN KOFFIE"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
					}
...
TaskCleaning.prototype.priv_handleDescalingMilker = function (timeElapsedMSec)		//#4419
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = ". Druk op DOORGAAN als u klaar bent."; break;
				case 2:		msg = "Hydraulisch circuit legen, even wachten a.u.b."; break;
				case 3:		msg = ". Druk op DOORGAAN als u klaar bent."; break;
				case 4:		msg = "Plaats de dompelpomp in de tank met de ontkalker. Druk op DOORGAAN als u klaar bent."; break;
				case 5:		msg = "Het hydraulisch circuit vullen met ontkalkingsmiddel, even wachten a.u.b."; break;
				case 6:		msg = "Controleer het niveau van het ontkalkingsmiddel in de air-break. Druk op DOORGAAN als u klaar bent."; break;
				case 7:		msg = "Begin met het vullen van hydraulische leidingen met ontkalkingsmiddel, even wachten a.u.b."; break;
				case 8:		msg = "Wacht tot de ontkalkingsvloeistof is ingewerkt..."; break;
				case 9:		msg = "Er begint ontkalkingsvloeistof door de uitlopen te stromen, even wachten a.u.b."; break;
				case 10:	msg = "start emptying and rinsing of the hydraulic circuit"; break;
				case 11:	msg = ". Druk op DOORGAAN als u klaar bent."; break;
				case 12:	msg = "Hydraulisch circuit legen, even wachten a.u.b."; break;
				case 13:	msg = ". Druk op DOORGAAN als u klaar bent."; break;
				case 14:	msg = "Plaats de dompelpomp nu in een tank met schoon water. Druk op DOORGAAN als u klaar bent."; break;
				case 15:	msg = "Het hydraulische circuit wordt gevuld met water, even wachten a.u.b."; break;
				case 16:	msg = "Controleer het waterniveau in de air-break. Druk op DOORGAAN als u klaar bent."; break;
				case 17:	msg = "Er stroomde water door de uitlopen."; break;
				case 18:	msg = "Plaats een beker om een watermonster te verzamelen en test dit.. Druk op DOORGAAN als u klaar bent."; break;
				case 19:	msg = "Begin met het aftappen van een watermonster door elke uitloop."; break;
				case 20:	msg = "Controleer het verzamelde watermonster. Druk op de knop DOORGAAN om door te gaan of op HERHAAL om de voorgaande stappen te herhalen om het hydraulische circuit goed te reinigen."; break;
				case 21:	msg = "De ontkalkingsprocedure is voltooid. Druk op SLUITEN om af te sluiten."; break;
			}
...
TaskCleaning.prototype.priv_handleDescalingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = "Open de boilerkraan. Druk op DOORGAAN als u klaar bent."; break;
				case 2:		msg = "Hydraulisch circuit legen, even wachten a.u.b."; break;
				case 3:		msg = "Sluit de boilerkraan. Druk op DOORGAAN als u klaar bent."; break;
				case 4:		msg = "Plaats de dompelpomp in de tank met de ontkalker. Druk op DOORGAAN als u klaar bent."; break;
				case 5:		msg = "Het hydraulisch circuit vullen met ontkalkingsmiddel, even wachten a.u.b."; break;
				case 6:		msg = "Controleer het niveau van het ontkalkingsmiddel in de air-break. Druk op DOORGAAN als u klaar bent."; break;
				case 7:		msg = "Begin met het vullen van hydraulische leidingen met ontkalkingsmiddel, even wachten a.u.b."; break;
				case 8:		msg = "Wacht tot de ontkalkingsvloeistof is ingewerkt..."; break;
				case 9:		msg = "Er begint ontkalkingsvloeistof door de uitlopen te stromen, even wachten a.u.b."; break;
				case 10:	msg = "Controleer de vloeistof die uit de uitlopen komt om te bepalen of het ontkalkingsproces succesvol is voltooid."; break;
				case 11:	msg = "Open de boilerkraan. Druk op DOORGAAN als u klaar bent."; break;
				case 12:	msg = "Hydraulisch circuit legen, even wachten a.u.b."; break;
				case 13:	msg = "Sluit de boilerkraan. Druk op DOORGAAN als u klaar bent."; break;
				case 14:	msg = "Plaats de dompelpomp nu in een tank met schoon water. Druk op DOORGAAN als u klaar bent."; break;
				case 15:	msg = "Het hydraulische circuit wordt gevuld met water, even wachten a.u.b."; break;
				case 16:	msg = "Controleer het waterniveau in de air-break. Druk op DOORGAAN als u klaar bent."; break;
				case 17:	msg = "Er stroomde water door de uitlopen."; break;
...
TaskCleaning.prototype.priv_handleSanWashingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: msg = ""; break;
				case 0: msg = "Reiniging is actief"; break;	//Cleaning is active
				case 1: msg = "Plaats de tablet in de zetkamer en druk op DOORGAAN"; break; 	//Put the pastille in the brewer and press CONTINUE
				case 2: msg = "Zetgroep sluit zich"; break; 	//Brewer is closing
				case 3: msg = "Oploscyclus 1/2 van tablet, even geduld a.u.b."; break; 	//Tablet dissolution 1/2, please wait
				case 4: msg = "2e oploscyclus start zeer binnenkort"; break; 	//2nd dissolution cycle is about to starting
				case 5: msg = "Oploscyclus 2/2 van tablet , even geduld a.u.b."; break; 	//Tablet dissolution 1/2, please wait

				case 6: msg = "1e reiniging, even geduld a.u.b. 1/3"; break; 	//1st Cleaning, please wait 1/3
				case 7: msg = "1e reiniging,  1/3 is actief"; break; 	//1st Cleaning, active 1/3
				case 8: msg = "1e reiniging, even geduld a.u.b. 2/3"; break; 	//1st Cleaning, please wait 2/3
				case 9: msg = "1e reiniging,  2/3 is actief"; break; 	//1st Cleaning, active 2/3
				case 10: msg = "1e reiniging, even geduld a.u.b. 3/3"; break; 	//1st Cleaning, please wait 3/3
				case 11: msg = "1e reiniging,  3/3 is actief"; break; 	//1st Cleaning, active 3/3

				case 12: msg = "Wilt u reinigingscyclus 1/2 herhalen ?"; break; 	//Do you want to repeat clean cycle 1/2 ?
				
				case 13: msg = "Zetgroep gaat naar open positie"; break; 	//Brewer is going into open position
				
				case 14: msg = "Veeg a.u.b. handmatig de zetgroep schoon en druk vervolgens op DOORGAAN als u gereed bent"; break; 	//Please, perform a manual brush and then press CONTINUE when finished
				
				case 15: msg = "2e reiniging, even geduld a.u.b. 1/6"; break; 	//2nd Cleaning, please wait 1/6
				case 16: msg = "2e reiniging,  1/6 is actief"; break; 	//2nd Cleaning, active 1/6
				case 17: msg = "2e reiniging, even geduld a.u.b. 2/6"; break; 	//2nd Cleaning, please wait 2/6
				case 18: msg = "2e reiniging,  2/6 is actief"; break; 	//2nd Cleaning, active 2/6
				case 19: msg = "2e reiniging, even geduld a.u.b. 3/6"; break; 	//2nd Cleaning, please wait 3/6
				case 20: msg = "2e reiniging,  3/6 is actief"; break; 	//2nd Cleaning, active 3/6
				case 21: msg = "2e reiniging, even geduld a.u.b. 4/6"; break; 	//2nd Cleaning, please wait 4/6
				case 22: msg = "2e reiniging,  4/6 is actief"; break; 	//2nd Cleaning, active 4/6
				case 23: msg = "2e reiniging, even geduld a.u.b. 5/6"; break; 	//2nd Cleaning, please wait 5/6
				case 24: msg = "2e reiniging,  5/6 is actief"; break; 	//2nd Cleaning, active 5/6
				case 25: msg = "2e reiniging, even geduld a.u.b. 6/6"; break; 	//2nd Cleaning, please wait 6/6
				case 26: msg = "2e reiniging,  6/6 is actief"; break; 	//2nd Cleaning, active 6/6
				
				case 27: msg = "Wilt u reinigingscyclus 2/2 herhalen ?"; break; 	//Do you want to repeat clean cycle 2/2 ?
				
				case 28: msg = "Wilt u de koffiestap overslaan ?"; break; //Do you want to skip the final coffee ?
				case 29: msg = "Koffiebereiding bezig, even geduld a.u.b."; break; //Coffee delivery, please wait

				case 30: msg = "Spoeling zetgroep"; break; //Brewer Rinsing 
				case 31: msg = "Spoeling mixer 1"; break; //Mixer 1 Rinsing
				case 32: msg = "Spoeling mixer 2"; break; //Mixer 2 Rinsing
				case 33: msg = "Spoeling mixer 3"; break; //Mixer 3 Rinsing 
				case 34: msg = "Zetgroepreiniging is voltooid. Druk op SLUITEN"; break; //Brewer Cleaning Done. Press CLOSE to exit
				case 35: msg = "Wilt u een HANDMATIGE of AUTOMATISCHE reiniging uitvoeren?"; break; //Do you want to perform MANUAL or AUTOMATIC washing?
			}
			...
			if ( (me.fase != me.prevFase) || ( me.fase == me.prevFase && (me.btn1 != me.prevFaseBtn1 || me.btn2 != me.prevFaseBtn2) ))
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							case 1:  btnText = "DOORGAAN"; break;
							case 12: btnText = "NEE"; break; //Do you want to repeat clean cycle 1/2 ?
							case 14:  btnText = "DOORGAAN"; break;
							case 27: btnText = "NEE"; break; //Do you want to repeat clean cycle 2/2 ?
							case 28: btnText = "KOFFIESTAP OVERSLAAN"; break; //Do you want to skip the final coffee ?
							case 34: btnText = "SLUITEN"; break; //Do you want to skip the final coffee ?
							case 35: btnText = "AUTOMATISCH"; break;
				...
				else
				{
					...
					switch (me.fase)
					{
						case 12: btnText = "JA"; break; //Do you want to repeat clean cycle 1/2 ?
						case 27: btnText = "JA"; break; //Do you want to repeat clean cycle 2/2 ?
						case 28: btnText = "NEEM EEN KOFFIE"; break; //Do you want to skip the final coffee ?
						case 35: btnText = "HANDMATIG"; break;
					}
					pleaseWait_btn2_setText (btnText);
					pleaseWait_btn2_show();	
				}
...
TaskCleaning.prototype.priv_handleMilkWashingVenturi = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 1: pleaseWait_freeText_setText("Reiniging Melkmodule gestart"); break;	//Milker Cleaning is started
				case 2: pleaseWait_freeText_setText("Warmt op voor reiniging"); break;	//Warming for cleaner
				case 3: pleaseWait_freeText_setText("Wacht op bevestiging"); break;	//Wait for confirm
				case 4: pleaseWait_freeText_setText("De reinigingscycli zijn bezig (12)"); break;	//Doing cleaner cycles (12)
				case 5: pleaseWait_freeText_setText("Warmt op, even geduld a.u.b."); break;	//Warming for water
				case 6: pleaseWait_freeText_setText("Wacht op de tweede bevestiging"); break;	//Wait for second confirm
				case 7: pleaseWait_freeText_setText("De reinigingscycli zijn bezig (12)"); break;	//Doing cleaner cycles (12)
				default: pleaseWait_freeText_setText(""); break;
			}
			pleaseWait_freeText_show();
			...
			else
			{
				switch (me.fase)
				{
					default: pleaseWait_btn1_setText ("KNOP " +me.btn2); break;
					case 2:  pleaseWait_btn1_setText ("START"); break;
					case 3:
					case 5:  pleaseWait_btn1_setText ("DOORGAAN"); break;
					case 6:  pleaseWait_btn1_setText ("BEVESTIGEN"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			{
				pleaseWait_btn2_setText ("KNOP " +me.btn2);
				pleaseWait_btn2_show();	
			}			
		})
		.catch( function(result)
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "Controleer voordat u met de reiniging begint of:<ol><li>De watervoorziening in orde is</li><li>De residutank is geleegd</li><li>de melkslang in de reinigingscanister is geplaatst</li><li>het reinigingsmiddel in de canister is geplaatst</li></ol>");
			...
			else
			{
				...
				case 2:	//CIC_STEP_FILL_WATER
					...
					pleaseWait_freeText_setText("Canister wordt gevuld, even geduld a.u.b.<br>De geleidbaarheid van het water is: {0} uS".translateLang(cond_uS)); //Water refilling in progress, please wait.<br>Water conducibility: {0} uS
					break;

				case 3:	//CIC_WAIT_FOR_TABLET_DISSOLVING
					var timeSec = parseInt(obj.buffer8[0]);
					pleaseWait_freeText_setText("Reiniging: -{0}".translateLang(timeSec)); //Rinsing -{0}
					break;
				...
				case 5:	//CIC_cleaning_PHASE2
					...
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Reiniging {0} van {1} is bezig, even geduld a.u.b.<br>De geleidbaarheid van het water: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Rinsing {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 6: //CIC_RINSING_PHASE3
					...
					var ciclo_di = parseInt(obj.buffer8[3]);
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Spoeling {0} van {1} is bezig, even geduld a.u.b.<br>De geleidbaarheid van het water is: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Cleaning {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					...
					pleaseWait_freeText_setText("De reinigingsprocedure is voltooid.<br><br>Denk er a.u.b. aan om:<ul><li>de residutank te legen</li><li>de melkslang terug in de melk te plaatsen</li></ul><br>Druk op SLUITEN om dit scherm te verlaten".translateLang(cond_uS_init_rif,cond_uS_finale)); //The cleaning procedure is finished.<br><Initial conducibility {0} and current conducibility {1},><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;

				case 9: //CIC_WAIT_CONF_LIQUID_DETERGENT
					pleaseWait_freeText_setText("voeg wasmiddel toe aan de melkreservoir, plaats een lege kan in het bekerstation en druk vervolgens op “BEGIN”.<br><br><center><img src='img/milkerInduxClean05.jpg'></center>"); //Please fill liquid detergent and push START
					break;
					
				case 97: //CIC_TOO_MUCH_DETERGENTE
					pleaseWait_freeText_setText("WAARSCHUWING: Te veel of te sterk reinigingsmiddel gedetecteerd!");
					break;
				
				case 98: //CIC_DET_TOO_LOW
					pleaseWait_freeText_setText("WAARSCHUWING: Te weinig of te zwak reinigingsmiddel gedetecteerd!<br>Een nieuwe reinigingcyclus wordt aanbevolen");
					break;

				case 99: //CIC_DET_TOO_AGGRESSIVE
					pleaseWait_freeText_setText("WAARSCHUWING: Het reinigingsmiddel is te agressief");
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						pleaseWait_btn1_setText ("DOORGAAN");
					else
						pleaseWait_btn1_setText ("START");
					break;
				case 7:		pleaseWait_btn1_setText ("SLUITEN"); break;
			...
			else
			{
				...
				case 1:	 pleaseWait_btn2_setText ("AFBREKEN"); break;
				case 7:	 pleaseWait_btn2_setText ("SLUITEN->GEEN MELKSELECTIE"); break;
				}
				pleaseWait_btn2_show();	
			}	
...
TaskCalibMotor.prototype.showPopupCalibrazioneEVPump = function (ev1_5)
{
	...
	pleaseWait_btn1_setText("AFBREKEN");
	pleaseWait_btn1_show();
}
...
console.log ("TaskCalibMotor::fase[" +me.fase +"]");
	...
	case 0:
		...
		pleaseWait_calibration_setText("Even geduld alstublieft terwijl de molen draait"); //Please wait while motor is running
	...
	case 20:
		...
		pleaseWait_calibration_setText("Als u klaar bent, voert u het aantal gram in van de LAATSTE maling en drukt u vervolgens op DOORGAAN"); //Please enter the quantity, then press CONTINUE
	...
	case 40:
		...
		{
			pleaseWait_calibration_setText("Ongeldige waarde");
			me.fase = 20;
			break;
		}
	
		pleaseWait_calibration_setText("Waarde wordt opgeslagen ...");
		me.value = pleaseWait_calibration_num_getValue();
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Verwijder de zetgroep alstublieft, druk vervolgens op DOORGAAN en vang de koffie op."); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("AFBREKEN");
		pleaseWait_btn2_show();	
...
//console.log ("TaskCalibMotor.priv_handleCalibMacina() => runMotor, m="  +me.motor);
	...
	case 25:	//qui ci andiamo se siamo in fase 21 e l'utente preme il btn SET per impostare una nuova apertura del VGrind
		pleaseWait_calibration_setText("Wacht aub tot de varigrind zijn positie heeft aangepast"); //Please wait while the varigrind is adjusting its position
	...
	case 28:
		if (da3.isGruppoVariflex())
		{
			rhea.ajax ("getPosMacina", {"m":(me.motor-10)}).then( function(result)
			{
				var obj = JSON.parse(result);
				rheaSetDivHTMLByName("pagePleaseWait_calibration_1_vg", obj.v);
				pleaseWait_calibration_setText("Wacht aub tot de varigrind zijn positie heeft aangepast" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position  [current pos]
			})
			.catch( function(result)
			{
			});	
...
//console.log	("TaskCalibMotor.priv_handleCalibMacina: setFattoreCalib m=" +me.motor +",v=" +me.gsec);		
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Plaatst de zetgroep terug in positie, druk vervolgens op DOORGAAN"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_show();
		me.fase = 41;
		break;
	...
	case 60: //gruppo è stato ricollegato, procedo con il calcolo impulsi se richiesto
		...
		else
		{
			me.fase = 65;
			pleaseWait_calibration_show();
			pleaseWait_calibration_setText("Impulsberekening bezig, even geduld a.u.b."); //Impulse calculation in progress, please wait
...
TaskTestSelezione.prototype.priv_handleTestMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Verwijder de zetgroep alstublieft, druk vervolgens op DOORGAAN en vang de koffie op."); //Please remove the brewer, then press CONTINUE
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("AFBREKEN");
		pleaseWait_btn2_show();
	...
	case 10:  //ok, il gruppo è scollegato, chiedo a CPU di attivare la macina
		me.fase = 11;
		pleaseWait_calibration_setText ("Molen draait"); //Grinder is running
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Plaats de zetgroep en druk op doorgaan of selecteer herhalen"); //Place the brewer into position then press CONTINUE, or press REPEAT to grind again
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("HERHALEN");
		pleaseWait_btn2_show();		
		me.fase = 41;
		break;
...
TaskDevices.prototype.priv_handleSnackProg = function(timeNowMsec)
{
	...
	case 0:
		this.fase = 10;
		pleaseWait_rotella_hide();
		pleaseWait_btn1_setText("VERLAAT PROGRAMMERING");
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleRichiestaPosizioneMacina = function()
{
	...
	rhea.ajax ("getCupSensorLiveValue", "" ).then( function(result)
	{
		...
		default: rheaSetDivHTMLByName("divCupSensorLiveValueBrewmatic", "GEEN BEKER GEDETECTEERD"); break;
		}
		
		//nel caso di sensore Wenglor
		switch (parseInt(result))
		{
		default: rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "GEEN BEKER GEDETECTEERD"); break;
		case 1:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "KLEINE KOP (beneden)"); break;
		case 2:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "KLEINE KOP (boven)"); break;
		case 3:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "GROTE KOP"); break;
		}		
	})
	.catch( function(result)
	{
...
TaskDevices.prototype.priv_handleRegolazionePosizioneMacina = function()
{
	switch (this.fase)
	{
		case 0: 
			...
			pleaseWait_freeText_setText("Wacht aub tot de varigrind zijn positie heeft aangepast"); //Please wait while the varigrind is adjusting its position
			pleaseWait_freeText_show();
...
TaskDevices.prototype.priv_queryMacina = function(macina_1o2)
{
	...
	rhea.ajax ("getPosMacina", {"m":macina_1o2}).then( function(result)
	{
		...
		pleaseWait_freeText_setText("Wacht aub tot de varigrind zijn positie heeft aangepast" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position [current_value]
	})
	.catch( function(result)
	{
	});			
...
TaskDevices.prototype.priv_handleTestAssorbGruppo = function(timeNowMsec)
{
	...
	{
	case 0:
		pleaseWait_freeText_setText ("De test begint...");
		pleaseWait_freeText_show();
		pleaseWait_rotella_show();
		me.fase = 1;
		me.test_fase = 0;
	...
	case 10:
		...
		pleaseWait_freeText_setText ("De test is bezig, even geduld a.u.b…..<br>huidige fase: " +me.test_fase +"/5");
		me.fase = 11;
		break;
	...
	case 11:
		...
		rhea.ajax ("getStatTestAssGrp", "" ).then( function(result)
		{
			...
			{
				//errore
				pleaseWait_freeText_setText ("De test is klaar.<br>Result: FAILED<br><br>");
				pleaseWait_btn1_setText("SLUITEN");
				pleaseWait_btn1_show();	
				pleaseWait_btn2_setText("HERHALEN");
				pleaseWait_btn2_show();	
				me.fase = 80;
			...
			else
			{
				...
				else
				{
					...
					var html = "<table class='dataAudit'>"
								...
								+"</table>";
					pleaseWait_freeText_setText ("De test is klaar.<br>Results:<br><br>" +html);		
					pleaseWait_btn1_setText("SLUITEN");
					pleaseWait_btn1_show();	
					pleaseWait_btn2_setText("HERHALEN");
					pleaseWait_btn2_show();	
...
TaskDevices.prototype.priv_handleTestAssorbMotoriduttore = function(timeNowMsec)
{
	...
	case 0: //prego rimuovere il gruppo
		me.fase = 1;
		pleaseWait_show();
		pleaseWait_freeText_setText ("Verwijder de zetgroep alstublieft, druk vervolgens op DOORGAAN en vang de koffie op.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("AFBREKEN");
	...
	case 20:
		//ho ricevuto l'OK dal comando start Test. Da ora in poi, pollo lo stato del test fino a che non finisce
		pleaseWait_freeText_setText ("De test is bezig, even geduld a.u.b…..<br>huidige fase: " +me.test_fase +"/4");
		me.fase = 21;
		break;
	...
	case 85: //prego rimettere a posto il gruppo
		pleaseWait_freeText_setText("Plaatst de zetgroep terug in positie, druk vervolgens op DOORGAAN"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		pleaseWait_rotella_show();
		me.fase = 86;
...
TaskDevices.prototype.priv_handleGrinderSpeedTest = function(timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MOLENSNELHEID VOOR OFF09</b><br><br>Verwijder de zetgroep alstublieft, druk vervolgens op DOORGAAN en vang de koffie op."); //Please remove the brewer, then press CONTINUE
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("AFBREKEN");
	...
	case 5: //step 1
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MOLENSNELHEID VOOR OFF09</b><br><br>STAP 1<br>Sluit<b>de koffiecontainer</b> (oranje schuif) en druk op DOORGAAN. De molen zal ongeveer 10 seconden draaien om zichzelf te legen.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("AFBREKEN");
	...
	case 20:
		me.fase = 21;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MOLENSNELHEID VOOR OFF09</b><br><br>STAP 2<br>De machine gaat nu de gemiddelde sensorwaarde bepalen die wordt gerapporteerd wanneer de bonen op zijn. Druk op DOORGAAN. De molen zal ongeveer 10 seconden draaien.");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("AFBREKEN");
	...
	case 40:
		me.fase = 41;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MOLENSNELHEID VOOR OFF09</b><br><br>STAP 3<br>Open nu<b>de koffiecontainer</b> (oranje schuif) en druk op DOORGAAN voor de volgende stap. De molen zal ongeveer 10 seconden draaien.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("AFBREKEN");
	...
	case 60:
		me.fase = 61;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MOLENSNELHEID VOOR OFF09</b><br><br>RESULTAAT:<br>Gemiddelde snelheid wanneer de molen leeg is: <b>" +me.speed1 +"</b><br>Gemiddelde snelheid wanneer de molen niet leeg is: <b>" +me.speed2 +"</b><br>");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("SLUITEN");
		pleaseWait_btn1_show();
		break;
	...
	case 70: //chiedo di rimettere a posto il gruppo
		...
		else
		{
			me.fase = 71;
			pleaseWait_rotella_hide();
			pleaseWait_freeText_setText("<b>MOLENSNELHEID VOOR OFF09</b><br><br>Plaatst de zetgroep terug in positie, druk vervolgens op DOORGAAN"); //Place the brewer into position, then press CONTINUE
			pleaseWait_freeText_show();
			pleaseWait_btn1_setText("DOORGAAN");
			pleaseWait_btn1_show();
		}
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_freeText_show();
		pleaseWait_freeText_setText("De-installatie<br>lekbak leeg?"); //DISINTALLATION<br><br>Is driptray empty?
		pleaseWait_btn1_setText("Ja, doorgaan");
		pleaseWait_btn2_setText("AFBREKEN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 10:
		this.fase = 11;
		pleaseWait_freeText_setText("De-installatie<br><br>verwijder koffieresidu en druk op doorgaan"); //DISINTALLATION<br><br>Please remove coffee grounds, then press CONTINUE
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn2_setText("AFBREKEN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
	...
	case 20:
		this.fase = 21;
		pleaseWait_freeText_setText("De-installatie<br><br>Druk op start de-installatie om door te gaan of druk annuleer om te stoppen."); //DISINTALLATION<br><br>Press START DISINSTALLATION to continue, ABORT to cancel the operation
		pleaseWait_btn1_setText("START DE DE-INSTALLATIE");
		pleaseWait_btn2_setText("AFBREKEN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("De-installatie wordt uitgevoerd, wachten aub ...<br><br><br>Druk op de PROG-knop om af te breken"); //DISINTALLATION is running, please wait
		else
			pleaseWait_freeText_setText("De-installatie wordt uitgevoerd, wachten aub ..."); //DISINTALLATION is running, please wait
	...
	case 40:
		var msgToOutput = "De-installatie beeindigd, Schakel de machine uit"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "De-installatie voltooid - sluit de boilerkraan en schakel de machine uit"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
	...
	case 51:
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("De-installatie<br><br>open de boilerkraan en druk op doorgaan ...<br><br><br>Druk op de PROG-knop om af te breken"); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
		else
			pleaseWait_freeText_setText("De-installatie<br><br>open de boilerkraan en druk op doorgaan ..."); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
...
TaskDataAudit.prototype.onTimer = function (timeNowMsec)
{
	...
	switch (this.fase)
	{
		...
		case 10: //eva dts scaricato
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			me.fase = 20;
			pleaseWait_freeText_appendText ("<br>Voltooid; Even geduld a.u.b. - Gegevens worden verwerkt<br>"); //Done, processing data, please wait
			break;
		...
		case 200: //errore downloading eva-dts
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			pleaseWait_freeText_appendText("Fout Download EVA-DTS - Probeer het opnieuw"); //Error downloading EVA-DTS. Please try again later
			me.fase = 201;
			break;
...
TaskGrinderClean.prototype.onEvent_cpuStatus  	= function(statusID, statusStr, flag16)		{ this.cpuStatus = statusID; pleaseWait_header_setTextL ("MOLEN REINIGEN"); }
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	...
	var msg = "Maalcyclus {0} van {1} is bezig".translateLang(this.curCiclo,this.numCicli);
	msg += "<br><br><b>Vang het product op</b>";
	this.priv_show (msg, "", "");	
...
TaskGrinderClean.prototype.runGrinderCycle_3 = function(timeNowMsec)
{
	...
	var msg = "Maalcyclus {0} van {1} is bezig".translateLang(this.curCiclo-1,this.numCicli);
	msg += "<br>" +"{0} sec. wachten".translateLang(timeLeftSec);
	this.priv_show (msg, "", "");	
	if (timeLeftMSec <= 0)
		this.runGrinderCycle_1();
}
...
//console.log ("fase="+this.fase);	
	...
	{
		pleaseWait_freeText_setText ("<b>MOLEN REINIGEN</b><br><br>" + text);
		pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step1 = function()
{
	...
	this.priv_show ("&nbsp;", "DOORGAAN", "AFBREKEN");
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	var msg = "Sluit de schuif van het bonenreservoir om morsen van bonen te voorkomen.";
	msg += "<br>Druk op DOORGAAN indien gereed.";
	this.priv_show (msg, "DOORGAAN", "");
}
...
TaskGrinderClean.prototype.step3 = function()
{
	...
	var msg = "Verwijder de zetgroep en het bonenreservoir.";
	msg += "<br>Druk op DOORGAAN indien gereed.";
	this.priv_show (msg, "DOORGAAN", "");
}
...
TaskGrinderClean.prototype.step5 = function()
{
	...
	var msg = "Installeer de molenreiniger.";
	msg += "<br>Druk op DOORGAAN indien gereed.";	
	this.priv_show (msg, "DOORGAAN", "");	
}
...
TaskGrinderClean.prototype.step6 = function()
{
	...
	var msg = "Reinigingsapparaat bijvullen.";
	msg += "<br>Druk op DOORGAAN indien gereed.";
	msg += "<br><br><b>LET OP</b> Zodra er op DOORGAAN wordt gedrukt, begint de molen te draaien";
	this.priv_show (msg, "DOORGAAN", "");	
}
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("Wilt u de maalhandelingen herhalen?", "NEE", "JA");
}
...
TaskGrinderClean.prototype.step21 = function()
{
	...
	var msg = "Plaats het bonereservoir terug.";
	msg += "<br>Druk op DOORGAAN indien gereed.";
	this.priv_show (msg, "DOORGAAN", "");
}
...
TaskGrinderClean.prototype.step23 = function()
{
	...
	var msg = "Open de schuif van het bonenreservoir.";
	msg += "<br>Druk op DOORGAAN indien gereed.";
	msg += "<br><br><b>LET OP</b> Zodra er op DOORGAAN wordt gedrukt, begint de molen te draaien";
	this.priv_show (msg, "DOORGAAN", "");	
}
...
TaskGrinderClean.prototype.step26 = function()
{
	...
	var msg = "Plaats de zetgroep terug in positie.";
	msg += "<br>Druk op DOORGAAN indien gereed.";
	this.priv_show (msg, "DOORGAAN", "");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("Wilt u een koffie bereiden?", "NEE", "JA");
}
...
TaskCalibMilkPump.prototype.priv_handleCalibMilkPump = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_calibMilkPump_setText("Vul het melkreservoir met water, plaats een lege kan in het bekerstation en druk vervolgens op “DOORGAAN”.");
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		var btnText = "UITGANG";
		pleaseWait_btn2_setText (btnText);
	...
	case 12:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
	    pleaseWait_calibMilkPump_setText("Even geduld a.u.b. terwijl er water wordt afgegeven"); 
	...
	case 13:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
		pleaseWait_calibMilkPump_setText("Leeg de kan in het bekerstation en druk vervolgens op 'DOORGAAN'");
		pleaseWait_btn1_setText("DOORGAAN");
		pleaseWait_btn1_show();
		break;	
	...
	case 20:
		...
		pleaseWait_calibMilkPump_setText("Wanneer u klaar bent, voert u de hoeveelheid in ml van het LAATSTE afgegeven water in,<br> max. 340 ml <br>druk vervolgens op DOORGAAN<br><br>"); //Please enter the quantity, then press CONTINUE
...
TaskCleaning.prototype.priv_handleSyrupCleaning = function (timeElapsedMSec)		//#4660
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = " "; break;
				case 1:		msg = "Place an one-liter tank with the correct quantity of detergent under the cup station, Druk op DOORGAAN als u klaar bent."; break;			//SYRUP_CLEANING_PREPARE_TANK_UNDER_NOZZLES,
				case 2:		msg = "Hot water is flowing from the the nozzle in the tank with cleaning detergent. even wachten a.u.b...."; break;
				case 3:		msg = "Remove the tubes from the syrup bottles and place them in the cleaning solution tank, Druk op DOORGAAN als u klaar bent."; break;
				case 4:		msg = "step 1 - Cleaning solution is flowing from the syrup tube nozzles. even wachten a.u.b...."; break;
				case 5:		msg = "step 1 - Please wait for the cleaning solution action…, even wachten a.u.b...."; break;
				case 6:		msg = "step 2 - Cleaning solution is flowing from the syrup tube nozzles. even wachten a.u.b...."; break;
				case 7:		msg = "step 2 - Please wait for the cleaning solution action…. even wachten a.u.b...."; break;
				case 8:		msg = "Place a clean empty tank under the cup station, Druk op DOORGAAN als u klaar bent."; break;
				case 9:		msg = "Hot water is flowing from the the nozzle in the tank. even wachten a.u.b...."; break;
				case 10:	msg = "Place the syrup tubes in the cleaning water tank. Druk op DOORGAAN als u klaar bent."; break;
				case 11:	msg = "Hot water  is flowing from the syrup tube nozzles."; break;
				case 12:	msg = "Check the syrup tubes. Do you want to repeat the rinsing ?  Press REPEAT to rinse again the tubes.. Druk op DOORGAAN als u klaar bent."; break;
