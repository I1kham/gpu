...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_btn1_setText("ПОТВЪРДИ");
	pleaseWait_btn1_show();
	pleaseWait_btn2_setText("НЕ");
...
TaskCleaning.prototype.priv_handleSanWashingMicro = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 0: pleaseWait_freeText_setText("Почистването на групата не е стартирало(или преключило)"); break;	//Brewer Cleaning is not started (or ended)
				case 1: pleaseWait_freeText_setText("Почистване на група започна"); break; 	//Brewer Cleaning is started
				case 2: pleaseWait_freeText_setText("Групата поставена"); break; 	//Brewer placed
				case 3: pleaseWait_freeText_setText("Постави таблетка и натисни СТАРТ"); break; //Put pastille and push START
				case 4: pleaseWait_freeText_setText("инфузия"); break; //Infusion
				case 5: pleaseWait_freeText_setText("Цикъл почистване на група 1"); break; // Brewer cleaning cycles 1
				case 6: pleaseWait_freeText_setText("Цикъл почистване на група 2"); break;	// Brewer cleaning cycles 2
				case 7: pleaseWait_freeText_setText("Цикъл почистване на група 3"); break;	// Brewer cleaning cycles 3
				case 8: pleaseWait_freeText_setText("Цикъл почистване на група 4"); break;	// Brewer cleaning cycles 4
				case 9: pleaseWait_freeText_setText("Цикъл почистване на група 5"); break;	// Brewer cleaning cycles 56
				case 10: pleaseWait_freeText_setText("Цикъл почистване на група 6"); break;	// HC_STEP_BRW_6
				
				case 11: pleaseWait_freeText_setText("Повтори почистването?"); break;	//Repeat cleaning ?
				case 12: pleaseWait_freeText_setText("Групата е на позиция,след ръчно почистване натисни ПРОДЪЛЖИ"); break;	//Brewer placed in brush position, press CONTINUE when finished
				case 13: pleaseWait_freeText_setText("Пропусни пробно кафе,или направи кафе"); break; //Skip final coffee or make a coffee
				case 14: pleaseWait_freeText_setText("Кафето се приготвя"); break; //Coffee delivery
			...
			if (me.fase != me.prevFase)
			{
				...
				else
				{
					...
					{
						var btnText = "БУТОН " +me.btn1;
						switch (me.fase)
						{
							case 3:  btnText = "СТАРТ"; break; //HC_STEP_TABLET
							case 11: btnText = "НЕ"; break; //HC_STEP_BRW_REPEAT
							case 12: btnText = "ПРОДЪЛЖИ"; break; //HC_STEP_BRW_BRUSH_POSITION
							case 13: btnText = "ПРОПУНИ  КАФЕ"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
						}
				...
				{
					var btnText = "БУТОН " +me.btn2;
					switch (me.fase)
					{
						case 11: btnText = "ДА"; break;//HC_STEP_BRW_REPEAT
						case 13: btnText = "ВЗЕМИ СИ КАФЕ"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
					}
...
TaskCleaning.prototype.priv_handleDescalingMilker = function (timeElapsedMSec)		//#4419
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = ". Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 2:		msg = "Източване на воден кръг, моля изчакайте…"; break;
				case 3:		msg = ". Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 4:		msg = "Добави препарат за почистване. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 5:		msg = "Пълнене на воден кръг с препарат, моля изчакайте…"; break;
				case 6:		msg = "Провери нивото на препарат в резервоара. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 7:		msg = "Стартира пълнене с препарат, моля изчакайте…"; break;
				case 8:		msg = "Изчакайте препарата да реагира…"; break;
				case 9:		msg = "Източване на препарата през чашките, моля изчакайте…"; break;
				case 10:	msg = "start emptying and rinsing of the hydraulic circuit"; break;
				case 11:	msg = ". Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 12:	msg = "Изпразване на воден кръг, моля изчакайте…"; break;
				case 13:	msg = ". Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 14:	msg = "Зареди резервоара с чиста вода за промиване. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 15:	msg = "Водния кръг ще се напълни с вода, моля изчакайте…"; break;
				case 16:	msg = "Провери нивото на водата в резервоара. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 17:	msg = "Източване на водата през чашките."; break;
				case 18:	msg = "Пускане на вода за проба, постави чаша за пробата. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 19:	msg = "Пусни вода за проба през всяка чашка."; break;
				case 20:	msg = "След проверка на пробата.Натисни ПРОДЪЛЖИ или ПОВТОРИ за ново почистване на водния кръг"; break;
				case 21:	msg = "Почистването завърши, натисни ЗАТВОРИ за да преключи."; break;
			}
...
TaskCleaning.prototype.priv_handleDescalingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = "Извади тапата за източване на водата. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 2:		msg = "Източване на воден кръг, моля изчакайте…"; break;
				case 3:		msg = "Постави тапата за източване на водата. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 4:		msg = "Добави препарат за почистване. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 5:		msg = "Пълнене на воден кръг с препарат, моля изчакайте…"; break;
				case 6:		msg = "Провери нивото на препарат в резервоара. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 7:		msg = "Стартира пълнене с препарат, моля изчакайте…"; break;
				case 8:		msg = "Изчакайте препарата да реагира…"; break;
				case 9:		msg = "Източване на препарата през чашките, моля изчакайте…"; break;
				case 10:	msg = "Провери водата за да определиш успешно ли е почистването."; break;
				case 11:	msg = "Извади тапата за източване на водата. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 12:	msg = "Изпразване на воден кръг, моля изчакайте…"; break;
				case 13:	msg = "Постави тапата за източване на водата. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 14:	msg = "Зареди резервоара с чиста вода за промиване. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 15:	msg = "Водния кръг ще се напълни с вода, моля изчакайте…"; break;
				case 16:	msg = "Провери нивото на водата в резервоара. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 17:	msg = "Източване на водата през чашките."; break;
...
TaskCleaning.prototype.priv_handleSanWashingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: msg = ""; break;
				case 0: msg = "Почистването е в ход"; break;	//Cleaning is active
				case 1: msg = "Постави таблетката в групата и натисни ПРОДЪЛЖИ"; break; 	//Put the pastille in the brewer and press CONTINUE
				case 2: msg = "Групата се затваря"; break; 	//Brewer is closing
				case 3: msg = "Разтваряне на таблетката 1/2, изчакай"; break; 	//Tablet dissolution 1/2, please wait
				case 4: msg = "Ще започне втори цикъл на разтваряне"; break; 	//2nd dissolution cycle is about to starting
				case 5: msg = "Разтваряне на таблетката 2/2, изчакай"; break; 	//Tablet dissolution 1/2, please wait

				case 6: msg = "Първо почистване, изчакай 1/3"; break; 	//1st Cleaning, please wait 1/3
				case 7: msg = "Първо почистване в ход 1/3"; break; 	//1st Cleaning, active 1/3
				case 8: msg = "Първо почистване, изчакай 2/3"; break; 	//1st Cleaning, please wait 2/3
				case 9: msg = "Първо почистване в ход 2/3"; break; 	//1st Cleaning, active 2/3
				case 10: msg = "Първо почистване, изчакай 3/3"; break; 	//1st Cleaning, please wait 3/3
				case 11: msg = "Първо почистване в ход 3/3"; break; 	//1st Cleaning, active 3/3

				case 12: msg = "Искаш ли да повториш почистващия цикъл 1/2?"; break; 	//Do you want to repeat clean cycle 1/2 ?
				
				case 13: msg = "Групата се отваря"; break; 	//Brewer is going into open position
				
				case 14: msg = "Почисти ръчно и натисни ПРОДЪЛЖИ"; break; 	//Please, perform a manual brush and then press CONTINUE when finished
				
				case 15: msg = "Второ почистване, изчакай 1/6"; break; 	//2nd Cleaning, please wait 1/6
				case 16: msg = "Второ почистване в ход 1/6"; break; 	//2nd Cleaning, active 1/6
				case 17: msg = "Второ почистване, изчакай 2/6"; break; 	//2nd Cleaning, please wait 2/6
				case 18: msg = "Второ почистване в ход 2/6"; break; 	//2nd Cleaning, active 2/6
				case 19: msg = "Второ почистване, изчакай 3/6"; break; 	//2nd Cleaning, please wait 3/6
				case 20: msg = "Второ почистване в ход 3/6"; break; 	//2nd Cleaning, active 3/6
				case 21: msg = "Второ почистване, изчакай 4/6"; break; 	//2nd Cleaning, please wait 4/6
				case 22: msg = "Второ почистване в ход 4/6"; break; 	//2nd Cleaning, active 4/6
				case 23: msg = "Второ почистване, изчакай 5/6"; break; 	//2nd Cleaning, please wait 5/6
				case 24: msg = "Второ почистване в ход 5/6"; break; 	//2nd Cleaning, active 5/6
				case 25: msg = "Второ почистване, изчакай 6/6"; break; 	//2nd Cleaning, please wait 6/6
				case 26: msg = "Второ почистване в ход 6/6"; break; 	//2nd Cleaning, active 6/6
				
				case 27: msg = "Искаш ли да повториш почистващия цикъл 2/2?"; break; 	//Do you want to repeat clean cycle 2/2 ?
				
				case 28: msg = "Искаш ли да пропуснеш пробното кафе?"; break; //Do you want to skip the final coffee ?
				case 29: msg = "Кафето се приготвя, изчакай"; break; //Coffee delivery, please wait

				case 30: msg = "Промивка на Групата"; break; //Brewer Rinsing 
				...
				case 34: msg = "Почистването на Групата Преключи.Натисни ЗАТВОРИ за да завърши"; break; //Brewer Cleaning Done. Press CLOSE to exit
				case 35: msg = "Предпочитате РЪЧНО или АВТОМАТИЧНО почистване?"; break; //Do you want to perform MANUAL or AUTOMATIC washing?
			}
			...
			if ( (me.fase != me.prevFase) || ( me.fase == me.prevFase && (me.btn1 != me.prevFaseBtn1 || me.btn2 != me.prevFaseBtn2) ))
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							case 1:  btnText = "ПРОДЪЛЖИ"; break;
							case 12: btnText = "НЕ"; break; //Do you want to repeat clean cycle 1/2 ?
							case 14:  btnText = "ПРОДЪЛЖИ"; break;
							case 27: btnText = "НЕ"; break; //Do you want to repeat clean cycle 2/2 ?
							case 28: btnText = "ПРОПУНИ  КАФЕ"; break; //Do you want to skip the final coffee ?
							case 34: btnText = "ЗАТВОРИ"; break; //Do you want to skip the final coffee ?
							case 35: btnText = "АВТОМАТИЧНО"; break;
				...
				else
				{
					...
					switch (me.fase)
					{
						case 12: btnText = "ДА"; break; //Do you want to repeat clean cycle 1/2 ?
						case 27: btnText = "ДА"; break; //Do you want to repeat clean cycle 2/2 ?
						case 28: btnText = "ВЗЕМИ СИ КАФЕ"; break; //Do you want to skip the final coffee ?
						case 35: btnText = "УПЪТВАНЕ"; break;
					}
					pleaseWait_btn2_setText (btnText);
					pleaseWait_btn2_show();	
				}
...
TaskCleaning.prototype.priv_handleMilkWashingVenturi = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 1: pleaseWait_freeText_setText("Почистване модул мляко стартирано"); break;	//Milker Cleaning is started
				case 2: pleaseWait_freeText_setText("Загрява за почистване"); break;	//Warming for cleaner
				case 3: pleaseWait_freeText_setText("Изчакай за потвърждение"); break;	//Wait for confirm
				case 4: pleaseWait_freeText_setText("Извършване на почистващи цикли(12)"); break;	//Doing cleaner cycles (12)
				case 5: pleaseWait_freeText_setText("Загряване на водата"); break;	//Warming for water
				case 6: pleaseWait_freeText_setText("Изчакай за второ потвърждение"); break;	//Wait for second confirm
				case 7: pleaseWait_freeText_setText("Извършване на почистващи цикли(12)"); break;	//Doing cleaner cycles (12)
				default: pleaseWait_freeText_setText(""); break;
			}
			pleaseWait_freeText_show();
			...
			else
			{
				switch (me.fase)
				{
					default: pleaseWait_btn1_setText ("БУТОН " +me.btn2); break;
					case 2:  pleaseWait_btn1_setText ("СТАРТ"); break;
					case 3:
					case 5:  pleaseWait_btn1_setText ("ПРОДЪЛЖИ"); break;
					case 6:  pleaseWait_btn1_setText ("ПОТВЪРДИ"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			{
				pleaseWait_btn2_setText ("БУТОН " +me.btn2);
				pleaseWait_btn2_show();	
			}			
		})
		.catch( function(result)
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "Before starting the cleaning, please check that:<ol><li>water supply is available</li><li>waste tank is empty</li><li>the milk tube is in the cleaning jug</li><li>the detergent is filled into the jug</li></ol>");
			...
			else
			{
				...
				case 3:	//CIC_WAIT_FOR_TABLET_DISSOLVING
					...
					pleaseWait_freeText_setText("Cleaning in progress: -{0}".translateLang(timeSec)); //Rinsing -{0}
					break;
				...
				case 6: //CIC_RINSING_PHASE3
					...
					var ciclo_di = parseInt(obj.buffer8[3]);
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Rinsing {0} of {1} in progress, please wait.<br>Water conducibility: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Cleaning {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					...
					pleaseWait_freeText_setText("The cleaning procedure is finished.<br><br>Initial conducibility {0} Final conducibility {1}<br><br>Please, remember to:<ul><li>empty waste tank</li><li>put the milk pipe back into position</li></ul><br>Press <br>CLOSE to close this window and check the milk presence or<br> CLOSE NO SEL.MILK if you don't want to enable milk selections".translateLang(cond_uS_init_rif,cond_uS_finale)); //The cleaning procedure is finished.<br><Initial conducibility {0} and current conducibility {1},><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;

				case 9: //CIC_WAIT_CONF_LIQUID_DETERGENT
					pleaseWait_freeText_setText("Please fill the cleaning jug with the detergent. Press START when done<br><br><center><img src='img/milkerInduxClean05.jpg'></center>"); //Please fill liquid detergent and push START
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						pleaseWait_btn1_setText ("ПРОДЪЛЖИ");
					else
						pleaseWait_btn1_setText ("СТАРТ");
					break;
				case 7:		pleaseWait_btn1_setText ("ЗАТВОРИ"); break;
			...
			else
			{
				...
				case 1:	 pleaseWait_btn2_setText ("ПРЕКРАТИ"); break;
				case 7:	 pleaseWait_btn2_setText ("CLOSE NO SEL.MILK"); break;
				}
				pleaseWait_btn2_show();	
			}	
...
TaskCalibMotor.prototype.showPopupCalibrazioneEVPump = function (ev1_5)
{
	...
	pleaseWait_btn1_setText("ПРЕКРАТИ");
	pleaseWait_btn1_show();
}
...
console.log ("TaskCalibMotor::fase[" +me.fase +"]");
	...
	case 0:
		...
		pleaseWait_calibration_setText("Изчакай,мотора работи"); //Please wait while motor is running
	...
	case 20:
		...
		pleaseWait_calibration_setText("Когато сте готови,въведете количеството в грамове от ПОСЛЕДНОТО мелене, след което натиснете ПРОДЪЛЖИ"); //Please enter the quantity, then press CONTINUE
	...
	case 40:
		...
		{
			pleaseWait_calibration_setText("Невалидна стойност");
			me.fase = 20;
			break;
		}
	
		pleaseWait_calibration_setText("Съхраняване на стойност ...");
		me.value = pleaseWait_calibration_num_getValue();
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Извади групата, и натисни ПРОДЪЛЖИ"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ПРЕКРАТИ");
		pleaseWait_btn2_show();	
...
//console.log ("TaskCalibMotor.priv_handleCalibMacina() => runMotor, m="  +me.motor);
	...
	case 25:	//qui ci andiamo se siamo in fase 21 e l'utente preme il btn SET per impostare una nuova apertura del VGrind
		pleaseWait_calibration_setText("Изчакай,мелачката коригира позицията си"); //Please wait while the varigrind is adjusting its position
	...
	case 28:
		if (da3.isGruppoVariflex())
		{
			rhea.ajax ("getPosMacina", {"m":(me.motor-10)}).then( function(result)
			{
				var obj = JSON.parse(result);
				rheaSetDivHTMLByName("pagePleaseWait_calibration_1_vg", obj.v);
				pleaseWait_calibration_setText("Изчакай,мелачката коригира позицията си" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position  [current pos]
			})
			.catch( function(result)
			{
			});	
...
//console.log	("TaskCalibMotor.priv_handleCalibMacina: setFattoreCalib m=" +me.motor +",v=" +me.gsec);		
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Постави групата, и натисни ПРОДЪЛЖИ"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_show();
		me.fase = 41;
		break;
	...
	case 60: //gruppo è stato ricollegato, procedo con il calcolo impulsi se richiesto
		...
		else
		{
			me.fase = 65;
			pleaseWait_calibration_show();
			pleaseWait_calibration_setText("Импулсен калкулатор в ход,изчакай"); //Impulse calculation in progress, please wait
...
TaskTestSelezione.prototype.priv_handleTestMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Извади групата, и натисни ПРОДЪЛЖИ"); //Please remove the brewer, then press CONTINUE
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ПРЕКРАТИ");
		pleaseWait_btn2_show();
	...
	case 10:  //ok, il gruppo è scollegato, chiedo a CPU di attivare la macina
		me.fase = 11;
		pleaseWait_calibration_setText ("Мелачката работи"); //Grinder is running
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Постави групата и натисни ПРОДЪЛЖИ, или натисни ПОВТОРИ за да смели отново"); //Place the brewer into position then press CONTINUE, or press REPEAT to grind again
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ПОВТОРИ");
		pleaseWait_btn2_show();		
		me.fase = 41;
		break;
...
TaskDevices.prototype.priv_handleSnackProg = function(timeNowMsec)
{
	...
	case 0:
		this.fase = 10;
		pleaseWait_rotella_hide();
		pleaseWait_btn1_setText("ИЗХОД ПРОГРАМИРАНЕ");
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleRichiestaPosizioneMacina = function()
{
	...
	rhea.ajax ("getCupSensorLiveValue", "" ).then( function(result)
	{
		...
		default: rheaSetDivHTMLByName("divCupSensorLiveValueBrewmatic", "НЕ Е ОТКРИТА ЧАША"); break;
		}
		
		//nel caso di sensore Wenglor
		switch (parseInt(result))
		{
		default: rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "НЕ Е ОТКРИТА ЧАША"); break;
		case 1:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "МАЛКА ЧАША (долу)"); break;
		case 2:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "МАЛКА ЧАША (горе)"); break;
		case 3:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "ГОЛЯМА ЧАША"); break;
		}		
	})
	.catch( function(result)
	{
...
TaskDevices.prototype.priv_handleRegolazionePosizioneMacina = function()
{
	switch (this.fase)
	{
		case 0: 
			...
			pleaseWait_freeText_setText("Изчакай,мелачката коригира позицията си"); //Please wait while the varigrind is adjusting its position
			pleaseWait_freeText_show();
...
TaskDevices.prototype.priv_queryMacina = function(macina_1o2)
{
	...
	rhea.ajax ("getPosMacina", {"m":macina_1o2}).then( function(result)
	{
		...
		pleaseWait_freeText_setText("Изчакай,мелачката коригира позицията си" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position [current_value]
	})
	.catch( function(result)
	{
	});			
...
TaskDevices.prototype.priv_handleTestAssorbGruppo = function(timeNowMsec)
{
	...
	{
	case 0:
		pleaseWait_freeText_setText ("Теста стартира...");
		pleaseWait_freeText_show();
		pleaseWait_rotella_show();
		me.fase = 1;
		me.test_fase = 0;
	...
	case 10:
		...
		pleaseWait_freeText_setText ("Теста е в ход,моля изчакай...<br>Текуща фаза " +me.test_fase +"/5");
		me.fase = 11;
		break;
	...
	case 11:
		...
		rhea.ajax ("getStatTestAssGrp", "" ).then( function(result)
		{
			...
			{
				//errore
				pleaseWait_freeText_setText ("Теста е завършен.<br>Result: FAILED<br><br>");
				pleaseWait_btn1_setText("ЗАТВОРИ");
				pleaseWait_btn1_show();	
				pleaseWait_btn2_setText("ПОВТОРИ");
				pleaseWait_btn2_show();	
				me.fase = 80;
			...
			else
			{
				...
				else
				{
					...
					var html = "<table class='dataAudit'>"
								...
								+"</table>";
					pleaseWait_freeText_setText ("Теста е завършен.<br>Results:<br><br>" +html);		
					pleaseWait_btn1_setText("ЗАТВОРИ");
					pleaseWait_btn1_show();	
					pleaseWait_btn2_setText("ПОВТОРИ");
					pleaseWait_btn2_show();	
...
TaskDevices.prototype.priv_handleTestAssorbMotoriduttore = function(timeNowMsec)
{
	...
	case 0: //prego rimuovere il gruppo
		me.fase = 1;
		pleaseWait_show();
		pleaseWait_freeText_setText ("Извади групата, и натисни ПРОДЪЛЖИ");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ПРЕКРАТИ");
	...
	case 20:
		//ho ricevuto l'OK dal comando start Test. Da ora in poi, pollo lo stato del test fino a che non finisce
		pleaseWait_freeText_setText ("Теста е в ход,моля изчакай...<br>Текуща фаза " +me.test_fase +"/4");
		me.fase = 21;
		break;
	...
	case 85: //prego rimettere a posto il gruppo
		pleaseWait_freeText_setText("Постави групата, и натисни ПРОДЪЛЖИ"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		pleaseWait_rotella_show();
		me.fase = 86;
...
TaskDevices.prototype.priv_handleGrinderSpeedTest = function(timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>СКОРОСТ НА МЕЛАЧКАТА ЗА OFF9</b><br><br>Извади групата, и натисни ПРОДЪЛЖИ"); //Please remove the brewer, then press CONTINUE
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ПРЕКРАТИ");
	...
	case 5: //step 1
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>СКОРОСТ НА МЕЛАЧКАТА ЗА OFF9</b><br><br>СТЪПКА 1<br>Моля,<br>затвори бункера за кафе</br>(оранжевия език) и натисни ПРОДЪЛЖИ. Мелачката ще работи 10 секунди за да изпразни останалото кафе");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ПРЕКРАТИ");
	...
	case 20:
		me.fase = 21;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>СКОРОСТ НА МЕЛАЧКАТА ЗА OFF9</b><br><br>СТЪПКА 2<br>След като мелачката е изпразнена, можем да я тестваме за да определим средната сойност на сензора. Натисни ПРОДЪЛЖИ. Мелачката ще работи 10 секунди");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ПРЕКРАТИ");
	...
	case 40:
		me.fase = 41;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>СКОРОСТ НА МЕЛАЧКАТА ЗА OFF9</b><br><br>СТЪПКА 3<br>Сега<br>отвори бункера за кафе</br>(оранжевия език) и натисни ПРОДЪЛЖИ. Мелачката ще работи 10 секунди");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ПРЕКРАТИ");
	...
	case 60:
		me.fase = 61;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>СКОРОСТ НА МЕЛАЧКАТА ЗА OFF9</b><br><br>РЕЗУЛТАТ:<br>Средна скорост при празна мелачка: <b>" +me.speed1 +"</b><br>Средна скорост при пълна мелачка: <b>" +me.speed2 +"</b><br>");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("ЗАТВОРИ");
		pleaseWait_btn1_show();
		break;
	...
	case 70: //chiedo di rimettere a posto il gruppo
		...
		else
		{
			me.fase = 71;
			pleaseWait_rotella_hide();
			pleaseWait_freeText_setText("<b>СКОРОСТ НА МЕЛАЧКАТА ЗА OFF9</b><br><br>Постави групата, и натисни ПРОДЪЛЖИ"); //Place the brewer into position, then press CONTINUE
			pleaseWait_freeText_show();
			pleaseWait_btn1_setText("ПРОДЪЛЖИ");
			pleaseWait_btn1_show();
		}
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_freeText_show();
		pleaseWait_freeText_setText("ДЕИНСТАЛИРАНЕ<br><br>празна ли е тавичката?"); //DISINTALLATION<br><br>Is driptray empty?
		pleaseWait_btn1_setText("ДА-ПРОДЪЛЖИ");
		pleaseWait_btn2_setText("ПРЕКРАТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 10:
		this.fase = 11;
		pleaseWait_freeText_setText("ДЕИНСТАЛИРАНЕ<br><br>Изхвърли отпадачното кафе и натисни ПРОДЪЛЖИ"); //DISINTALLATION<br><br>Please remove coffee grounds, then press CONTINUE
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn2_setText("ПРЕКРАТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
	...
	case 20:
		this.fase = 21;
		pleaseWait_freeText_setText("ДЕИНСТАЛИРАНЕ<br><br>Натисни СТАРТ ДЕИНСТАЛИРАНЕ за да продъжиш, или ПРЕКРАТИ за отмяна на операцията"); //DISINTALLATION<br><br>Press START DISINSTALLATION to continue, ABORT to cancel the operation
		pleaseWait_btn1_setText("СТАРТ ДЕИНСТАЛИРАНЕ");
		pleaseWait_btn2_setText("ПРЕКРАТИ");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("ДЕИНСТАЛИРАНЕ в ход, изчакай ...<br><br><br>Press PROG button to abort"); //DISINTALLATION is running, please wait
		else
			pleaseWait_freeText_setText("ДЕИНСТАЛИРАНЕ в ход, изчакай ..."); //DISINTALLATION is running, please wait
	...
	case 40:
		var msgToOutput = "ДЕИНСТАЛИРАНЕ завършено, ИЗКЛЮЧИ машината"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "ДЕИНСТАЛИРАНЕ завършено,постави тапата за източване на водата и ИЗКЛЮЧИ машината"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
	...
	case 51:
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("ДЕИНСТАЛИРАНЕ<br><br>премахни тапата за източване на водата и натисни ПРОДЪЛЖИ ...<br><br><br>Press PROG button to abort"); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
		else
			pleaseWait_freeText_setText("ДЕИНСТАЛИРАНЕ<br><br>премахни тапата за източване на водата и натисни ПРОДЪЛЖИ ..."); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
...
TaskDataAudit.prototype.onTimer = function (timeNowMsec)
{
	...
	switch (this.fase)
	{
		...
		case 10: //eva dts scaricato
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			me.fase = 20;
			pleaseWait_freeText_appendText ("<br>Готово.Обработване на данни, изчакай<br>"); //Done, processing data, please wait
			break;
		...
		case 200: //errore downloading eva-dts
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			pleaseWait_freeText_appendText("Грешка при изтегляне EVA-DTS.Опитай пак след малко"); //Error downloading EVA-DTS. Please try again later
			me.fase = 201;
			break;
...
TaskGrinderClean.prototype.onEvent_cpuStatus  	= function(statusID, statusStr, flag16)		{ this.cpuStatus = statusID; pleaseWait_header_setTextL ("ПОЧИСТВАНЕ МЕЛАЧКА"); }
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	...
	var msg = "Почистване мелачка в ход {0} от {1}".translateLang(this.curCiclo,this.numCicli);
	msg += "<br><br><b>Замерване на продукт</b>";
	this.priv_show (msg, "", "");	
...
TaskGrinderClean.prototype.runGrinderCycle_3 = function(timeNowMsec)
{
	...
	var msg = "Почистване мелачка в ход {0} от {1}".translateLang(this.curCiclo-1,this.numCicli);
	msg += "<br>" +"Изчакване {0} сек.".translateLang(timeLeftSec);
	this.priv_show (msg, "", "");	
	if (timeLeftMSec <= 0)
		this.runGrinderCycle_1();
}
...
//console.log ("fase="+this.fase);	
	...
	{
		pleaseWait_freeText_setText ("<b>ПОЧИСТВАНЕ МЕЛАЧКА</b><br><br>" + text);
		pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step1 = function()
{
	...
	this.priv_show ("&nbsp;", "ПРОДЪЛЖИ", "ПРЕКРАТИ");
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	var msg = "Затвори езичето на бункера с кафе.";
	msg += "<br>Натисни ПРОДЪЛЖИ след като си готов.";
	this.priv_show (msg, "ПРОДЪЛЖИ", "");
}
...
TaskGrinderClean.prototype.step3 = function()
{
	...
	var msg = "Извади групата и бункера с кафе.";
	msg += "<br>Натисни ПРОДЪЛЖИ след като си готов.";
	this.priv_show (msg, "ПРОДЪЛЖИ", "");
}
...
TaskGrinderClean.prototype.step5 = function()
{
	...
	var msg = "Постави устройството за почистване на мелачката.";
	msg += "<br>Натисни ПРОДЪЛЖИ след като си готов.";	
	this.priv_show (msg, "ПРОДЪЛЖИ", "");	
}
...
TaskGrinderClean.prototype.step6 = function()
{
	...
	var msg = "Презареди почистващото устройство.";
	msg += "<br>Натисни ПРОДЪЛЖИ след като си готов.";
	msg += "<br><br><b>ВНИМАНИЕ:</b>след като избереш ПРОДЪЛЖИ мелачката ще стартира";
	this.priv_show (msg, "ПРОДЪЛЖИ", "");	
}
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("Искаш ли да повториш цикъла на мелачката", "НЕ", "ДА");
}
...
TaskGrinderClean.prototype.step21 = function()
{
	...
	var msg = "Постави бункера за кафе.";
	msg += "<br>Натисни ПРОДЪЛЖИ след като си готов.";
	this.priv_show (msg, "ПРОДЪЛЖИ", "");
}
...
TaskGrinderClean.prototype.step23 = function()
{
	...
	var msg = "Отвори езичето на бункера за кафе.";
	msg += "<br>Натисни ПРОДЪЛЖИ след като си готов.";
	msg += "<br><br><b>ВНИМАНИЕ:</b>след като избереш ПРОДЪЛЖИ мелачката ще стартира";
	this.priv_show (msg, "ПРОДЪЛЖИ", "");	
}
...
TaskGrinderClean.prototype.step26 = function()
{
	...
	var msg = "Постави групата обратно на позиция.";
	msg += "<br>Натисни ПРОДЪЛЖИ след като си готов.";
	this.priv_show (msg, "ПРОДЪЛЖИ", "");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("Искаш ли да направиш кафе", "НЕ", "ДА");
}
...
TaskCalibMilkPump.prototype.priv_handleCalibMilkPump = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_calibMilkPump_setText("Please fill water in the milk tank, put an empty jug in the cup station than press 'CONTINUE'");
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		var btnText = "ИЗХОД";
		pleaseWait_btn2_setText (btnText);
	...
	case 12:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
	    pleaseWait_calibMilkPump_setText("Please wait while water is dispensing"); 
	...
	case 13:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
		pleaseWait_calibMilkPump_setText("Please empty the jug in the cup station than press 'CONTINUE'");
		pleaseWait_btn1_setText("ПРОДЪЛЖИ");
		pleaseWait_btn1_show();
		break;	
	...
	case 20:
		...
		pleaseWait_calibMilkPump_setText("When you're done, please enter the quantity in ml of the LAST dispensing water,<br> max 340ml <br>then press CONTINUE<br><br>"); //Please enter the quantity, then press CONTINUE
...
TaskCleaning.prototype.priv_handleSyrupCleaning = function (timeElapsedMSec)		//#4660
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = " "; break;
				case 1:		msg = "Place an one-liter tank with the correct quantity of detergent under the cup station, Натисни ПРОДЪЛЖИ след като си готов."; break;			//SYRUP_CLEANING_PREPARE_TANK_UNDER_NOZZLES,
				case 2:		msg = "Hot water is flowing from the the nozzle in the tank with cleaning detergent. моля изчакайте…..."; break;
				case 3:		msg = "Remove the tubes from the syrup bottles and place them in the cleaning solution tank, Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 4:		msg = "step 1 - Cleaning solution is flowing from the syrup tube nozzles. моля изчакайте…..."; break;
				case 5:		msg = "step 1 - Please wait for the cleaning solution action…, моля изчакайте…..."; break;
				case 6:		msg = "step 2 - Cleaning solution is flowing from the syrup tube nozzles. моля изчакайте…..."; break;
				case 7:		msg = "step 2 - Please wait for the cleaning solution action…. моля изчакайте…..."; break;
				case 8:		msg = "Place a clean empty tank under the cup station, Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 9:		msg = "Hot water is flowing from the the nozzle in the tank. моля изчакайте…..."; break;
				case 10:	msg = "Place the syrup tubes in the cleaning water tank. Натисни ПРОДЪЛЖИ след като си готов."; break;
				case 11:	msg = "Hot water  is flowing from the syrup tube nozzles."; break;
				case 12:	msg = "Check the syrup tubes. Do you want to repeat the rinsing ?  Press REPEAT to rinse again the tubes.. Натисни ПРОДЪЛЖИ след като си готов."; break;
