		...
		.then( function(result) 
		{
			...
			else
			{
				...
				case 9: //CIC_WAIT_CONF_LIQUID_DETERGENT
					pleaseWait_freeText_setText("adicione detergente ao recipiente do leite e coloque um recipiente por baixo dos bicos e pressione 'START'<br><br><center><img src='img/milkerInduxClean05.jpg'></center>"); //Please fill liquid detergent and push START
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						...
						pleaseWait_btn1_setText ("INICIAR");
					break;
				case 7:		pleaseWait_btn1_setText ("FECHAR"); break;
				case 9:		pleaseWait_btn1_setText ("INICIAR"); break;
				}
				pleaseWait_btn1_show();	
			}
...
TaskCalibMotor.prototype.showPopupCalibrazioneEVPump = function (ev1_5)
{
	...
	pleaseWait_btn1_setText("ABORTA");
	pleaseWait_btn1_show();
}
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Remova o Grupo, e pressione CONTINUAR"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("CONTINUAR");
		pleaseWait_btn1_show();
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("DESINSTALAÇÂO está rodando, espere... ...<br><br><br>Press PROG button to abort"); //DISINTALLATION is running, please wait
		else
	...
	case 40:
		var msgToOutput = "DESINSTALAÇÃO encerrada, favor DESLIGAR a máquina"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
