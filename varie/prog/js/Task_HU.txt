...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_btn1_setText("MEGERŐSÍT");
	pleaseWait_btn1_show();
	pleaseWait_btn2_setText("NEM");
...
TaskCleaning.prototype.priv_handleSanWashingMicro = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 0: pleaseWait_freeText_setText("Főzőtisztítás nem indult el (vagy nem fejeződött be)"); break;	//Brewer Cleaning is not started (or ended)
				case 1: pleaseWait_freeText_setText("Főzőtisztítás elindult"); break; 	//Brewer Cleaning is started
				case 2: pleaseWait_freeText_setText("Főző behelyezve"); break; 	//Brewer placed
				case 3: pleaseWait_freeText_setText("Tegye be a tablettát és nyomja a START gombot"); break; //Put pastille and push START
				case 4: pleaseWait_freeText_setText("Áztatás"); break; //Infusion
				case 5: pleaseWait_freeText_setText("Főzőtiszítási ciklusok 1"); break; // Brewer cleaning cycles 1
				case 6: pleaseWait_freeText_setText("Főzőtiszítási ciklusok 2"); break;	// Brewer cleaning cycles 2
				case 7: pleaseWait_freeText_setText("Főzőtiszítási ciklusok 3"); break;	// Brewer cleaning cycles 3
				case 8: pleaseWait_freeText_setText("Főzőtiszítási ciklusok 4"); break;	// Brewer cleaning cycles 4
				case 9: pleaseWait_freeText_setText("Főzőtiszítási ciklusok 5"); break;	// Brewer cleaning cycles 56
				case 10: pleaseWait_freeText_setText("Főzőtiszítási ciklusok 6"); break;	// HC_STEP_BRW_6
				
				case 11: pleaseWait_freeText_setText("Ismételje a tisztítást?"); break;	//Repeat cleaning ?
				case 12: pleaseWait_freeText_setText("A főző kefével tisztítható pozícióban van, nyomjon &quot;TOVÁBB&quot; gombot ha készen van."); break;	//Brewer placed in brush position, press CONTINUE when finished
				case 13: pleaseWait_freeText_setText("Egy kávé elkészítésének az átugrása"); break; //Skip final coffee or make a coffee
				case 14: pleaseWait_freeText_setText("Kávékészítés"); break; //Coffee delivery
				...
				case 18:	//HC_STEP_MIXER_4
					...
					if (me.isEspresso)
						cleanMixNum++;
					pleaseWait_freeText_setText("Öblítés " +cleanMixNum); //rinsing
					break; 	
			...
			if (me.fase != me.prevFase)
			{
				...
				else
				{
					...
					{
						var btnText = "GOMB " +me.btn1;
						switch (me.fase)
						{
							case 3:  btnText = "START"; break; //HC_STEP_TABLET
							case 11: btnText = "NEM"; break; //HC_STEP_BRW_REPEAT
							case 12: btnText = "TOVÁBB"; break; //HC_STEP_BRW_BRUSH_POSITION
							case 13: btnText = "KÁVÉ KIHAGYÁSA"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
						}
				...
				{
					var btnText = "GOMB " +me.btn2;
					switch (me.fase)
					{
						case 11: btnText = "IGEN"; break;//HC_STEP_BRW_REPEAT
						case 13: btnText = "KÁVÉKÉSZÍTÉS"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
					}
...
TaskCleaning.prototype.priv_handleDescalingMilker = function (timeElapsedMSec)		//#4419
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = ". Nyomja a TOVÁBB gombot, ha kész."; break;
				case 2:		msg = "Vízrendszer ürítése, kérem várjon…"; break;
				case 3:		msg = ". Nyomja a TOVÁBB gombot, ha kész."; break;
				case 4:		msg = "Csatlakoztassa a merülőpumpát a tartályhoz, ami tartalmazza a vizkőtelenítő folyadékot. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 5:		msg = "Vízrendszer feltöltése vízkőoldóval, kérem várjon…"; break;
				case 6:		msg = "Ellenőrizze a vízkőtelenítő folyadék szintjét a levegő tartályban. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 7:		msg = "A vízcsövek vízkőtelenítő folyadékkal töténő feltőltésének indítása, kérem várjon…"; break;
				case 8:		msg = "Kérem várjon, amíg a vízkőtelenítő folyadék kifejti a hatását…"; break;
				case 9:		msg = "Vízkőtelenítő folyadék eltávolításának indítása a kifolyőcsöveken keresztül, kérem várjon…"; break;
				case 10:	msg = "start emptying and rinsing of the hydraulic circuit"; break;
				case 11:	msg = ". Nyomja a TOVÁBB gombot, ha kész."; break;
				case 12:	msg = "Vízrendszer ürítése, kérem várjon…"; break;
				case 13:	msg = ". Nyomja a TOVÁBB gombot, ha kész."; break;
				case 14:	msg = "Cserélje ki a víztartályhoz csatlakoztatott vízforrást. Csatlakoztassa a merülő szivattyút a vizet tartalmazó tartályhoz. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 15:	msg = "Vízrendszer feltöltése vízzel, kérem várjon…"; break;
				case 16:	msg = "Ellenőrizze a vízszintet a levegő tartályban. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 17:	msg = "Víz kifolyása a kifolyócsöveken keresztül."; break;
				case 18:	msg = "Engedjen ki vizet, és ellenőrizze a mintát. Helyezzen egy poharat a minta felfogására.. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 19:	msg = "Minta kitöltésének az indítása a kifolyócsöveken keresztük."; break;
				case 20:	msg = "Ellenőrizze a mintát. Nyomja a TOVÁBB gombot a folytatáshoz, vagy az ISMÉTLÉS gombot, hogy megfelelően ki legyen tisztítva a vízrendszer."; break;
				case 21:	msg = "Vízkőtelenítő folyamat befejeződött, nyomja a BEZÁRÁS gombot.."; break;
			}
...
TaskCleaning.prototype.priv_handleDescalingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = "Nyissa ki a bojler csapját. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 2:		msg = "Vízrendszer ürítése, kérem várjon…"; break;
				case 3:		msg = "Zárja el a bojler csapját. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 4:		msg = "Csatlakoztassa a merülőpumpát a tartályhoz, ami tartalmazza a vizkőtelenítő folyadékot. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 5:		msg = "Vízrendszer feltöltése vízkőoldóval, kérem várjon…"; break;
				case 6:		msg = "Ellenőrizze a vízkőtelenítő folyadék szintjét a levegő tartályban. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 7:		msg = "A vízcsövek vízkőtelenítő folyadékkal töténő feltőltésének indítása, kérem várjon…"; break;
				case 8:		msg = "Kérem várjon, amíg a vízkőtelenítő folyadék kifejti a hatását…"; break;
				case 9:		msg = "Vízkőtelenítő folyadék eltávolításának indítása a kifolyőcsöveken keresztül, kérem várjon…"; break;
				case 10:	msg = "Ellenőrizze a kifolyócsövekből kiürített folyadékot, hogy a vízkőoldó kifejtette-e a megfelelő hatást."; break;
				case 11:	msg = "Nyissa ki a bojler csapját. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 12:	msg = "Vízrendszer ürítése, kérem várjon…"; break;
				case 13:	msg = "Zárja el a bojler csapját. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 14:	msg = "Cserélje ki a víztartályhoz csatlakoztatott vízforrást. Csatlakoztassa a merülő szivattyút a vizet tartalmazó tartályhoz. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 15:	msg = "Vízrendszer feltöltése vízzel, kérem várjon…"; break;
				case 16:	msg = "Ellenőrizze a vízszintet a levegő tartályban. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 17:	msg = "Víz kifolyása a kifolyócsöveken keresztül."; break;
...
TaskCleaning.prototype.priv_handleSanWashingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: msg = ""; break;
				case 0: msg = "Tisztítás aktív"; break;	//Cleaning is active
				case 1: msg = "Helyzze a tablettár a főzőbe és nyomja a TOVÁBB gombot"; break; 	//Put the pastille in the brewer and press CONTINUE
				case 2: msg = "Főző zárása"; break; 	//Brewer is closing
				case 3: msg = "Tabletta oldása 1/2, kérem várjon"; break; 	//Tablet dissolution 1/2, please wait
				case 4: msg = "Második tisztítási ciklus hamarosan indul"; break; 	//2nd dissolution cycle is about to starting
				case 5: msg = "Tabletta oldás 2/2, kérem várjon"; break; 	//Tablet dissolution 1/2, please wait

				case 6: msg = "Első tisztítás, kérem várjon 1/3"; break; 	//1st Cleaning, please wait 1/3
				case 7: msg = "Első tisztítás aktív 1/3"; break; 	//1st Cleaning, active 1/3
				case 8: msg = "Első tisztítás, kérem várjon 2/3"; break; 	//1st Cleaning, please wait 2/3
				case 9: msg = "Első tisztítás aktív 2/3"; break; 	//1st Cleaning, active 2/3
				case 10: msg = "Első tisztítás, kérem várjon 3/3"; break; 	//1st Cleaning, please wait 3/3
				case 11: msg = "Első tisztítás aktív 3/3"; break; 	//1st Cleaning, active 3/3

				case 12: msg = "Akarja ismételni a tisztítást? 1/2"; break; 	//Do you want to repeat clean cycle 1/2 ?
				
				case 13: msg = "Főző nyitott állapotba hozása"; break; 	//Brewer is going into open position
				
				case 14: msg = "Kérem, hogy kézi kefével tisztísa a főzőt, majd nyomja a TOVÁBB gombot"; break; 	//Please, perform a manual brush and then press CONTINUE when finished
				
				case 15: msg = "Második tisztítás, kérem várjon 1/6"; break; 	//2nd Cleaning, please wait 1/6
				case 16: msg = "Második tisztítás aktív 1/6"; break; 	//2nd Cleaning, active 1/6
				case 17: msg = "Második tisztítás, kérem várjon 2/6"; break; 	//2nd Cleaning, please wait 2/6
				case 18: msg = "Második tisztítás aktív 2/6"; break; 	//2nd Cleaning, active 2/6
				case 19: msg = "Második tisztítás, kérem várjon 3/6"; break; 	//2nd Cleaning, please wait 3/6
				case 20: msg = "Második tisztítás aktív 3/6"; break; 	//2nd Cleaning, active 3/6
				case 21: msg = "Második tisztítás, kérem várjon 4/6"; break; 	//2nd Cleaning, please wait 4/6
				case 22: msg = "Második tisztítás aktív 4/6"; break; 	//2nd Cleaning, active 4/6
				case 23: msg = "Második tisztítás, kérem várjon 5/6"; break; 	//2nd Cleaning, please wait 5/6
				case 24: msg = "Második tisztítás aktív 5/6"; break; 	//2nd Cleaning, active 5/6
				case 25: msg = "Második tisztítás, kérem várjon 6/6"; break; 	//2nd Cleaning, please wait 6/6
				case 26: msg = "Második tisztítás aktív 6/6"; break; 	//2nd Cleaning, active 6/6
				
				case 27: msg = "Akarja ismételni a tisztítást? 2/2"; break; 	//Do you want to repeat clean cycle 2/2 ?
				
				case 28: msg = "Át akarja lépni az 1 db kávé készítést?"; break; //Do you want to skip the final coffee ?
				case 29: msg = "Kávékészítés, kérem várjon"; break; //Coffee delivery, please wait

				case 30: msg = "Főző öblítés"; break; //Brewer Rinsing 
				case 31: msg = "Mixer 1 öblítés"; break; //Mixer 1 Rinsing
				case 32: msg = "Mixer 2 öblítés"; break; //Mixer 2 Rinsing
				case 33: msg = "Mixer 3 öblítés"; break; //Mixer 3 Rinsing 
				case 34: msg = "Főzőtisztítás elvégezve. Nyomja a BEZÁRÁS gombot!"; break; //Brewer Cleaning Done. Press CLOSE to exit
				case 35: msg = "Kíván egy AUTOMATIKUS vagy MANUÁLIS mosást végezni?"; break; //Do you want to perform MANUAL or AUTOMATIC washing?
			}
			...
			if ( (me.fase != me.prevFase) || ( me.fase == me.prevFase && (me.btn1 != me.prevFaseBtn1 || me.btn2 != me.prevFaseBtn2) ))
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							case 1:  btnText = "TOVÁBB"; break;
							case 12: btnText = "NEM"; break; //Do you want to repeat clean cycle 1/2 ?
							case 14:  btnText = "TOVÁBB"; break;
							case 27: btnText = "NEM"; break; //Do you want to repeat clean cycle 2/2 ?
							case 28: btnText = "KÁVÉ KIHAGYÁSA"; break; //Do you want to skip the final coffee ?
							case 34: btnText = "BEZÁRNI"; break; //Do you want to skip the final coffee ?
							case 35: btnText = "AUTOMATA"; break;
				...
				else
				{
					...
					switch (me.fase)
					{
						case 12: btnText = "IGEN"; break; //Do you want to repeat clean cycle 1/2 ?
						case 27: btnText = "IGEN"; break; //Do you want to repeat clean cycle 2/2 ?
						case 28: btnText = "KÁVÉKÉSZÍTÉS"; break; //Do you want to skip the final coffee ?
						case 35: btnText = "KÉZI"; break;
					}
					pleaseWait_btn2_setText (btnText);
					pleaseWait_btn2_show();	
				}
...
TaskCleaning.prototype.priv_handleMilkWashingVenturi = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 1: pleaseWait_freeText_setText("Tejmodul tisztítás elundult"); break;	//Milker Cleaning is started
				case 2: pleaseWait_freeText_setText("Tisztítófolyadék melegítése"); break;	//Warming for cleaner
				case 3: pleaseWait_freeText_setText("Várjon a visszaigazolásig"); break;	//Wait for confirm
				case 4: pleaseWait_freeText_setText("Tisztítóciklusok végzése (12)"); break;	//Doing cleaner cycles (12)
				case 5: pleaseWait_freeText_setText("Vízmelegítés"); break;	//Warming for water
				case 6: pleaseWait_freeText_setText("Várjon a második megerősítésre"); break;	//Wait for second confirm
				case 7: pleaseWait_freeText_setText("Tisztítóciklusok végzése (12)"); break;	//Doing cleaner cycles (12)
				default: pleaseWait_freeText_setText(""); break;
			}
			pleaseWait_freeText_show();
			...
			else
			{
				switch (me.fase)
				{
					default: pleaseWait_btn1_setText ("GOMB " +me.btn2); break;
					case 2:  pleaseWait_btn1_setText ("START"); break;
					case 3:
					case 5:  pleaseWait_btn1_setText ("TOVÁBB"); break;
					case 6:  pleaseWait_btn1_setText ("MEGERŐSÍT"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			{
				pleaseWait_btn2_setText ("GOMB " +me.btn2);
				pleaseWait_btn2_show();	
			}			
		})
		.catch( function(result)
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "Tisztítás előtt ellenőrizze:<ol><li>van e megfelelő vízellátás,</li><li>szennyvíz tartály üres</li><li>a tejfelszívó cső a tisztítószeres edényben van</li><li>a mosószer be van töltve az edénybe</li></ol>");
			...
			else
			{
				...
				case 2:	//CIC_STEP_FILL_WATER
					...
					pleaseWait_freeText_setText("Víz újratöltés, kérem várjon!<br>víz vezetőképesség: {0} uS".translateLang(cond_uS)); //Water refilling in progress, please wait.<br>Water conducibility: {0} uS
					break;

				case 3:	//CIC_WAIT_FOR_TABLET_DISSOLVING
					var timeSec = parseInt(obj.buffer8[0]);
					pleaseWait_freeText_setText("Tisztítás folyamatban: -{0}".translateLang(timeSec)); //Rinsing -{0}
					break;
				...
				case 5:	//CIC_cleaning_PHASE2
					...
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Tisztítás {0} az {1}-ből folyamatban, kérem, hogy várjon!<br>Víz vezetőképesség: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Rinsing {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 6: //CIC_RINSING_PHASE3
					...
					var ciclo_di = parseInt(obj.buffer8[3]);
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Öblítés {0} az {1}-ből folyamatban, kérem, hogy várjon!<br>Víz vezetőképesség: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Cleaning {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					...
					pleaseWait_freeText_setText("Tisztítási folyamat vége.<br><br>Kezdeti vezetőképesség {0} Végső vezetőképesség {1}<br><br>Kérem, hogy ne felejtse el:<ul><li>kiüríteni a szennyvíz tartályt</li><li>és a tej csövet visszahelyezni a tejtartályba</li></ul><br>Press <br>BEZÁR gombra kattintson, hogy bezárja ezt az ablakot és ellenőrizze a tej jelenlétét<br> BEZÁR NINCS TEJES TERMÉK, ha nem akarja a tejes termékek kiválaszthatóságát.".translateLang(cond_uS_init_rif,cond_uS_finale)); //The cleaning procedure is finished.<br><Initial conducibility {0} and current conducibility {1},><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;

				case 9: //CIC_WAIT_CONF_LIQUID_DETERGENT
					pleaseWait_freeText_setText("Adjon tisztítószert a tejtartályhoz, és helyezzen egy edényt a kifolyócsövek alá és nyomja a  'INDUL' gombot<br><br><center><img src='img/milkerInduxClean05.jpg'></center>"); //Please fill liquid detergent and push START
					break;
					
				case 97: //CIC_TOO_MUCH_DETERGENTE
					pleaseWait_freeText_setText("FIGYELMEZTETÉS: Túl sok mosószer!");
					break;
				
				case 98: //CIC_DET_TOO_LOW
					pleaseWait_freeText_setText("FIGYELMEZTETÉS: kevés mosószer érzékelve<br>új tisztítás tanácsos");
					break;

				case 99: //CIC_DET_TOO_AGGRESSIVE
					pleaseWait_freeText_setText("FIGYELMEZTETÉS: Túl agresszív mosószer!");
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						pleaseWait_btn1_setText ("TOVÁBB");
					else
						pleaseWait_btn1_setText ("START");
					break;
				case 7:		pleaseWait_btn1_setText ("BEZÁRNI"); break;
			...
			else
			{
				...
				case 1:	 pleaseWait_btn2_setText ("MEGSZAKÍT"); break;
				case 7:	 pleaseWait_btn2_setText ("TEJKIVÁLASZTÁS BEZÁRÁSA"); break;
				}
				pleaseWait_btn2_show();	
			}	
...
TaskCalibMotor.prototype.showPopupCalibrazioneEVPump = function (ev1_5)
{
	...
	pleaseWait_btn1_setText("MEGSZAKÍT");
	pleaseWait_btn1_show();
}
...
console.log ("TaskCalibMotor::fase[" +me.fase +"]");
	...
	case 0:
		...
		pleaseWait_calibration_setText("Kérem várjon, amíg a motor működik"); //Please wait while motor is running
	...
	case 20:
		...
		pleaseWait_calibration_setText("Ha készen van, akkor adja meg az utolsó darálás mennyiségét grammban, és nyomja a tovább gombot"); //Please enter the quantity, then press CONTINUE
	...
	case 40:
		...
		{
			pleaseWait_calibration_setText("Érvénytelen érték");
			me.fase = 20;
			break;
		}
	
		pleaseWait_calibration_setText("Érték tárolása ...");
		me.value = pleaseWait_calibration_num_getValue();
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Kérem, hogy távolítsa el a főzőt és nyomja a tovább gombot"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("MEGSZAKÍT");
		pleaseWait_btn2_show();	
...
//console.log ("TaskCalibMotor.priv_handleCalibMacina() => runMotor, m="  +me.motor);
	...
	case 25:	//qui ci andiamo se siamo in fase 21 e l'utente preme il btn SET per impostare una nuova apertura del VGrind
		pleaseWait_calibration_setText("Kérem várjon amíg a Varigrind eléri a pozíciót"); //Please wait while the varigrind is adjusting its position
	...
	case 28:
		if (da3.isGruppoVariflex())
		{
			rhea.ajax ("getPosMacina", {"m":(me.motor-10)}).then( function(result)
			{
				var obj = JSON.parse(result);
				rheaSetDivHTMLByName("pagePleaseWait_calibration_1_vg", obj.v);
				pleaseWait_calibration_setText("Kérem várjon amíg a Varigrind eléri a pozíciót" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position  [current pos]
			})
			.catch( function(result)
			{
			});	
...
//console.log	("TaskCalibMotor.priv_handleCalibMacina: setFattoreCalib m=" +me.motor +",v=" +me.gsec);		
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Helyezze vissza a főzőt és nyomja a tovább gombot"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_show();
		me.fase = 41;
		break;
	...
	case 60: //gruppo è stato ricollegato, procedo con il calcolo impulsi se richiesto
		...
		else
		{
			me.fase = 65;
			pleaseWait_calibration_show();
			pleaseWait_calibration_setText("Kérem várjon impulzus számlálás folyamatban"); //Impulse calculation in progress, please wait
...
TaskTestSelezione.prototype.priv_handleTestMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Kérem, hogy távolítsa el a főzőt és nyomja a tovább gombot"); //Please remove the brewer, then press CONTINUE
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("MEGSZAKÍT");
		pleaseWait_btn2_show();
	...
	case 10:  //ok, il gruppo è scollegato, chiedo a CPU di attivare la macina
		me.fase = 11;
		pleaseWait_calibration_setText ("Daráló működésben"); //Grinder is running
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("Helyezze vissza a főzőt és nyomja a tovább gombot, vagy daráltasson újra"); //Place the brewer into position then press CONTINUE, or press REPEAT to grind again
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ISMÉTLÉS");
		pleaseWait_btn2_show();		
		me.fase = 41;
		break;
...
TaskDevices.prototype.priv_handleSnackProg = function(timeNowMsec)
{
	...
	case 0:
		this.fase = 10;
		pleaseWait_rotella_hide();
		pleaseWait_btn1_setText("BROGRAMBÓL KILÉPÉS");
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleRichiestaPosizioneMacina = function()
{
	...
	rhea.ajax ("getCupSensorLiveValue", "" ).then( function(result)
	{
		...
		default: rheaSetDivHTMLByName("divCupSensorLiveValueBrewmatic", "POHÁR NEM ÉRZÉKELHETŐ"); break;
		}
		
		//nel caso di sensore Wenglor
		switch (parseInt(result))
		{
		default: rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "POHÁR NEM ÉRZÉKELHETŐ"); break;
		case 1:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "KIS POHÁR (le)"); break;
		case 2:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "KIS POHÁR (fel)"); break;
		case 3:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "NAGY POHÁR"); break;
		}		
	})
	.catch( function(result)
	{
...
TaskDevices.prototype.priv_handleRegolazionePosizioneMacina = function()
{
	switch (this.fase)
	{
		case 0: 
			...
			pleaseWait_freeText_setText("Kérem várjon amíg a Varigrind eléri a pozíciót"); //Please wait while the varigrind is adjusting its position
			pleaseWait_freeText_show();
...
TaskDevices.prototype.priv_queryMacina = function(macina_1o2)
{
	...
	rhea.ajax ("getPosMacina", {"m":macina_1o2}).then( function(result)
	{
		...
		pleaseWait_freeText_setText("Kérem várjon amíg a Varigrind eléri a pozíciót" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position [current_value]
	})
	.catch( function(result)
	{
	});			
...
TaskDevices.prototype.priv_handleTestAssorbGruppo = function(timeNowMsec)
{
	...
	{
	case 0:
		pleaseWait_freeText_setText ("Teszt indul...");
		pleaseWait_freeText_show();
		pleaseWait_rotella_show();
		me.fase = 1;
		me.test_fase = 0;
	...
	case 10:
		...
		pleaseWait_freeText_setText ("Teszt folyamatban, kérem, hogy várjon...<br>Aktuális állapot: " +me.test_fase +"/5");
		me.fase = 11;
		break;
	...
	case 11:
		...
		rhea.ajax ("getStatTestAssGrp", "" ).then( function(result)
		{
			...
			{
				//errore
				pleaseWait_freeText_setText ("Teszt befejezve.<br>Result: FAILED<br><br>");
				pleaseWait_btn1_setText("BEZÁRNI");
				pleaseWait_btn1_show();	
				pleaseWait_btn2_setText("ISMÉTLÉS");
				pleaseWait_btn2_show();	
				me.fase = 80;
			...
			else
			{
				...
				else
				{
					...
					var html = "<table class='dataAudit'>"
								...
								+"</table>";
					pleaseWait_freeText_setText ("Teszt befejezve.<br>Results:<br><br>" +html);		
					pleaseWait_btn1_setText("BEZÁRNI");
					pleaseWait_btn1_show();	
					pleaseWait_btn2_setText("ISMÉTLÉS");
					pleaseWait_btn2_show();	
...
TaskDevices.prototype.priv_handleTestAssorbMotoriduttore = function(timeNowMsec)
{
	...
	case 0: //prego rimuovere il gruppo
		me.fase = 1;
		pleaseWait_show();
		pleaseWait_freeText_setText ("Kérem, hogy távolítsa el a főzőt és nyomja a tovább gombot");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("MEGSZAKÍT");
	...
	case 20:
		//ho ricevuto l'OK dal comando start Test. Da ora in poi, pollo lo stato del test fino a che non finisce
		pleaseWait_freeText_setText ("Teszt folyamatban, kérem, hogy várjon...<br>Aktuális állapot: " +me.test_fase +"/4");
		me.fase = 21;
		break;
	...
	case 85: //prego rimettere a posto il gruppo
		pleaseWait_freeText_setText("Helyezze vissza a főzőt és nyomja a tovább gombot"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		pleaseWait_rotella_show();
		me.fase = 86;
...
TaskDevices.prototype.priv_handleGrinderSpeedTest = function(timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>DARÁLÓ SEBESSÉG AZ OFF09 HIBÁHOZ</b><br><br>Kérem, hogy távolítsa el a főzőt és nyomja a tovább gombot"); //Please remove the brewer, then press CONTINUE
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("MEGSZAKÍT");
	...
	case 5: //step 1
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>DARÁLÓ SEBESSÉG AZ OFF09 HIBÁHOZ</b><br><br>1. LÉPÉS<br>Kérem, hogy, <b>zárja el a kávéreteszt</b> (narancs fogantyú) és nyomja a  TOVÁBB gombot. A daráló kb. 10 másodpercig fog futni, hogy kiürítse önmagát.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("MEGSZAKÍT");
	...
	case 20:
		me.fase = 21;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>DARÁLÓ SEBESSÉG AZ OFF09 HIBÁHOZ</b><br><br>2. LÉPÉS<br>Most, hogy a daráló üres, tesztelhetjük az üres daráló érzékelő szenzort. Nyomjon TOVÁBB gombot a folytatáshoz. A daráló kb 10 másodpercig fog működni.");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("MEGSZAKÍT");
	...
	case 40:
		me.fase = 41;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>DARÁLÓ SEBESSÉG AZ OFF09 HIBÁHOZ</b><br><br>3. LÉPÉS<br>Most <b>Nyissa ki a kávéreteszt</b> (narancs fogantyú) és nyomja a TOVÁBB gombot. A daráló kb 10 másodpercig fog működni.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("MEGSZAKÍT");
	...
	case 60:
		me.fase = 61;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>DARÁLÓ SEBESSÉG AZ OFF09 HIBÁHOZ</b><br><br>EREDMÉNY:<br>Átlagos sebesség, amikor a daráló üres: <b>" +me.speed1 +"</b><br>Átlagos sebesség, amikor a radáló nem üres: <b>" +me.speed2 +"</b><br>");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("BEZÁRNI");
		pleaseWait_btn1_show();
		break;
	...
	case 70: //chiedo di rimettere a posto il gruppo
		...
		else
		{
			me.fase = 71;
			pleaseWait_rotella_hide();
			pleaseWait_freeText_setText("<b>DARÁLÓ SEBESSÉG AZ OFF09 HIBÁHOZ</b><br><br>Helyezze vissza a főzőt és nyomja a tovább gombot"); //Place the brewer into position, then press CONTINUE
			pleaseWait_freeText_show();
			pleaseWait_btn1_setText("TOVÁBB");
			pleaseWait_btn1_show();
		}
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_freeText_show();
		pleaseWait_freeText_setText("LESZERELÉS<br><br>Csepptálca üres?"); //DISINTALLATION<br><br>Is driptray empty?
		pleaseWait_btn1_setText("IGEN-FOLYTATÁS");
		pleaseWait_btn2_setText("MEGSZAKÍT");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 10:
		this.fase = 11;
		pleaseWait_freeText_setText("LESZERELÉS<br><br>Kérem, hogy távolítsa el a kávézaccot, és nyomja a TOVÁBB gombot"); //DISINTALLATION<br><br>Please remove coffee grounds, then press CONTINUE
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn2_setText("MEGSZAKÍT");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
	...
	case 20:
		this.fase = 21;
		pleaseWait_freeText_setText("LESZERELÉS<br><br>Nyomja a LESZERELÉS INDÍTÁSA gombot, vagy MEGSZAKÍTÁS gombot a folyamat leállításához"); //DISINTALLATION<br><br>Press START DISINSTALLATION to continue, ABORT to cancel the operation
		pleaseWait_btn1_setText("LESZERELÉS INDÍTÁSA");
		pleaseWait_btn2_setText("MEGSZAKÍT");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("LESZERELÉS folyamatban, kérem várjon ...<br><br><br>Press PROG button to abort"); //DISINTALLATION is running, please wait
		else
			pleaseWait_freeText_setText("LESZERELÉS folyamatban, kérem várjon ..."); //DISINTALLATION is running, please wait
	...
	case 40:
		var msgToOutput = "LESZERELÉS befejeződött, ÁLLÍTSA LE a gépet"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "LESZERELÉS befejeződött, zárja el a bojler csapját és ÁLLÍTSA LE a gépet"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
	...
	case 51:
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("LESZERELÉS<br><br>Nyissa ki a bojler csapját és nyomja a TOVÁBB gombot ...<br><br><br>Press PROG button to abort"); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
		else
			pleaseWait_freeText_setText("LESZERELÉS<br><br>Nyissa ki a bojler csapját és nyomja a TOVÁBB gombot ..."); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
...
TaskDataAudit.prototype.onTimer = function (timeNowMsec)
{
	...
	switch (this.fase)
	{
		...
		case 10: //eva dts scaricato
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			me.fase = 20;
			pleaseWait_freeText_appendText ("<br>KÉSZ. Adatfeldolgozás, kérem várjon<br>"); //Done, processing data, please wait
			break;
		...
		case 200: //errore downloading eva-dts
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			pleaseWait_freeText_appendText("Hiba az EVA-DTS letöltésnél. Próbálja újra"); //Error downloading EVA-DTS. Please try again later
			me.fase = 201;
			break;
...
TaskGrinderClean.prototype.onEvent_cpuStatus  	= function(statusID, statusStr, flag16)		{ this.cpuStatus = statusID; pleaseWait_header_setTextL ("DARÁLÓ TISZTÍTÁS"); }
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	...
	var msg = "Daráló ciklus  {0} az {1}-ből".translateLang(this.curCiclo,this.numCicli);
	msg += "<br><br><b>Fogja fel a terméket</b>";
	this.priv_show (msg, "", "");	
...
TaskGrinderClean.prototype.runGrinderCycle_3 = function(timeNowMsec)
{
	...
	var msg = "Daráló ciklus  {0} az {1}-ből".translateLang(this.curCiclo-1,this.numCicli);
	msg += "<br>" +"Várakozás {0} mp.".translateLang(timeLeftSec);
	this.priv_show (msg, "", "");	
	if (timeLeftMSec <= 0)
		this.runGrinderCycle_1();
}
...
//console.log ("fase="+this.fase);	
	...
	{
		pleaseWait_freeText_setText ("<b>DARÁLÓ TISZTÍTÁS</b><br><br>" + text);
		pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step1 = function()
{
	...
	this.priv_show ("&nbsp;", "TOVÁBB", "MEGSZAKÍT");
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	var msg = "Zárja el a kávéreteszt a kávétartályon, hogy a kávészem kihullást megakadályozza..";
	msg += "<br>Nyomja a TOVÁBB gombot, ha kész.";
	this.priv_show (msg, "TOVÁBB", "");
}
...
TaskGrinderClean.prototype.step3 = function()
{
	...
	var msg = "Távolítsa el a főzőt és a kávétartályt.";
	msg += "<br>Nyomja a TOVÁBB gombot, ha kész.";
	this.priv_show (msg, "TOVÁBB", "");
}
...
TaskGrinderClean.prototype.step5 = function()
{
	...
	var msg = "Üzemelje be a daráló tisztító eszközt.";
	msg += "<br>Nyomja a TOVÁBB gombot, ha kész.";	
	this.priv_show (msg, "TOVÁBB", "");	
}
...
TaskGrinderClean.prototype.step6 = function()
{
	...
	var msg = "Töltse újra a tisztító eszközt.";
	msg += "<br>Nyomja a TOVÁBB gombot, ha kész.";
	msg += "<br><br><b>FIGYELMEZTETÉS:</b> amint megnyomja a TOVÁBB gombot, a daráló beindul!";
	this.priv_show (msg, "TOVÁBB", "");	
}
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("Szeretné ismételni a darálási ciklust?", "NEM", "IGEN");
}
...
TaskGrinderClean.prototype.step21 = function()
{
	...
	var msg = "Tegye vissz a kávétartályt.";
	msg += "<br>Nyomja a TOVÁBB gombot, ha kész.";
	this.priv_show (msg, "TOVÁBB", "");
}
...
TaskGrinderClean.prototype.step23 = function()
{
	...
	var msg = "Nyissa ki a kávétartály reteszt.";
	msg += "<br>Nyomja a TOVÁBB gombot, ha kész.";
	msg += "<br><br><b>FIGYELMEZTETÉS:</b> amint megnyomja a TOVÁBB gombot, a daráló beindul!";
	this.priv_show (msg, "TOVÁBB", "");	
}
...
TaskGrinderClean.prototype.step26 = function()
{
	...
	var msg = "Helyezze vissza a főzőt a helyére.";
	msg += "<br>Nyomja a TOVÁBB gombot, ha kész.";
	this.priv_show (msg, "TOVÁBB", "");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("Szeretne egy kávét lefőzni?", "NEM", "IGEN");
}
...
TaskCalibMilkPump.prototype.priv_handleCalibMilkPump = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_calibMilkPump_setText("Kérem, hogy töltsön vizet a tejtartályba, és helyezzen egy edényt a kifolyócsövek alá és nyomja a  'TOVÁBB' gombot");
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		var btnText = "KILÉPÉS";
		pleaseWait_btn2_setText (btnText);
	...
	case 12:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
	    pleaseWait_calibMilkPump_setText("Kérem várja meg, amíg a víz feltöltődik"); 
	...
	case 13:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
		pleaseWait_calibMilkPump_setText("Kérem, hogy ürítse ki a kifolyócsövek alatti edényt és nyomja a  'TOVÁBB' gombot");
		pleaseWait_btn1_setText("TOVÁBB");
		pleaseWait_btn1_show();
		break;	
	...
	case 20:
		...
		pleaseWait_calibMilkPump_setText("Ha készen van, akkor táplálja be ml-ben az UTOLSÓ kiadagolt víz mennyiségét,<br> max 340ml <br>majd nyomja a  TOVÁBB gombot<br><br>"); //Please enter the quantity, then press CONTINUE
...
TaskCleaning.prototype.priv_handleSyrupCleaning = function (timeElapsedMSec)		//#4660
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = " "; break;
				case 1:		msg = "Place an one-liter tank with the correct quantity of detergent under the cup station, Nyomja a TOVÁBB gombot, ha kész."; break;			//SYRUP_CLEANING_PREPARE_TANK_UNDER_NOZZLES,
				case 2:		msg = "Hot water is flowing from the the nozzle in the tank with cleaning detergent. kérem várjon…..."; break;
				case 3:		msg = "Remove the tubes from the syrup bottles and place them in the cleaning solution tank, Nyomja a TOVÁBB gombot, ha kész."; break;
				case 4:		msg = "step 1 - Cleaning solution is flowing from the syrup tube nozzles. kérem várjon…..."; break;
				case 5:		msg = "step 1 - Please wait for the cleaning solution action…, kérem várjon…..."; break;
				case 6:		msg = "step 2 - Cleaning solution is flowing from the syrup tube nozzles. kérem várjon…..."; break;
				case 7:		msg = "step 2 - Please wait for the cleaning solution action…. kérem várjon…..."; break;
				case 8:		msg = "Place a clean empty tank under the cup station, Nyomja a TOVÁBB gombot, ha kész."; break;
				case 9:		msg = "Hot water is flowing from the the nozzle in the tank. kérem várjon…..."; break;
				case 10:	msg = "Place the syrup tubes in the cleaning water tank. Nyomja a TOVÁBB gombot, ha kész."; break;
				case 11:	msg = "Hot water  is flowing from the syrup tube nozzles."; break;
				case 12:	msg = "Check the syrup tubes. Do you want to repeat the rinsing ?  Press REPEAT to rinse again the tubes.. Nyomja a TOVÁBB gombot, ha kész."; break;
