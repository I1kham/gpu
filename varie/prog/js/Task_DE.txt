...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_freeText_setText("Warning, the first coffee cycle setting only works with the lower piston kit (with side slots) and cake bin (with hole at bottom) of which can release flushing water into the drip tray properly, could you please confirm these components have been installed??");
	pleaseWait_freeText_show();
	pleaseWait_btn1_setText("BESTAETIGEN");
	pleaseWait_btn1_show();
	pleaseWait_btn2_setText("NEIN");
...
TaskCleaning.prototype.priv_handleSanWashingMicro = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 0: pleaseWait_freeText_setText("BRUEHERREINIGUNG WIRD NICHT GESTARTET (ODER BEENDET)"); break;	//Brewer Cleaning is not started (or ended)
				case 1: pleaseWait_freeText_setText("BRUEHERREINIGUNG WIRD GESTARTET"); break; 	//Brewer Cleaning is started
				case 2: pleaseWait_freeText_setText("BRUEHER EINGESTZT"); break; 	//Brewer placed
				case 3: pleaseWait_freeText_setText("LEGEN SIE TABLETTE EIN UND DRUECKEN SIE START"); break; //Put pastille and push START
				case 4: pleaseWait_freeText_setText("INFUSION"); break; //Infusion
				case 5: pleaseWait_freeText_setText("BRUEHERREINIGUNGS-ZYKLUS 1"); break; // Brewer cleaning cycles 1
				case 6: pleaseWait_freeText_setText("BRUEHERREINIGUNGS-ZYKLUS 2"); break;	// Brewer cleaning cycles 2
				case 7: pleaseWait_freeText_setText("BRUEHERREINIGUNGS-ZYKLUS 3"); break;	// Brewer cleaning cycles 3
				case 8: pleaseWait_freeText_setText("BRUEHERREINIGUNGS-ZYKLUS 4"); break;	// Brewer cleaning cycles 4
				case 9: pleaseWait_freeText_setText("BRUEHERREINIGUNGS-ZYKLUS 5"); break;	// Brewer cleaning cycles 56
				case 10: pleaseWait_freeText_setText("BRUEHERREINIGUNGS-ZYKLUS 6"); break;	// HC_STEP_BRW_6
				
				case 11: pleaseWait_freeText_setText("REINIGUNG WIEDERHOLEN?"); break;	//Repeat cleaning ?
				case 12: pleaseWait_freeText_setText("BRUEHER IN REINIGUNGSPOSITION, DANACH WEITER DRUECKEN"); break;	//Brewer placed in brush position, press CONTINUE when finished
				case 13: pleaseWait_freeText_setText("KAFFEE-DANACH UEBERSPRINGEN ODER KAFFEE DANACH AKTIV"); break; //Skip final coffee or make a coffee
				case 14: pleaseWait_freeText_setText("KAFFEE WIRD ZUBEREITET"); break; //Coffee delivery
				...
				case 18:	//HC_STEP_MIXER_4
					...
					if (me.isEspresso)
						cleanMixNum++;
					pleaseWait_freeText_setText("SPUELEN " +cleanMixNum); //rinsing
					break; 	
			...
			if (me.fase != me.prevFase)
			{
				...
				else
				{
					...
					{
						var btnText = "TASTE " +me.btn1;
						switch (me.fase)
						{
							case 3:  btnText = "START"; break; //HC_STEP_TABLET
							case 11: btnText = "NEIN"; break; //HC_STEP_BRW_REPEAT
							case 12: btnText = "WEITER"; break; //HC_STEP_BRW_BRUSH_POSITION
							case 13: btnText = "KAFFEE UEBERSPRINGEN"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
						}
				...
				{
					var btnText = "TASTE " +me.btn2;
					switch (me.fase)
					{
						case 11: btnText = "JA"; break;//HC_STEP_BRW_REPEAT
						case 13: btnText = "KAFFEE BEZIEHEN"; break; //HC_STEP_BRW_SKIP_FINAL_COFFEE
					}
...
TaskCleaning.prototype.priv_handleDescalingMilker = function (timeElapsedMSec)		//#4419
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = ". Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 2:		msg = "Entleerung des Hydraulikkreislaufs, Bitte warten…"; break;
				case 3:		msg = ". Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 4:		msg = "Befestigen Sie die Tauchpumpe am Tank mit dem Entkalker. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 5:		msg = "Füllen des Hydraulikkreislaufs mit Entkalkungsmittel, Bitte warten…"; break;
				case 6:		msg = "Ueberpruefen Sie den Fuellstand des Entkalkungsmittels im Ausgleichsbehaelter. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 7:		msg = "Beginnen Sie damit, die Hydraulikschlaeuche mit Entkalkungsmittel zu fuellen, Bitte warten…"; break;
				case 8:		msg = "Bitte warten Sie auf die Wirkung der Entkalkungsfluessigkeit..."; break;
				case 9:		msg = "Entkalkungsfluessigkeit beginnt durch die Duesen auszulaufen, Bitte warten…"; break;
				case 10:	msg = "start emptying and rinsing of the hydraulic circuit"; break;
				case 11:	msg = ". Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 12:	msg = "Entleerung des Hydraulikkreislaufs, Bitte warten…"; break;
				case 13:	msg = ". Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 14:	msg = "Versorgungsquelle auf Wassertank umstellen. Befestigen Sie die Tauchpumpe am Tank mit Wasser. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 15:	msg = "Der Hydraulikkreislauf wird mit Wasser gefuellt, Bitte warten…"; break;
				case 16:	msg = "Ueberpruefen Sie den Wasserstand im Lufttank. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 17:	msg = "Wasser floss durch Ausgabeduesen."; break;
				case 18:	msg = "Geben Sie Wasser ab und testen Sie die Probe. Stellen Sie einen Becher auf, um die Probe aufzufangen. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 19:	msg = "Beginnen Sie mit dem Ablassen der Probe durch jede Düse."; break;
				case 20:	msg = "Ueberpruefen Sie die gesammelte Probe. Druecken Sie die WEITER-Taste, um fortzufahren, oder WIEDERHOLEN, um die vorherigen Schritte zu wiederholen und den Hydraulikkreislauf ordnungsgemaeß zu reinigen."; break;
				case 21:	msg = "Der Entkalkungsvorgang ist abgeschlossen. Zum Beenden druecken Sie SCHLIEßEN."; break;
			}
...
TaskCleaning.prototype.priv_handleDescalingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = "???"; break;
				case 1:		msg = "Boilerablauf oeffnen. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 2:		msg = "Entleerung des Hydraulikkreislaufs, Bitte warten…"; break;
				case 3:		msg = "Boilerablauf schließen. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 4:		msg = "Befestigen Sie die Tauchpumpe am Tank mit dem Entkalker. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 5:		msg = "Füllen des Hydraulikkreislaufs mit Entkalkungsmittel, Bitte warten…"; break;
				case 6:		msg = "Ueberpruefen Sie den Fuellstand des Entkalkungsmittels im Ausgleichsbehaelter. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 7:		msg = "Beginnen Sie damit, die Hydraulikschlaeuche mit Entkalkungsmittel zu fuellen, Bitte warten…"; break;
				case 8:		msg = "Bitte warten Sie auf die Wirkung der Entkalkungsfluessigkeit..."; break;
				case 9:		msg = "Entkalkungsfluessigkeit beginnt durch die Duesen auszulaufen, Bitte warten…"; break;
				case 10:	msg = "Ueberpruefen Sie die aus den Duesen austretende Fluessigkeit, um festzustellen, ob der Entkalkungsvorgang erfolgreich abgeschlossen wurde."; break;
				case 11:	msg = "Boilerablauf oeffnen. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 12:	msg = "Entleerung des Hydraulikkreislaufs, Bitte warten…"; break;
				case 13:	msg = "Boilerablauf schließen. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 14:	msg = "Versorgungsquelle auf Wassertank umstellen. Befestigen Sie die Tauchpumpe am Tank mit Wasser. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 15:	msg = "Der Hydraulikkreislauf wird mit Wasser gefuellt, Bitte warten…"; break;
				case 16:	msg = "Ueberpruefen Sie den Wasserstand im Lufttank. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 17:	msg = "Wasser floss durch Ausgabeduesen."; break;
...
TaskCleaning.prototype.priv_handleSanWashingVFlex = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: msg = ""; break;
				case 0: msg = "REINIGUNG IST AKTIV"; break;	//Cleaning is active
				case 1: msg = "LEGEN SIE DIE TABLETTE IN DEN BRUEHER UND DRUECKEN SIE WEITER"; break; 	//Put the pastille in the brewer and press CONTINUE
				case 2: msg = "BRUEHER SCHLIESST"; break; 	//Brewer is closing
				case 3: msg = "TABLETTENAUFLOESUNG 1/2 - BITTE WARTEN"; break; 	//Tablet dissolution 1/2, please wait
				case 4: msg = "2. AUFLOESUNGSZYKLUS - BEGINNT GLEICH"; break; 	//2nd dissolution cycle is about to starting
				case 5: msg = "TABLETTENAUFLOESUNG 2/2 - BITTE WARTEN"; break; 	//Tablet dissolution 1/2, please wait

				case 6: msg = "1. REINIGUNG - BITTE WARTEN 1/3"; break; 	//1st Cleaning, please wait 1/3
				case 7: msg = "1. REINIGUNG - AKTIV 1/3"; break; 	//1st Cleaning, active 1/3
				case 8: msg = "1. REINIGUNG - BITTE WARTEN 2/3"; break; 	//1st Cleaning, please wait 2/3
				case 9: msg = "1. REINIGUNG - AKTIV 2/3"; break; 	//1st Cleaning, active 2/3
				case 10: msg = "1. REINIGUNG - BITTE WARTEN 3/3"; break; 	//1st Cleaning, please wait 3/3
				case 11: msg = "1. REINIGUNG - AKTIV 3/3"; break; 	//1st Cleaning, active 3/3

				case 12: msg = "REINIGUNGSZYKLUS 1/2 WIEDERHOLEN?"; break; 	//Do you want to repeat clean cycle 1/2 ?
				
				case 13: msg = "BRUEHERBEWEGUNG IN OFFENE POSITION"; break; 	//Brewer is going into open position
				
				case 14: msg = "MIT BUERSTE MANUELL REINIGEN - MIT WEITER BESTAETIGEN"; break; 	//Please, perform a manual brush and then press CONTINUE when finished
				
				case 15: msg = "2. REINIGUNG - BITTE WARTEN 1/6"; break; 	//2nd Cleaning, please wait 1/6
				case 16: msg = "2. REINIGUNG - 1/6 AKTIV"; break; 	//2nd Cleaning, active 1/6
				case 17: msg = "2. REINIGUNG - BITTE WARTEN 2/6"; break; 	//2nd Cleaning, please wait 2/6
				case 18: msg = "2. REINIGUNG -  2/6 AKTIV"; break; 	//2nd Cleaning, active 2/6
				case 19: msg = "2. REINIGUNG - BITTE WARTEN 3/6"; break; 	//2nd Cleaning, please wait 3/6
				case 20: msg = "2. REINIGUNG - 3/6 AKTIV"; break; 	//2nd Cleaning, active 3/6
				case 21: msg = "2. REINIGUNG - BITTE WARTEN 4/6"; break; 	//2nd Cleaning, please wait 4/6
				case 22: msg = "2. REINIGUNG - 4/6 AKTIV"; break; 	//2nd Cleaning, active 4/6
				case 23: msg = "2. REINIGUNG - BITTE WARTEN 5/6"; break; 	//2nd Cleaning, please wait 5/6
				case 24: msg = "2. REINIGUNG - 5/6 AKTIV"; break; 	//2nd Cleaning, active 5/6
				case 25: msg = "2. REINIGUNG - BITTE WARTEN 6/6"; break; 	//2nd Cleaning, please wait 6/6
				case 26: msg = "2. REINIGUNG - 6/6 AKTIV"; break; 	//2nd Cleaning, active 6/6
				
				case 27: msg = "REINIGUNGSZYKLUS 2/2 WIEDERHOLEN?"; break; 	//Do you want to repeat clean cycle 2/2 ?
				
				case 28: msg = "KAFFEE-DANACH UEBERSPRINGEN?"; break; //Do you want to skip the final coffee ?
				case 29: msg = "KAFFEE WIRD ZUBEREITET - BITTE WARTEN"; break; //Coffee delivery, please wait

				case 30: msg = "BRUEHERSPUELUNG"; break; //Brewer Rinsing 
				case 31: msg = "MIXER 1 - SPUELUNG"; break; //Mixer 1 Rinsing
				case 32: msg = "MIXER 2 - SPUELUNG"; break; //Mixer 2 Rinsing
				case 33: msg = "MIXER 3 - SPUELUNG"; break; //Mixer 3 Rinsing 
				case 34: msg = "BRUEHERREINIGUNG BEENDET - BEENDEN DRUECKEN"; break; //Brewer Cleaning Done. Press CLOSE to exit
				case 35: msg = "Moechten Sie eine MANUELLE oder AUTOMATISCHE Reinigung durchfuehren?"; break; //Do you want to perform MANUAL or AUTOMATIC washing?
			}
			...
			if ( (me.fase != me.prevFase) || ( me.fase == me.prevFase && (me.btn1 != me.prevFaseBtn1 || me.btn2 != me.prevFaseBtn2) ))
			{
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							case 1:  btnText = "WEITER"; break;
							case 12: btnText = "NEIN"; break; //Do you want to repeat clean cycle 1/2 ?
							case 14:  btnText = "WEITER"; break;
							case 27: btnText = "NEIN"; break; //Do you want to repeat clean cycle 2/2 ?
							case 28: btnText = "KAFFEE UEBERSPRINGEN"; break; //Do you want to skip the final coffee ?
							case 34: btnText = "BEENDEN"; break; //Do you want to skip the final coffee ?
				...
				else
				{
					...
					switch (me.fase)
					{
						...
						case 28: btnText = "KAFFEE BEZIEHEN"; break; //Do you want to skip the final coffee ?
						case 35: btnText = "MANUELLE"; break;
					}
					pleaseWait_btn2_setText (btnText);
					pleaseWait_btn2_show();	
				}
...
TaskCleaning.prototype.priv_handleMilkWashingVenturi = function (timeElapsedMSec)
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				case 1: pleaseWait_freeText_setText("REINIGUNG MILCHMODUL GESTARTET"); break;	//Milker Cleaning is started
				case 2: pleaseWait_freeText_setText("ERWAERMUNG REINIGER"); break;	//Warming for cleaner
				case 3: pleaseWait_freeText_setText("WARTEN AUF BESTAETIGUNG"); break;	//Wait for confirm
				case 4: pleaseWait_freeText_setText("REINIGUNGSZYKLUS DURCHFUEHREN"); break;	//Doing cleaner cycles (12)
				case 5: pleaseWait_freeText_setText("HEIZPHASE WASSER"); break;	//Warming for water
				case 6: pleaseWait_freeText_setText("WARTEN SIE AUF ZWEITE BESTAETIGUNG"); break;	//Wait for second confirm
				case 7: pleaseWait_freeText_setText("REINIGUNGSZYKLUS DURCHFUEHREN"); break;	//Doing cleaner cycles (12)
				default: pleaseWait_freeText_setText(""); break;
			}
			pleaseWait_freeText_show();
			...
			else
			{
				switch (me.fase)
				{
					default: pleaseWait_btn1_setText ("TASTE " +me.btn2); break;
					case 2:  pleaseWait_btn1_setText ("START"); break;
					case 3:
					case 5:  pleaseWait_btn1_setText ("WEITER"); break;
					case 6:  pleaseWait_btn1_setText ("BESTAETIGEN"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			{
				pleaseWait_btn2_setText ("TASTE " +me.btn2);
				pleaseWait_btn2_show();	
			}			
		})
		.catch( function(result)
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "Bevor Sie die Reinigung starten ueberpruefen Sie ob:<ol><li>Restwassertank geleert wurde</li><li>Milchschlauch sich im Reinigungsgefaess befindet</li><li>Reinigungsgefaess mit Reiniger/Tabletten befüllt wurde</li></ol>");
			...
			else
			{
				...
				case 2:	//CIC_STEP_FILL_WATER
					...
					pleaseWait_freeText_setText("Bitte warten, Wasser wird befuellt<br>Wasserleitwert: {0} µS".translateLang(cond_uS)); //Water refilling in progress, please wait.<br>Water conducibility: {0} uS
					break;

				case 3:	//CIC_WAIT_FOR_TABLET_DISSOLVING
					var timeSec = parseInt(obj.buffer8[0]);
					pleaseWait_freeText_setText("Spuelung laueft: -{0}".translateLang(timeSec)); //Rinsing -{0}
					break;
				...
				case 5:	//CIC_cleaning_PHASE2
					...
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Bitte warten, Reinigung {0} von {1} laeuft.<br>Wasserleitwert: {2} µS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Rinsing {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 6: //CIC_RINSING_PHASE3
					...
					var ciclo_di = parseInt(obj.buffer8[3]);
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Bitte warten, Spuelung {0} von {1} laeuft.<br>Wasserleitwert: {2} µS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Cleaning {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					...
					pleaseWait_freeText_setText("Reinigung beendet.<br><br>Anfangliche laeuft. {0} Endgultige laeuft. {1}<br><br>Bitte denken Sie daran:<ul><li>den Restwassertank zu entleeren</li><li>den Milchschlauch wieder einzusetzen</li></ul><br>SCHLIESSEN zum Beenden druecken".translateLang(cond_uS_init_rif,cond_uS_finale)); //The cleaning procedure is finished.<br><Initial conducibility {0} and current conducibility {1},><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;

				case 9: //CIC_WAIT_CONF_LIQUID_DETERGENT
					pleaseWait_freeText_setText("Füllen Sie bitte den Reinigungskrug mit dem Reinigungsmittel<br><br><center><img src='img/milkerInduxClean05.jpg'></center>"); //Please fill liquid detergent and push START
					break;
					
				case 97: //CIC_TOO_MUCH_DETERGENTE
					pleaseWait_freeText_setText("WARNUNG: zu viel Reiniger!");
					break;
				
				case 98: //CIC_DET_TOO_LOW
					pleaseWait_freeText_setText("WARNUNG: Reiniger zu gering!<br>Eine erneute Reinigung wird empfohlen.");
					break;

				case 99: //CIC_DET_TOO_AGGRESSIVE
					pleaseWait_freeText_setText("WARNUNG: Reiniger zu aggressiv!");
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						pleaseWait_btn1_setText ("WEITER");
					else
						pleaseWait_btn1_setText ("START");
					break;
				case 7:		pleaseWait_btn1_setText ("SCHLIESSEN"); break;
			...
			else
			{
				...
				case 1:	 pleaseWait_btn2_setText ("ABRECHEN"); break;
				case 7:	 pleaseWait_btn2_setText ("BEENDEN MILCH-AUSWAHL"); break;
				}
				pleaseWait_btn2_show();	
			}	
			...
			else
			{
				switch (me.fase)
				{
				case 1:	 pleaseWait_btn3_setText ("REINIGEN SIE MIT „FLÜSSIGEM REINIGUNGSMITTEL“"); break;
				}
...
TaskCalibMotor.prototype.showPopupCalibrazioneEVPump = function (ev1_5)
{
	...
	pleaseWait_btn1_setText("ABRECHEN");
	pleaseWait_btn1_show();
}
...
console.log ("TaskCalibMotor::fase[" +me.fase +"]");
	...
	case 20:
		...
		pleaseWait_calibration_setText("WENN FERTIG, BITTE DIE GEWOGENEN MENGE DER LETZTEN MAHLUNG IN GRAMM EINGEBEN, MIT WEITER FORTFUEHREN"); //Please enter the quantity, then press CONTINUE
	...
	case 40:
		...
		{
			pleaseWait_calibration_setText("UNGUELTIGER WERT");
			me.fase = 20;
			break;
		}
	
		pleaseWait_calibration_setText("WERT WIRD GESPEICHERT ...");
		me.value = pleaseWait_calibration_num_getValue();
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("BITTE BRUEHER ENTNEHMEN UND WEITER DRUECKEN"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ABRECHEN");
		pleaseWait_btn2_show();	
...
//console.log ("TaskCalibMotor.priv_handleCalibMacina() => runMotor, m="  +me.motor);
	...
	case 25:	//qui ci andiamo se siamo in fase 21 e l'utente preme il btn SET per impostare una nuova apertura del VGrind
		pleaseWait_calibration_setText("BITTE WARTEN WAEHREND DER VARIGRIND SEINE POSITION EINSTELLT"); //Please wait while the varigrind is adjusting its position
	...
	case 28:
		if (da3.isGruppoVariflex())
		{
			rhea.ajax ("getPosMacina", {"m":(me.motor-10)}).then( function(result)
			{
				var obj = JSON.parse(result);
				rheaSetDivHTMLByName("pagePleaseWait_calibration_1_vg", obj.v);
				pleaseWait_calibration_setText("BITTE WARTEN WAEHREND DER VARIGRIND SEINE POSITION EINSTELLT" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position  [current pos]
			})
			.catch( function(result)
			{
			});	
...
//console.log	("TaskCalibMotor.priv_handleCalibMacina: setFattoreCalib m=" +me.motor +",v=" +me.gsec);		
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("BRUEHER EINSETZEN UND WEITER DRUECKEN"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_show();
		me.fase = 41;
		break;
	...
	case 60: //gruppo è stato ricollegato, procedo con il calcolo impulsi se richiesto
		...
		else
		{
			me.fase = 65;
			pleaseWait_calibration_show();
			pleaseWait_calibration_setText("BITTE WARTEN, IMPULSBERECHNUNG IN ARBEIT"); //Impulse calculation in progress, please wait
...
TaskTestSelezione.prototype.priv_handleTestMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("BITTE BRUEHER ENTNEHMEN UND WEITER DRUECKEN"); //Please remove the brewer, then press CONTINUE
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ABRECHEN");
		pleaseWait_btn2_show();
	...
	case 10:  //ok, il gruppo è scollegato, chiedo a CPU di attivare la macina
		me.fase = 11;
		pleaseWait_calibration_setText ("MAHLWERK LAEUFT"); //Grinder is running
	...
	case 40: //chiedo di rimettere a posto il gruppo
		pleaseWait_calibration_setText("BRUEHER EINSETZEN UND WEITER DRUECKEN ODER WIEDERHOLEN AUSWAEHLEN"); //Place the brewer into position then press CONTINUE, or press REPEAT to grind again
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("WIEDERHOLEN");
		pleaseWait_btn2_show();		
		me.fase = 41;
		break;
...
TaskDevices.prototype.priv_handleSnackProg = function(timeNowMsec)
{
	...
	case 0:
		this.fase = 10;
		pleaseWait_rotella_hide();
		pleaseWait_btn1_setText("PROGRAMMIERUNG VERLASSEN");
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleRichiestaPosizioneMacina = function()
{
	...
	rhea.ajax ("getCupSensorLiveValue", "" ).then( function(result)
	{
		...
		default: rheaSetDivHTMLByName("divCupSensorLiveValueBrewmatic", "KEINE TASSE ERKANNT"); break;
		}
		
		//nel caso di sensore Wenglor
		switch (parseInt(result))
		{
		default: rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "KEINE TASSE ERKANNT"); break;
		case 1:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "KLEINE TASSE (unten)"); break;
		case 2:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "KLEINE TASSE (oben)"); break;
		case 3:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "GROSSE TASSE"); break;
		}		
	})
	.catch( function(result)
	{
...
TaskDevices.prototype.priv_handleRegolazionePosizioneMacina = function()
{
	switch (this.fase)
	{
		case 0: 
			...
			pleaseWait_freeText_setText("BITTE WARTEN WAEHREND DER VARIGRIND SEINE POSITION EINSTELLT"); //Please wait while the varigrind is adjusting its position
			pleaseWait_freeText_show();
...
TaskDevices.prototype.priv_queryMacina = function(macina_1o2)
{
	...
	rhea.ajax ("getPosMacina", {"m":macina_1o2}).then( function(result)
	{
		...
		pleaseWait_freeText_setText("BITTE WARTEN WAEHREND DER VARIGRIND SEINE POSITION EINSTELLT" +"  [" +obj.v +"]"); //Please wait while the varigrind is adjusting its position [current_value]
	})
	.catch( function(result)
	{
	});			
...
TaskDevices.prototype.priv_handleTestAssorbGruppo = function(timeNowMsec)
{
	...
	{
	case 0:
		pleaseWait_freeText_setText ("TEST STARTET...");
		pleaseWait_freeText_show();
		pleaseWait_rotella_show();
		me.fase = 1;
		me.test_fase = 0;
	...
	case 10:
		...
		pleaseWait_freeText_setText ("TEST LAEUFT, BITTE WARTEN...<br>AKTUELLE PHASE " +me.test_fase +"/5");
		me.fase = 11;
		break;
	...
	case 11:
		...
		rhea.ajax ("getStatTestAssGrp", "" ).then( function(result)
		{
			...
			{
				//errore
				pleaseWait_freeText_setText ("TEST IST ABGESCHLOSSEN.<br>Result: FAILED<br><br>");
				pleaseWait_btn1_setText("SCHLIESSEN");
				pleaseWait_btn1_show();	
				pleaseWait_btn2_setText("WIEDERHOLEN");
				pleaseWait_btn2_show();	
				me.fase = 80;
			...
			else
			{
				...
				else
				{
					...
					var html = "<table class='dataAudit'>"
								...
								+"</table>";
					pleaseWait_freeText_setText ("TEST IST ABGESCHLOSSEN.<br>Results:<br><br>" +html);		
					pleaseWait_btn1_setText("SCHLIESSEN");
					pleaseWait_btn1_show();	
					pleaseWait_btn2_setText("WIEDERHOLEN");
					pleaseWait_btn2_show();	
...
TaskDevices.prototype.priv_handleTestAssorbMotoriduttore = function(timeNowMsec)
{
	...
	case 0: //prego rimuovere il gruppo
		me.fase = 1;
		pleaseWait_show();
		pleaseWait_freeText_setText ("BITTE BRUEHER ENTNEHMEN UND WEITER DRUECKEN");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ABRECHEN");
	...
	case 20:
		//ho ricevuto l'OK dal comando start Test. Da ora in poi, pollo lo stato del test fino a che non finisce
		pleaseWait_freeText_setText ("TEST LAEUFT, BITTE WARTEN...<br>AKTUELLE PHASE " +me.test_fase +"/4");
		me.fase = 21;
		break;
	...
	case 85: //prego rimettere a posto il gruppo
		pleaseWait_freeText_setText("BRUEHER EINSETZEN UND WEITER DRUECKEN"); //Place the brewer into position, then press CONTINUE
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		pleaseWait_rotella_show();
		me.fase = 86;
...
TaskDevices.prototype.priv_handleGrinderSpeedTest = function(timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MAHLGESCHWINDIGKEIT FUER OFF09</b><br><br>BITTE BRUEHER ENTNEHMEN UND WEITER DRUECKEN"); //Please remove the brewer, then press CONTINUE
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ABRECHEN");
	...
	case 5: //step 1
		...
		pleaseWait_show();
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MAHLGESCHWINDIGKEIT FUER OFF09</b><br><br>SCHRITT 1:  Bitte schließen Sie den Kaffeebehaelter (oranger Schieber) und druecken Sie WEITER. Das Mahlwerk laeuft etwa 10 sek. lang (um das Mahlwerk selbst zu entleeren).");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ABRECHEN");
	...
	case 20:
		me.fase = 21;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MAHLGESCHWINDIGKEIT FUER OFF09</b><br><br>SCHRITT 2: Nachdem das Mahlwerk leer ist, wird der durchschnittliche Sensorwert ermittelt, der gemeldet wird, wenn das Mahlwerk leer ist. Druecken Sie WEITER, um fortzufahren. Das Mahlwerk laeuft ca. 10 sek.");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ABRECHEN");
	...
	case 40:
		me.fase = 41;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MAHLGESCHWINDIGKEIT FUER OFF09</b><br><br>SCHRITT 3: Oeffnen Sie nun den Kaffebehälter (oranger Schieber) und druecken Sie WEITER, um fortzufahren. Das Mahlwerk laeuft ca. 10 Sek.");
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		pleaseWait_btn2_setText("ABRECHEN");
	...
	case 60:
		me.fase = 61;
		pleaseWait_rotella_hide();
		pleaseWait_freeText_setText ("<b>MAHLGESCHWINDIGKEIT FUER OFF09</b><br><br>ERGEBNIS:<br>DURCHSCHNITTLICHE  GESCHWINDIGKEIT WENN DAS MAHLWERK LEER IST: <b>" +me.speed1 +"</b><br>DURCHSCHNITTLICHE GESCHWINDIGKEIT WENN DAS MAHLWERK NICHT LEER IST: <b>" +me.speed2 +"</b><br>");		
		pleaseWait_freeText_show();
		pleaseWait_btn1_setText("BEENDEN");
		pleaseWait_btn1_show();
		break;
	...
	case 70: //chiedo di rimettere a posto il gruppo
		...
		else
		{
			me.fase = 71;
			pleaseWait_rotella_hide();
			pleaseWait_freeText_setText("<b>MAHLGESCHWINDIGKEIT FUER OFF09</b><br><br>BRUEHER EINSETZEN UND WEITER DRUECKEN"); //Place the brewer into position, then press CONTINUE
			pleaseWait_freeText_show();
			pleaseWait_btn1_setText("WEITER");
			pleaseWait_btn1_show();
		}
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_freeText_show();
		pleaseWait_freeText_setText("DEINSTALLATION<br>TANK GELEER?"); //DISINTALLATION<br><br>Is driptray empty?
		pleaseWait_btn1_setText("JA - WEITER");
		pleaseWait_btn2_setText("ABRECHEN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
		break;
	...
	case 10:
		this.fase = 11;
		pleaseWait_freeText_setText("DEINSTALLATION<br><br>KAFFEESATZ BITTE ENTNEHMEN UND WEITER DRUECKEN"); //DISINTALLATION<br><br>Please remove coffee grounds, then press CONTINUE
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn2_setText("ABRECHEN");
		pleaseWait_btn1_show();
		pleaseWait_btn2_show();
	...
	case 20:
		this.fase = 21;
		pleaseWait_freeText_setText("DEINSTALLATION<br><br>START DEINSTALLATION DRUECKEN UM FORTZUFAHREN, ABBRUCH UM ZU BEENDEN"); //DISINTALLATION<br><br>Press START DISINSTALLATION to continue, ABORT to cancel the operation
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("DEINSTALLATION LAEUFT, BITTE WARTEN ...<br><br><br>Press PROG button to abort"); //DISINTALLATION is running, please wait
		else
			pleaseWait_freeText_setText("DEINSTALLATION LAEUFT, BITTE WARTEN ..."); //DISINTALLATION is running, please wait
	...
	case 40:
		var msgToOutput = "DEINSTALLATION BEENDET, BITTE MASCHINE AUSSCHALTEN"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "DEINSATALLATION BEENDET - BOILERAUSLASS SCHLIESEN UND MASCHINE AUSSCHALTEN"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
	...
	case 51:
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("DEINSTALLATION<br><br>BOILERAUSLASS OEFFNEN UND WEITER DRUECKEN ...<br><br><br>Press PROG button to abort"); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
		else
			pleaseWait_freeText_setText("DEINSTALLATION<br><br>BOILERAUSLASS OEFFNEN UND WEITER DRUECKEN ..."); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
...
TaskDataAudit.prototype.onTimer = function (timeNowMsec)
{
	...
	switch (this.fase)
	{
		...
		case 10: //eva dts scaricato
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			me.fase = 20;
			pleaseWait_freeText_appendText ("<br>ABGESCHLOSSEN; BITTE WARTEN - DATEN WERDEN VERARBEITET<br>"); //Done, processing data, please wait
			break;
		...
		case 200: //errore downloading eva-dts
			rhea.onEvent_readDataAudit = function(status, kbSoFar, fileID) {};
			pleaseWait_freeText_appendText("FEHLER DOWNLOAD EVA-DTS - BITTE ERNEUT VERUCHEN"); //Error downloading EVA-DTS. Please try again later
			me.fase = 201;
			break;
...
TaskGrinderClean.prototype.onEvent_cpuStatus  	= function(statusID, statusStr, flag16)		{ this.cpuStatus = statusID; pleaseWait_header_setTextL ("REINIGUNG MAHLWERK"); }
...
TaskGrinderClean.prototype.runGrinderCycle_1 = function()
{
	...
	var msg = "MAHLWERKSZYKLUS LAEUFT {0} VON {1]".translateLang(this.curCiclo,this.numCicli);
	msg += "<br><br><b>PRODUKT AUFFANGEN</b>";
	this.priv_show (msg, "", "");	
...
TaskGrinderClean.prototype.runGrinderCycle_3 = function(timeNowMsec)
{
	...
	var msg = "MAHLWERKSZYKLUS LAEUFT {0} VON {1]".translateLang(this.curCiclo-1,this.numCicli);
	msg += "<br>" +"BITTE WARTEN {0} SEK.".translateLang(timeLeftSec);
	this.priv_show (msg, "", "");	
	if (timeLeftMSec <= 0)
		this.runGrinderCycle_1();
}
...
//console.log ("fase="+this.fase);	
	...
	{
		pleaseWait_freeText_setText ("<b>REINIGUNG MAHLWERK</b><br><br>" + text);
		pleaseWait_freeText_show();
...
TaskGrinderClean.prototype.step1 = function()
{
	...
	this.priv_show ("&nbsp;", "WEITER", "ABRECHEN");
...
TaskGrinderClean.prototype.step2 = function()
{
	...
	var msg = "SCHIEBER VOM BOHNENBEHAELTER SCHLIESSEN.";
	msg += "<br>MIT WEITER BESTAETIGEN.";
	this.priv_show (msg, "WEITER", "");
}
...
TaskGrinderClean.prototype.step3 = function()
{
	...
	var msg = "BRUEHER UND BOHNENBEHAELTER ENTFERNEN.";
	msg += "<br>MIT WEITER BESTAETIGEN.";
	this.priv_show (msg, "WEITER", "");
}
...
TaskGrinderClean.prototype.step5 = function()
{
	...
	var msg = "ANBRINGEN VON MAHLWERKSREINIGUNGSGERAET.";
	msg += "<br>MIT WEITER BESTAETIGEN.";	
	this.priv_show (msg, "WEITER", "");	
}
...
TaskGrinderClean.prototype.step6 = function()
{
	...
	var msg = "NACHFUELLEN VON MAHLWERKSREINIGUNGSGERAET.";
	msg += "<br>MIT WEITER BESTAETIGEN.";
	msg += "<br><br><br>WARNUNG:<br>SOBALD WEITER GEDRUECKT WIRD STARTET DAS MAHLWERK";
	this.priv_show (msg, "WEITER", "");	
}
...
TaskGrinderClean.prototype.step20 = function()
{
	...
	this.priv_show ("MAHLWERKSREINIGUNG WIEDERHOLEN?", "NEIN", "JA");
}
...
TaskGrinderClean.prototype.step21 = function()
{
	...
	var msg = "BOEHNENBEHAELTER ERNEUT ANBRINGEN.";
	msg += "<br>MIT WEITER BESTAETIGEN.";
	this.priv_show (msg, "WEITER", "");
}
...
TaskGrinderClean.prototype.step23 = function()
{
	...
	var msg = "SCHIEBER VOM BOHNENBEHAELTER OEFFNEN.";
	msg += "<br>MIT WEITER BESTAETIGEN.";
	msg += "<br><br><br>WARNUNG:<br>SOBALD WEITER GEDRUECKT WIRD STARTET DAS MAHLWERK";
	this.priv_show (msg, "WEITER", "");	
}
...
TaskGrinderClean.prototype.step26 = function()
{
	...
	var msg = "BRUEHER ERNEUT EINSETZEN.";
	msg += "<br>MIT WEITER BESTAETIGEN.";
	this.priv_show (msg, "WEITER", "");
}
...
TaskGrinderClean.prototype.step28 = function()
{
	...
	this.priv_show ("MOECHTEN SIE EIN KAFFEE ZUBEREITEN?", "NEIN", "JA");
}
...
TaskCalibMilkPump.prototype.priv_handleCalibMilkPump = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_calibMilkPump_setText("Bitte fuellen Sie Wasser in den Milchtank, stellen Sie eine leere Kanne in die Tassenstation und druecken Sie dann „WEITER“.");
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		var btnText = "AUSGANG";
		pleaseWait_btn2_setText (btnText);
	...
	case 12:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
	    pleaseWait_calibMilkPump_setText("Bitte warten Sie, waehrend das Wasser ausgegeben wird"); 
	...
	case 13:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
		pleaseWait_calibMilkPump_setText("Bitte leeren Sie die Kanne in der Tassenstation und druecken Sie dann „WEITER“.");
		pleaseWait_btn1_setText("WEITER");
		pleaseWait_btn1_show();
		break;	
	...
	case 20:
		...
		pleaseWait_calibMilkPump_setText("Wenn Sie fertig sind, geben Sie bitte die Menge in ml des ZULETZT ausgegebenen Wassers ein,<br> max. 340 ml<br>, und druecken Sie dann WEITER<br><br>"); //Please enter the quantity, then press CONTINUE
...
TaskCleaning.prototype.priv_handleSyrupCleaning = function (timeElapsedMSec)		//#4660
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = " "; break;
				case 1:		msg = "Place an one-liter tank with the correct quantity of detergent under the cup station, Drücken Sie WEITER, wenn Sie fertig sind."; break;			//SYRUP_CLEANING_PREPARE_TANK_UNDER_NOZZLES,
				case 2:		msg = "Hot water is flowing from the the nozzle in the tank with cleaning detergent. Bitte warten…..."; break;
				case 3:		msg = "Remove the tubes from the syrup bottles and place them in the cleaning solution tank, Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 4:		msg = "step 1 - Cleaning solution is flowing from the syrup tube nozzles. Bitte warten…..."; break;
				case 5:		msg = "step 1 - Please wait for the cleaning solution action…, Bitte warten…..."; break;
				case 6:		msg = "step 2 - Cleaning solution is flowing from the syrup tube nozzles. Bitte warten…..."; break;
				case 7:		msg = "step 2 - Please wait for the cleaning solution action…. Bitte warten…..."; break;
				case 8:		msg = "Place a clean empty tank under the cup station, Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 9:		msg = "Hot water is flowing from the the nozzle in the tank. Bitte warten…..."; break;
				case 10:	msg = "Place the syrup tubes in the cleaning water tank. Drücken Sie WEITER, wenn Sie fertig sind."; break;
				case 11:	msg = "Hot water  is flowing from the syrup tube nozzles."; break;
				case 12:	msg = "Check the syrup tubes. Do you want to repeat the rinsing ?  Press REPEAT to rinse again the tubes.. Drücken Sie WEITER, wenn Sie fertig sind."; break;
