...
TaskTemperature.prototype.showPopupConfirmX9 = function()
{
	...
	pleaseWait_btn1_setText("CONFERMA");
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			switch (me.fase)
			{
				...
				case 10:	msg = "Avvio svuotamento e risciacquo circuito idraulico"; break;
				...
				case 17:	msg = "l'acqua sta fluendo nei tubi latte."; break;
				...
				else
				{
					...
					else
					{
						...
						switch (me.fase)
						{
							...
							case 35: btnText = "AUTOMATICO"; break;
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			if (me.fase == 1)
			{
				...
				{
					rheaSetDivHTMLByName ("pagePleaseWait_milkerInduxWashing_info", "Prima di iniziare il lavaggio, si prega di verificare che:<ol><li>la macchina sia collegata alla rete idrica</li><li>la vaschetta dell'acqua sia vuota</li><li>il tubo del latte sia nella vaschetta di pulizia</li><li>la vaschetta di pulizia contenga il detergente</li></ol>");
			...
			else
			{
				...
				case 3:	//CIC_WAIT_FOR_TABLET_DISSOLVING
					...
					pleaseWait_freeText_setText("Lavaggio in corso:  -{0}".translateLang(timeSec)); //Rinsing -{0}
					break;
				...
				case 5:	//CIC_cleaning_PHASE2
					...
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Lavaggio {0} of {1} in corso, attendere prego.<br>Conducibilità dell'acqua: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Rinsing {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 6: //CIC_RINSING_PHASE3
					...
					var ciclo_di = parseInt(obj.buffer8[3]);
					var cond_uS = parseInt(obj.buffer8[1]) + 256*parseInt(obj.buffer8[2]);
					pleaseWait_freeText_setText("Risciacquo {0} of {1} in corso, attendere prego.<br>Conducibilità dell'acqua: {2} uS".translateLang(ciclo_num,ciclo_di,cond_uS)); //Cleaning {0} of {1}, please wait.<br>Water conducibility: {2} uS
					break;
				...
				case 7: //CIC_WAIT_FOR_MILK_TUBE
					...
					pleaseWait_freeText_setText("La procedura di pulizia è terminata.<br><br>Conducibilità iniziale {0} Conducibilità finale {1}<br><br>Si prega di:<ul><li>svuotare la vaschetta dell'acqua</li><li>riportare il tubo del latte nella posizione iniziale</li></ul><br>Premere<br> CHIUDI per chiudere questa finestra verificando la presenza del latte o <br>CHIUDI NO SEL.LATTE se non vuoi abil. le selezioni latte".translateLang(cond_uS_init_rif,cond_uS_finale)); //The cleaning procedure is finished.<br><Initial conducibility {0} and current conducibility {1},><br>Please, remember to:<ul><li>empty Waste tank</li><li>put the milk pipe back into position</li></ol><br>Press CLOSE to close this window
					break;

				case 9: //CIC_WAIT_CONF_LIQUID_DETERGENT
					pleaseWait_freeText_setText("Si prega di riempire la caraffa per la pulizia con il detersivo. Premi START quando pronto<br><br><center><img src='img/milkerInduxClean05.jpg'></center>"); //Please fill liquid detergent and push START
					break;
			...
			else
			{
				...
				case 1:
					if (me.lavaggioConLiquidoDetergente==1)
						...
						pleaseWait_btn1_setText ("INIZIA");
					break;
				case 7:		pleaseWait_btn1_setText ("CHIUDI"); break;
				case 9:		pleaseWait_btn1_setText ("INIZIA"); break;
				}
				pleaseWait_btn1_show();	
			}
			...
			else
			{
				...
				case 7:	 pleaseWait_btn2_setText ("CHIUDI NO SEL.LATTE"); break;
				}
				pleaseWait_btn2_show();	
			}	
			...
			else
			{
				switch (me.fase)
				{
				case 1:	 pleaseWait_btn3_setText ("INIZIA CON `LIQUIDO DETERGENTE`"); break;
				}
...
TaskCalibMotor.prototype.priv_handleCalibMacina = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_show();
		pleaseWait_calibration_show();
		pleaseWait_calibration_setText("Prego rimuovere il gruppo caffè e poi premere CONTINUA"); //Please remove the brewer, then press CONTINUE AND BE PREPARED TO CATCH COOFEE
		pleaseWait_btn1_setText("CONTINUA");
		pleaseWait_btn1_show();
...
TaskDevices.prototype.priv_handleRichiestaPosizioneMacina = function()
{
	...
	rhea.ajax ("getCupSensorLiveValue", "" ).then( function(result)
	{
		...
		default: rheaSetDivHTMLByName("divCupSensorLiveValueBrewmatic", "NESSUNO"); break;
		}
		
		//nel caso di sensore Wenglor
		switch (parseInt(result))
		{
		default: rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "NESSUNO"); break;
		case 1:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "BICCHIERE PICCOLO (giu)"); break;
		case 2:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "BICCHIERE PICCOLO (su)"); break;
		case 3:rheaSetDivHTMLByName("divCupSensorLiveValueWenglor", "BICCHIERE GRANDE"); break;
		}		
	})
	.catch( function(result)
	{
...
TaskDisintall.prototype.onTimer = function (timeNowMsec)
{
	...
	case 30:
		...
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("La DISINSTALLAZIONE è in corso, attendere prego ...<br><br><br>Press PROG button to abort"); //DISINTALLATION is running, please wait
		else
	...
	case 40:
		var msgToOutput = "La DISINSTALLAZIONE è terminata. Si prega di RIAVVIARE la macchina"; //DISINTALLATION finished, please shut down the machine
		if (bBollitore400cc)
			msgToOutput = "La DISINSTALLAZIONE è terminata. Si prega CHIUDERE il tappo del bollitore e di RIAVVIARE la macchina"; //EINSTALLATION finished, please CLOSE the boiler tap and SHUT DOWN the machine
	...
	case 51:
		if (this.isSecondUninstall)
			pleaseWait_freeText_setText("DISINTALLAZIONE<br><br>Aprire il tappo del bollitore e poi premere CONTINUA ...<br><br><br>Press PROG button to abort"); //DISINSTALLATION<br><br>Open boiler tap then press CONTINUE
		else
...
TaskCalibMilkPump.prototype.priv_handleCalibMilkPump = function (timeElapsedMSec)
{
	...
	case 0:
		...
		pleaseWait_calibMilkPump_setText("Prego, riempire la tanica latte con acqua, mettere una caraffa nella stazione bicchieri e premere CONTINUA per iniziare il test");
		pleaseWait_btn1_setText("CONTINUA");
		pleaseWait_btn1_show();
		var btnText = "ESCI";
		pleaseWait_btn2_setText (btnText);
	...
	case 12:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
	    pleaseWait_calibMilkPump_setText("Si prega di attendre mentre l'acqua viene erogata"); 
	...
	case 13:
		...
		pleaseWait_show();
		pleaseWait_calibMilkPump_show();
		pleaseWait_calibMilkPump_setText("Prego, svuotare la caraffa nella stazione bicchieri e premere CONTINUA");
		pleaseWait_btn1_setText("CONTINUA");
		pleaseWait_btn1_show();
		break;	
	...
	case 20:
		...
		pleaseWait_calibMilkPump_setText("Alla fine dell'erogazione, si prega di inserire la quantità in ml che è stata erogata,,<br> massimo 340ml <br>quindi premere CONTINUA<br><br>"); //Please enter the quantity, then press CONTINUE
...
TaskCleaning.prototype.priv_handleSyrupCleaning = function (timeElapsedMSec)		//#4660
{
	...
	rhea.ajax ("sanWashStatus", "")
		.then( function(result) 
		{
			...
			{
				default: 	msg = " "; break;
				case 1:		msg = "Porre una tanica di circa un litro con la giusta quatità di detergente sotto la stazione bicchieri., Press CONTINUE when done."; break;			//SYRUP_CLEANING_PREPARE_TANK_UNDER_NOZZLES,
				case 2:		msg = "L'acqua calda sta fluendo dall'ugello, nel contenitore con il detergente. please wait......"; break;
				case 3:		msg = "Estrarre i tubi sciroppo dalle bottiglie e inserirli nella tanica con la soluzione di detergente e acqua, Press CONTINUE when done."; break;
				case 4:		msg = "fase 1 - La soluzione sanificante sta fluendo dall'ugello dei tubi sciroppo. please wait......"; break;
				case 5:		msg = "La soluzione sanificante sta fluendo dall'ugello, please wait......"; break;
				case 6:		msg = "fase 2 - La soluzione sanificante sta fluendo dall'ugello dei tubi sciroppo. please wait......"; break;
				case 7:		msg = "Prego attendere l'azione della soluzione detergente. please wait......"; break;
				case 8:		msg = "Porre nuovamente la tanica vuota e pulita sotto la stazione bicchieri, Press CONTINUE when done."; break;
				case 9:		msg = "L'acqua calda sta fluendo dall'ugello nella tanica. please wait......"; break;
				case 10:	msg = "Porre i tubi sciroppo nella tanica con l'acqua calda. Press CONTINUE when done."; break;
				case 11:	msg = "L'acqua calda sta fluendo dall'ugello dei tubi sciroppo."; break;
				case 12:	msg = "Verificare la corretta pulizia dei tubi sciroppo. Premere RIPETI per risciacquare nuovamente i tubi. Press CONTINUE when done."; break;
				case 13:	msg = "Porre nuovamente i tubi sciroppo nelle rispettive bottiglie.."; break;
			}
